...
The `public contributions` by users in Hong Kong on `2023/6/18 3:05 AM UTC`. This list contains users from `Hong Kong` and cities `Hong-kong` `Kowloon`.
...
<table>
	...
	<tr>
		...
		<td>@privacy-scaling-exp @ethereum @852dev-xyz </td>

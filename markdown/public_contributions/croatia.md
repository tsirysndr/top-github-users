...
The `public contributions` by users in Croatia on `2023/10/12 2:25 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.
...
<table>
	...
	<tr>
		...
		<td>Papar D.o.o </td>
		<td><a href="https://twitter.com/antonioobra8">antonioobra8</a></td>
		<td>Zagreb, Croatia</td>
		<td>222</td>
	</tr>
	<tr>

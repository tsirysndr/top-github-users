...
The `public contributions` by users in Philippines on `2022/12/28 7:10 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

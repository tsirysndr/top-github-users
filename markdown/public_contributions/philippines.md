...
The `public contributions` by users in Philippines on `2023/4/15 9:43 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

...
The `public contributions` by users in Philippines on `2022/12/21 11:03 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

...
The `public contributions` by users in Philippines on `2023/6/4 11:50 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

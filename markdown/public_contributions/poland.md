...
The `public contributions` by users in Poland on `2023/9/24 12:28 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

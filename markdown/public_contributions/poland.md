...
The `public contributions` by users in Poland on `2023/2/9 7:10 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

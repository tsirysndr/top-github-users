...
The `public contributions` by users in Poland on `2023/8/20 12:37 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

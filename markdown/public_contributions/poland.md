...
The `public contributions` by users in Poland on `2023/1/16 3:45 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` by users in Poland on `2022/10/14 4:57 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

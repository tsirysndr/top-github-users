...
The `public contributions` by users in Poland on `2022/12/30 4:28 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

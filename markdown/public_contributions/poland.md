...
The `public contributions` by users in Poland on `2023/7/1 7:25 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

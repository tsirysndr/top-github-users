...
The `public contributions` by users in Poland on `2022/11/17 3:17 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

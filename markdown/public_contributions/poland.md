...
The `public contributions` by users in Poland on `2022/10/20 7:04 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` by users in Poland on `2023/4/19 11:50 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

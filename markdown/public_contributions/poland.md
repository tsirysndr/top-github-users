...
The `public contributions` by users in Poland on `2023/8/1 5:00 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

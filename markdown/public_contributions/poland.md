...
The `public contributions` by users in Poland on `2023/2/27 10:39 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

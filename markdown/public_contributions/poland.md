...
The `public contributions` by users in Poland on `2023/1/11 4:15 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

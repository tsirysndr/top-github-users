...
The `public contributions` by users in Poland on `2022/10/30 10:48 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

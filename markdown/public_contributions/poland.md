...
The `public contributions` by users in Poland on `2023/6/23 11:10 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` by users in Poland on `2023/6/27 8:49 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

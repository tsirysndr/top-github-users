...
The `public contributions` by users in Poland on `2023/2/12 12:55 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

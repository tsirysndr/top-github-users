...
The `public contributions` by users in Poland on `2023/10/1 10:22 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

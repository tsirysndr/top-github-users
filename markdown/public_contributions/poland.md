...
The `public contributions` by users in Poland on `2023/9/9 5:24 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` by users in Poland on `2022/10/31 6:09 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

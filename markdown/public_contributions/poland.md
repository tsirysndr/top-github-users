...
The `public contributions` by users in Poland on `2023/10/13 6:16 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

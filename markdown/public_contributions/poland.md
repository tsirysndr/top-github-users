...
The `public contributions` by users in Poland on `2023/8/17 8:34 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

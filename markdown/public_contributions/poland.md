...
The `public contributions` by users in Poland on `2023/3/13 3:30 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

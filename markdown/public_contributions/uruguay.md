...
The `public contributions` by users in Uruguay on `2023/8/23 8:41 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `969 users`  in Uruguay. You need at least `7 followers` to be on this list.

...
The `public contributions` by users in Uruguay on `2023/10/3 2:29 PM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `969 users`  in Uruguay. You need at least `8 followers` to be on this list.

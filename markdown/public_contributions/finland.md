...
The `public contributions` by users in Finland on `2023/8/22 3:35 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

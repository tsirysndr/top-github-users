...
The `public contributions` by users in Finland on `2023/5/30 4:22 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

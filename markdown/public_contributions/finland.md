...
The `public contributions` by users in Finland on `2023/7/17 2:39 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2022/11/26 2:02 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

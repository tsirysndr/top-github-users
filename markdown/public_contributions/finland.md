...
The `public contributions` by users in Finland on `2023/8/27 1:19 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

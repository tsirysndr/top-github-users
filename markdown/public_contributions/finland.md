...
The `public contributions` by users in Finland on `2023/11/24 2:26 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/4/30 6:59 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

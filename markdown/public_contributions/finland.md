...
The `public contributions` by users in Finland on `2023/5/8 4:14 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

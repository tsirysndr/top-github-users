...
The `public contributions` by users in Finland on `2023/5/13 12:31 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

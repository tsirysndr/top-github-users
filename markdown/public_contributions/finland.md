...
The `public contributions` by users in Finland on `2023/2/1 5:33 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

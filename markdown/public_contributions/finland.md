...
The `public contributions` by users in Finland on `2023/11/15 12:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/4/16 8:04 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

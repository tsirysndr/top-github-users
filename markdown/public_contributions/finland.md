...
The `public contributions` by users in Finland on `2023/7/28 2:34 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

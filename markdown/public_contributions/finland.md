...
The `public contributions` by users in Finland on `2023/5/21 5:59 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

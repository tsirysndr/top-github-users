...
The `public contributions` by users in Finland on `2022/11/13 7:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

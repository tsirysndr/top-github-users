...
The `public contributions` by users in Finland on `2023/10/24 3:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

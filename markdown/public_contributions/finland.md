...
The `public contributions` by users in Finland on `2022/12/12 1:52 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

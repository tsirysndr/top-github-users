...
The `public contributions` by users in Finland on `2023/9/14 1:43 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

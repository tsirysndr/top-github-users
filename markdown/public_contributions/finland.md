...
The `public contributions` by users in Finland on `2023/8/9 8:50 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

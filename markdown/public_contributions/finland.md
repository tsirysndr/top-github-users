...
The `public contributions` by users in Finland on `2022/12/1 3:58 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2022/11/6 7:49 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

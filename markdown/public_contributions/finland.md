...
The `public contributions` by users in Finland on `2022/10/15 2:11 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

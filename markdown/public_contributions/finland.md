...
The `public contributions` by users in Finland on `2023/1/18 5:45 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

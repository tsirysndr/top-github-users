...
The `public contributions` by users in Finland on `2023/9/10 3:20 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

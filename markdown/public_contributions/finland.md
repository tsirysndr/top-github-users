...
The `public contributions` by users in Finland on `2023/2/9 11:25 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

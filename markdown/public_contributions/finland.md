...
The `public contributions` by users in Finland on `2023/10/13 10:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/3/28 9:32 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2022/10/12 4:36 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

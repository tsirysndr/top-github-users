...
The `public contributions` by users in Finland on `2023/7/29 1:10 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

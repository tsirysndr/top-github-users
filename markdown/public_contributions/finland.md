...
The `public contributions` by users in Finland on `2023/6/5 3:47 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2022/11/14 9:54 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

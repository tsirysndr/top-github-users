...
The `public contributions` by users in Finland on `2023/9/19 5:29 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/9/24 10:38 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

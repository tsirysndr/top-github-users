...
The `public contributions` by users in Finland on `2023/8/16 7:56 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

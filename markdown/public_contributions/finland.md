...
The `public contributions` by users in Finland on `2022/11/29 6:00 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/1/13 8:29 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2023/11/3 8:13 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

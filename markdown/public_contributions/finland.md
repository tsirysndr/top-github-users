...
The `public contributions` by users in Finland on `2023/6/24 3:52 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Finland on `2022/11/16 12:13 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `public contributions` by users in Saudi Arabia on `2022/10/15 3:13 AM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

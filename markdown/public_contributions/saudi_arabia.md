...
The `public contributions` by users in Saudi Arabia on `2023/8/14 11:50 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

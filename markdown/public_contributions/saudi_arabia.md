...
The `public contributions` by users in Saudi Arabia on `2023/1/4 12:12 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

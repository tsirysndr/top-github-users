...
The `public contributions` by users in Saudi Arabia on `2022/12/14 7:52 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

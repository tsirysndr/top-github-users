...
The `public contributions` by users in Slovenia on `2023/6/12 4:49 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

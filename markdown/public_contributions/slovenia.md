...
The `public contributions` by users in Slovenia on `2022/12/16 10:52 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

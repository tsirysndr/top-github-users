...
The `public contributions` by users in Slovenia on `2022/12/17 5:47 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

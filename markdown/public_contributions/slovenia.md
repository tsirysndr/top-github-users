...
The `public contributions` by users in Slovenia on `2022/12/18 7:55 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

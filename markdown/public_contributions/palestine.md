...
The `public contributions` by users in Palestine on `2023/9/23 6:22 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

...
The `public contributions` by users in Palestine on `2023/10/31 3:30 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

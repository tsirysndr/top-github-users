...
The `public contributions` by users in Greece on `2023/10/12 4:48 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
...
<table>
	...
	<tr>
		...
		<td>Greek Universities Network (gunet)<br/></td>
		<td>No Twitter Username</td>
		<td>Athens</td>
		<td>398</td>
	</tr>

...
The `public contributions` by users in Greece on `2023/10/10 5:03 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/gsofron">
				<img src="https://avatars.githubusercontent.com/u/100706402?s=72&u=860b1be12efb45c5151a3c8f9d4c13d5a1609256&v=4" width="24" alt="Avatar of gsofron"> gsofron
			</a><br/>
			Giorgos Sofronas
		</td>
		<td>No Company</td>

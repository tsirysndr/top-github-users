...
The `public contributions` by users in Greece on `2023/10/27 4:38 PM UTC`. This list contains users from `Greece` and cities `Athens` `Thessaloniki` `Patras` `Heraklion` `Ioannina` `Pireas` `Volos` `Agrinio`.
...
<table>
	...
	<tr>
		<td>430</td>
		<td>
			<a href="https://github.com/kpelelis">
				<img src="https://avatars.githubusercontent.com/u/13784424?s=72&u=d226cd93313a09004664446b4145ea99311133d0&v=4" width="24" alt="Avatar of kpelelis"> kpelelis
			</a><br/>
			Kostas Pelelis
		</td>
		<td>@grafana </td>

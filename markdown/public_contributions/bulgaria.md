...
The `public contributions` by users in Bulgaria on `2022/11/4 7:16 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

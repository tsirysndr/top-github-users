...
The `public contributions` by users in Bulgaria on `2023/7/30 3:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

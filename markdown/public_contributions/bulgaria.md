...
The `public contributions` by users in Bulgaria on `2023/3/14 6:05 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

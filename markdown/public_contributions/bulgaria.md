...
The `public contributions` by users in Bulgaria on `2023/3/6 8:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

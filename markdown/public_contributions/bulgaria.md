...
The `public contributions` by users in Bulgaria on `2023/2/13 7:53 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

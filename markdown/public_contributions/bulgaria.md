...
The `public contributions` by users in Bulgaria on `2023/10/4 11:58 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `public contributions` by users in Bulgaria on `2023/7/18 5:16 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

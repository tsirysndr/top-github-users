...
The `public contributions` by users in Bulgaria on `2023/10/10 12:42 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

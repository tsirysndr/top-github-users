...
The `public contributions` by users in Bulgaria on `2023/6/12 10:36 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

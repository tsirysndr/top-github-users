...
The `public contributions` by users in Bulgaria on `2023/2/12 8:03 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

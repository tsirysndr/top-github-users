...
The `public contributions` by users in Bulgaria on `2023/8/5 2:51 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `public contributions` by users in Bulgaria on `2023/1/1 2:15 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

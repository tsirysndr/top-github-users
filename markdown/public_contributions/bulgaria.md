...
The `public contributions` by users in Bulgaria on `2022/10/26 11:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `public contributions` by users in Bulgaria on `2022/10/19 7:57 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `public contributions` by users in Bulgaria on `2023/5/16 2:27 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

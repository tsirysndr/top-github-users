...
The `public contributions` by users in Bulgaria on `2023/1/5 2:03 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

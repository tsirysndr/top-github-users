...
The `public contributions` by users in Bulgaria on `2022/11/2 4:53 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

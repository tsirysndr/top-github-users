...
The `public contributions` by users in Bulgaria on `2022/10/9 4:34 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

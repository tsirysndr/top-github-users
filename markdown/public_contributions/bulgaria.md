...
The `public contributions` by users in Bulgaria on `2023/11/5 3:33 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

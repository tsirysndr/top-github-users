...
The `public contributions` by users in Bulgaria on `2023/1/26 5:01 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `public contributions` by users in Bulgaria on `2022/11/26 5:44 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

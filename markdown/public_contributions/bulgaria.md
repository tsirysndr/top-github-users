...
The `public contributions` by users in Bulgaria on `2022/10/27 6:21 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

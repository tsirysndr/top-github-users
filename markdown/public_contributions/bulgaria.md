...
The `public contributions` by users in Bulgaria on `2023/9/13 4:54 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

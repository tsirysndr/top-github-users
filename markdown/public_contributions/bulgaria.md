...
The `public contributions` by users in Bulgaria on `2023/8/28 9:15 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

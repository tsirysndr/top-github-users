...
The `public contributions` by users in Bulgaria on `2022/11/17 4:07 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

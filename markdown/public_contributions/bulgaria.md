...
The `public contributions` by users in Bulgaria on `2023/6/18 7:25 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

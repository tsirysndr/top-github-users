...
The `public contributions` by users in Bulgaria on `2022/12/20 4:38 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

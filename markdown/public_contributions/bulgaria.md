...
The `public contributions` by users in Bulgaria on `2023/10/8 6:24 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

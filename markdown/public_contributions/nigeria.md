...
The `public contributions` by users in Nigeria on `2023/10/24 3:27 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `996 users`  in Nigeria. You need at least `62 followers` to be on this list.

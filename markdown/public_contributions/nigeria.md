...
The `public contributions` by users in Nigeria on `2023/7/13 10:33 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>
			...
			Bolaji Adeniyi Bello
		</td>
		<td>Altschool Africa </td>
		<td><a href="https://twitter.com/belloblj2">belloblj2</a></td>
		<td>Lagos Nigeria</td>
		<td>76</td>
	</tr>
	<tr>

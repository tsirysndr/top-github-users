...
The `public contributions` by users in Nigeria on `2023/11/15 12:48 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `994 users`  in Nigeria. You need at least `61 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/awofiranyesher2">awofiranyesher2</a></td>
		<td>Lagos, Nigeria</td>
		<td>390</td>
	</tr>
	<tr>

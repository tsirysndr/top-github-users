...
The `public contributions` by users in Nigeria on `2023/11/27 9:17 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `993 users`  in Nigeria. You need at least `62 followers` to be on this list.

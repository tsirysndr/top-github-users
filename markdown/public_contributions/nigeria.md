...
The `public contributions` by users in Nigeria on `2023/9/16 7:27 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>Crypto Company </td>
		<td><a href="https://twitter.com/laspyces">laspyces</a></td>
		<td>Nigeria </td>
		<td>1</td>
	</tr>
	<tr>

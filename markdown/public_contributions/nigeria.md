...
The `public contributions` by users in Nigeria on `2023/8/24 9:05 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/nelsonjohn212">nelsonjohn212</a></td>
		<td>Nigeria</td>
		<td>715</td>
	</tr>
	<tr>

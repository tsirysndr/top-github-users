...
The `public contributions` by users in Armenia on `2022/10/8 7:38 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

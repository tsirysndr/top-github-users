...
The `public contributions` by users in Turkey on `2022/11/13 7:10 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `public contributions` by users in Turkey on `2023/7/7 2:14 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

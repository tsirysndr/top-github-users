...
The `public contributions` by users in Turkey on `2023/8/23 7:54 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.
...
<table>
	...
	<tr>
		...
		<td>Tea Networks/software Architect &<br/>Patika.dev/instructo<br/>&<br/>Freelancer/software<br/>Consultant<br/></td>
		<td>No Twitter Username</td>
		<td>Turkey</td>
		<td>229</td>
	</tr>

...
The `public contributions` by users in Turkey on `2023/2/27 7:12 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

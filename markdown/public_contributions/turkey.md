...
The `public contributions` by users in Turkey on `2022/12/6 11:14 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

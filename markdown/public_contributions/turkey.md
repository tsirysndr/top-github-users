...
The `public contributions` by users in Turkey on `2023/2/17 7:11 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

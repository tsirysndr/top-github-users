...
The `public contributions` by users in Turkey on `2023/9/11 7:04 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

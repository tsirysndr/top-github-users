...
The `public contributions` by users in Uganda on `2023/6/28 5:49 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `977 users`  in Uganda. You need at least `5 followers` to be on this list.

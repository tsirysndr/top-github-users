...
The `public contributions` by users in Uganda on `2023/9/13 12:46 PM UTC`. This list contains users from `Uganda` and cities `Kampala`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/bivetes">bivetes</a></td>
		<td>Kampala, uganda</td>
		<td>5</td>
	</tr>
	<tr>

...
The `public contributions` by users in Azerbaijan on `2023/1/9 8:05 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/1/13 3:49 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2022/10/16 5:45 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

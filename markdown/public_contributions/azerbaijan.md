...
The `public contributions` by users in Azerbaijan on `2023/4/25 5:50 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

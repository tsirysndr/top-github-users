...
The `public contributions` by users in Azerbaijan on `2023/10/27 11:30 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

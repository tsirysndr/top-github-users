...
The `public contributions` by users in Azerbaijan on `2023/9/30 12:09 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

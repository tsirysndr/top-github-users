...
The `public contributions` by users in Azerbaijan on `2023/10/6 5:28 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/9/25 12:13 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

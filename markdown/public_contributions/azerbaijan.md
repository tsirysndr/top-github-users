...
The `public contributions` by users in Azerbaijan on `2023/12/2 5:40 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

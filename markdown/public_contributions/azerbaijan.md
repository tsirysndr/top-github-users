...
The `public contributions` by users in Azerbaijan on `2023/8/7 12:04 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

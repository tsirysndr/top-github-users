...
The `public contributions` by users in Azerbaijan on `2023/11/7 1:33 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

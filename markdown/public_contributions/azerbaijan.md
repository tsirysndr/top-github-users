...
The `public contributions` by users in Azerbaijan on `2023/8/29 8:02 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/6/16 1:57 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/9/3 5:58 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

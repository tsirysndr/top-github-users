...
The `public contributions` by users in Azerbaijan on `2022/10/12 6:53 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

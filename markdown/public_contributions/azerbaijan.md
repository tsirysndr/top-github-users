...
The `public contributions` by users in Azerbaijan on `2023/3/22 5:07 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/11/18 8:08 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

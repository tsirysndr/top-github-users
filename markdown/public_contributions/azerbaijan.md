...
The `public contributions` by users in Azerbaijan on `2023/7/25 1:00 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

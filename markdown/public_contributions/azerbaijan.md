...
The `public contributions` by users in Azerbaijan on `2022/11/29 8:46 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

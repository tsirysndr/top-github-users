...
The `public contributions` by users in Azerbaijan on `2023/7/30 6:53 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/7/8 11:17 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2023/4/13 4:40 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

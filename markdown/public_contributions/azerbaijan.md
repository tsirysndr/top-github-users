...
The `public contributions` by users in Azerbaijan on `2023/7/10 6:07 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

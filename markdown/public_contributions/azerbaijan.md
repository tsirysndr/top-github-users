...
The `public contributions` by users in Azerbaijan on `2023/11/13 2:12 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

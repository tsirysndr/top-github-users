...
The `public contributions` by users in Azerbaijan on `2023/6/18 12:54 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2022/11/27 10:58 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

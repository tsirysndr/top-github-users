...
The `public contributions` by users in Azerbaijan on `2023/7/15 11:09 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

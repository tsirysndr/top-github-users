...
The `public contributions` by users in Azerbaijan on `2023/2/5 12:06 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

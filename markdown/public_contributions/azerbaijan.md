...
The `public contributions` by users in Azerbaijan on `2023/9/14 9:19 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

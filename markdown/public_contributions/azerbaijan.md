...
The `public contributions` by users in Azerbaijan on `2022/11/25 2:28 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

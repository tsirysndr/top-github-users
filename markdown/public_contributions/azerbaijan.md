...
The `public contributions` by users in Azerbaijan on `2023/7/15 5:47 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

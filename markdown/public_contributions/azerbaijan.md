...
The `public contributions` by users in Azerbaijan on `2023/9/28 12:29 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

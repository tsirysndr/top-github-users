...
The `public contributions` by users in Azerbaijan on `2022/11/5 8:00 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2022/12/19 8:19 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

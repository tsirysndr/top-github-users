...
The `public contributions` by users in Azerbaijan on `2023/6/28 2:50 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

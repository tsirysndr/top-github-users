...
The `public contributions` by users in Azerbaijan on `2023/4/23 10:49 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

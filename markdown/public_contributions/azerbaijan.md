...
The `public contributions` by users in Azerbaijan on `2022/12/3 1:56 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

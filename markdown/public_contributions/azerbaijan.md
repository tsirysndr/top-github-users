...
The `public contributions` by users in Azerbaijan on `2023/9/1 7:18 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `public contributions` by users in Azerbaijan on `2022/12/14 6:25 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

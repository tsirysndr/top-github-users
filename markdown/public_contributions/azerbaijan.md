...
The `public contributions` by users in Azerbaijan on `2023/1/16 10:27 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

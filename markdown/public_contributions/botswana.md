...
The `public contributions` by users in Botswana on `2022/10/16 6:45 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

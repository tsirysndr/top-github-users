...
The `public contributions` by users in Botswana on `2022/10/19 7:31 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

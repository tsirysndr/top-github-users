...
The `public contributions` by users in Botswana on `2022/11/18 6:36 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `public contributions` by users in Botswana on `2022/12/7 10:48 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

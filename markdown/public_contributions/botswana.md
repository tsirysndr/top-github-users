...
The `public contributions` by users in Botswana on `2022/10/23 9:30 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

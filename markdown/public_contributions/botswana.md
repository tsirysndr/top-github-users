...
The `public contributions` by users in Botswana on `2023/9/28 1:28 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

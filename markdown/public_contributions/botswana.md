...
The `public contributions` by users in Botswana on `2023/4/28 4:41 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `public contributions` by users in Botswana on `2022/12/1 12:12 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

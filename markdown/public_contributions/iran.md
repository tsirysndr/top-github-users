...
The `public contributions` by users in Iran on `2022/10/15 4:18 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `public contributions` by users in Iran on `2022/11/15 6:17 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

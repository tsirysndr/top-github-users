...
The `public contributions` by users in Iran on `2022/10/28 6:54 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

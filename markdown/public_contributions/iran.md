...
The `public contributions` by users in Iran on `2022/12/10 1:47 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `public contributions` by users in Iran on `2022/10/20 7:56 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `public contributions` by users in Iran on `2022/10/14 7:45 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

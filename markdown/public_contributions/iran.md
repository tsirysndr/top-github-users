...
The `public contributions` by users in Iran on `2022/12/25 4:29 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

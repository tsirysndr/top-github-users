...
The `public contributions` by users in Iran on `2022/10/6 9:26 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

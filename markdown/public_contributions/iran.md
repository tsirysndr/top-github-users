...
The `public contributions` by users in Iran on `2022/12/9 6:53 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `public contributions` by users in Iran on `2022/12/23 7:44 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

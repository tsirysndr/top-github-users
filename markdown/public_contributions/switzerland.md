...
The `public contributions` by users in Switzerland on `2023/9/24 2:59 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/6/20 5:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/1/29 3:38 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/1/23 3:45 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

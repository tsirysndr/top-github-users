...
The `public contributions` by users in Switzerland on `2023/9/8 8:49 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/4/13 1:13 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

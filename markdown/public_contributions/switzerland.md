...
The `public contributions` by users in Switzerland on `2023/2/20 7:52 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

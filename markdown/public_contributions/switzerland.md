...
The `public contributions` by users in Switzerland on `2023/1/24 10:45 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

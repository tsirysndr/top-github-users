...
The `public contributions` by users in Switzerland on `2023/4/1 4:35 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

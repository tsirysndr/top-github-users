...
The `public contributions` by users in Switzerland on `2022/11/29 4:53 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

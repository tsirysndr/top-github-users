...
The `public contributions` by users in Switzerland on `2023/9/1 3:46 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/5/7 8:41 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

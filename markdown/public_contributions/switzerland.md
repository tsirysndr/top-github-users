...
The `public contributions` by users in Switzerland on `2022/11/23 8:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/10/13 2:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

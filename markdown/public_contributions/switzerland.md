...
The `public contributions` by users in Switzerland on `2023/5/17 6:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

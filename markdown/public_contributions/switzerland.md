...
The `public contributions` by users in Switzerland on `2023/9/25 8:35 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

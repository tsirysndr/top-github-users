...
The `public contributions` by users in Switzerland on `2023/3/3 5:20 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/8/9 1:16 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

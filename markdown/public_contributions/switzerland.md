...
The `public contributions` by users in Switzerland on `2023/1/12 11:50 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

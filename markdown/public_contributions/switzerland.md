...
The `public contributions` by users in Switzerland on `2022/12/17 7:00 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

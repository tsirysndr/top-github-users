...
The `public contributions` by users in Switzerland on `2023/1/26 12:04 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

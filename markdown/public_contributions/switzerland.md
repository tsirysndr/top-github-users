...
The `public contributions` by users in Switzerland on `2023/1/17 1:42 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2022/10/14 8:10 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

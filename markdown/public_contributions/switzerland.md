...
The `public contributions` by users in Switzerland on `2023/12/3 1:04 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` by users in Switzerland on `2023/4/27 2:20 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

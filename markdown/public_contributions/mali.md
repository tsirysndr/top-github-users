...
The `public contributions` by users in Mali on `2022/11/8 2:24 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `304 users`  in Mali. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>94</td>
		<td>
			<a href="https://github.com/diagnediaraff">
				<img src="https://avatars.githubusercontent.com/u/45207119?s=72&v=4" width="24" alt="Avatar of diagnediaraff"> diagnediaraff
			</a><br/>
			Di@gneMLEngineer
		</td>
		<td>Orange </td>

...
The `public contributions` by users in Ecuador on `2023/11/23 8:10 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

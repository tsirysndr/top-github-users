...
The `public contributions` by users in Ecuador on `2022/10/8 11:58 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

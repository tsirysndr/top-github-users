...
The `public contributions` by users in Ecuador on `2023/6/14 12:22 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` by users in Ecuador on `2023/8/28 11:33 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

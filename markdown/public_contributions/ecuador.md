...
The `public contributions` by users in Ecuador on `2023/10/25 9:01 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

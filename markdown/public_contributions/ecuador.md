...
The `public contributions` by users in Ecuador on `2022/11/12 11:40 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

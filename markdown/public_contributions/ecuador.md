...
The `public contributions` by users in Ecuador on `2023/3/20 1:57 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

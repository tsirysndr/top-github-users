...
The `public contributions` by users in Ecuador on `2022/10/23 12:35 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

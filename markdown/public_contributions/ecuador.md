...
The `public contributions` by users in Ecuador on `2023/10/28 8:52 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

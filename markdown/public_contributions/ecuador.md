...
The `public contributions` by users in Ecuador on `2023/7/15 9:17 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

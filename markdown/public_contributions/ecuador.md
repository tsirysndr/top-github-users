...
The `public contributions` by users in Ecuador on `2022/11/19 4:20 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

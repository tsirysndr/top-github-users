...
The `public contributions` by users in Ecuador on `2023/10/1 2:35 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

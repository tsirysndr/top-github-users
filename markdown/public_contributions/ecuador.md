...
The `public contributions` by users in Ecuador on `2023/5/23 7:54 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

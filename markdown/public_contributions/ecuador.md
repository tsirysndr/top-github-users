...
The `public contributions` by users in Ecuador on `2023/1/30 4:28 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

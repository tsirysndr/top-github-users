...
The `public contributions` by users in Ecuador on `2023/9/11 1:33 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

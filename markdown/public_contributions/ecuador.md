...
The `public contributions` by users in Ecuador on `2023/5/29 10:00 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

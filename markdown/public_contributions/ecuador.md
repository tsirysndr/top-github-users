...
The `public contributions` by users in Ecuador on `2023/2/27 1:59 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

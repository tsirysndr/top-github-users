...
The `public contributions` by users in Ecuador on `2023/3/12 1:37 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

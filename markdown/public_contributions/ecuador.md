...
The `public contributions` by users in Ecuador on `2023/2/16 1:39 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

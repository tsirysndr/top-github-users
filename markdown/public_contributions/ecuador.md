...
The `public contributions` by users in Ecuador on `2022/10/15 1:21 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

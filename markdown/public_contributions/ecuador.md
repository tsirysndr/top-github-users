...
The `public contributions` by users in Ecuador on `2022/12/28 6:01 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

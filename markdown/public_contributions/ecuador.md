...
The `public contributions` by users in Ecuador on `2022/10/31 9:42 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

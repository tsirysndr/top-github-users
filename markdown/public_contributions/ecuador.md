...
The `public contributions` by users in Ecuador on `2023/4/9 2:36 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

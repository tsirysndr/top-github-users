...
The `public contributions` by users in Ecuador on `2022/12/4 12:41 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

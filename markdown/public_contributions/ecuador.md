...
The `public contributions` by users in Ecuador on `2022/10/12 3:51 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

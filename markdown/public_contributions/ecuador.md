...
The `public contributions` by users in Ecuador on `2023/4/6 4:24 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

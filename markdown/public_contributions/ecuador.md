...
The `public contributions` by users in Ecuador on `2022/11/22 8:47 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

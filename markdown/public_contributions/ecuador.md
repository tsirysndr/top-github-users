...
The `public contributions` by users in Ecuador on `2023/2/4 4:47 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

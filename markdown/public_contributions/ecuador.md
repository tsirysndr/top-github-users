...
The `public contributions` by users in Ecuador on `2023/9/7 4:14 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` by users in Ecuador on `2022/12/13 3:01 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

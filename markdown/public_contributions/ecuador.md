...
The `public contributions` by users in Ecuador on `2023/4/13 8:14 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` by users in Ecuador on `2022/10/27 8:50 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` by users in Ecuador on `2023/3/1 2:59 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

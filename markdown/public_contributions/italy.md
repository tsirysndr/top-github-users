...
The `public contributions` by users in Italy on `2023/9/10 10:51 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `978 users`  in Italy. You need at least `64 followers` to be on this list.

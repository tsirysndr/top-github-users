...
The `public contributions` by users in Myanmar on `2023/8/22 8:57 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/typle">
				<img src="https://avatars.githubusercontent.com/u/115131869?s=72&v=4" width="24" alt="Avatar of typle"> typle
			</a><br/>
			Typle
		</td>
		<td>No Company</td>

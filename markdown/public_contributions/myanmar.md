...
The `public contributions` by users in Myanmar on `2023/10/12 9:36 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Novarista13">
				<img src="https://avatars.githubusercontent.com/u/134473935?s=72&v=4" width="24" alt="Avatar of Novarista13"> Novarista13
			</a><br/>
			Nova
		</td>
		<td>No Company</td>

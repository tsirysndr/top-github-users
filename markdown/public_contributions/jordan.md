...
The `public contributions` by users in Jordan on `2023/7/12 1:18 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.
...
<table>
	...
	<tr>
		...
		<td>@jordanopensource </td>
		<td><a href="https://twitter.com/mbaraa271">mbaraa271</a></td>
		<td>Amman, Jordan</td>
		<td>294</td>
	</tr>
	<tr>

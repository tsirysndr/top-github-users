...
The `public contributions` by users in Jordan on `2022/12/11 9:49 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2022/12/21 6:17 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

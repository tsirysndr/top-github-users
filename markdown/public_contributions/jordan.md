...
The `public contributions` by users in Jordan on `2022/10/14 9:02 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

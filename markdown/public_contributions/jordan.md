...
The `public contributions` by users in Jordan on `2023/4/24 11:13 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

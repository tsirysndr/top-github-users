...
The `public contributions` by users in Jordan on `2023/4/21 12:58 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

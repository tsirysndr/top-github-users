...
The `public contributions` by users in Jordan on `2023/10/2 11:23 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2023/9/28 7:42 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

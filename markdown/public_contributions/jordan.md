...
The `public contributions` by users in Jordan on `2023/10/10 12:35 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2022/11/26 11:41 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

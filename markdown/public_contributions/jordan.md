...
The `public contributions` by users in Jordan on `2023/8/23 11:54 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2022/10/7 1:12 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

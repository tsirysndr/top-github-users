...
The `public contributions` by users in Jordan on `2023/5/6 3:07 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

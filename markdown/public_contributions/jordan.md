...
The `public contributions` by users in Jordan on `2023/8/20 1:11 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

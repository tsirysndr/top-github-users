...
The `public contributions` by users in Jordan on `2023/5/4 7:27 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

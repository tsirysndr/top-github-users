...
The `public contributions` by users in Jordan on `2023/8/8 12:21 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

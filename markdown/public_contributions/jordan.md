...
The `public contributions` by users in Jordan on `2022/12/5 12:12 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

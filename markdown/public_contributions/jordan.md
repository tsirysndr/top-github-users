...
The `public contributions` by users in Jordan on `2023/8/25 5:25 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

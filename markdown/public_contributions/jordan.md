...
The `public contributions` by users in Jordan on `2023/3/11 11:33 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2023/2/11 2:51 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

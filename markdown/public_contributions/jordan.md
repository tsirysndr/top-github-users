...
The `public contributions` by users in Jordan on `2023/7/9 12:32 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

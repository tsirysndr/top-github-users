...
The `public contributions` by users in Jordan on `2022/11/21 10:01 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

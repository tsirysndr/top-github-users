...
The `public contributions` by users in Jordan on `2023/7/23 4:36 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

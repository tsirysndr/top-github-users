...
The `public contributions` by users in Jordan on `2023/9/2 7:28 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` by users in Jordan on `2023/11/17 9:34 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

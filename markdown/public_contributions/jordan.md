...
The `public contributions` by users in Jordan on `2022/10/15 5:32 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

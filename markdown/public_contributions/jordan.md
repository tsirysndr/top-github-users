...
The `public contributions` by users in Jordan on `2023/9/28 1:42 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `983 users`  in Jordan. You need at least `6 followers` to be on this list.

...
The `public contributions` by users in Jordan on `2023/1/14 9:16 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

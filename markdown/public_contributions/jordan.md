...
The `public contributions` by users in Jordan on `2023/6/19 12:58 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

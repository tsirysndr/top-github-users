...
The `public contributions` by users in Jordan on `2022/10/9 3:43 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

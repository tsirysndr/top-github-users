...
The `public contributions` by users in Georgia on `2022/12/18 10:25 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `public contributions` by users in Georgia on `2022/12/13 4:03 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

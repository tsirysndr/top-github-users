...
The `public contributions` by users in Georgia on `2022/11/13 7:45 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

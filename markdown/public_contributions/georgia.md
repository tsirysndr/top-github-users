...
The `public contributions` by users in Georgia on `2022/10/10 3:12 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

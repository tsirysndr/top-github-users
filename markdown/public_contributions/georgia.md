...
The `public contributions` by users in Georgia on `2022/10/21 2:00 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `public contributions` by users in Lithuania on `2023/6/12 11:08 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

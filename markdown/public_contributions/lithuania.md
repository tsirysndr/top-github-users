...
The `public contributions` by users in Lithuania on `2023/7/6 12:59 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

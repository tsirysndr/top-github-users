...
The `public contributions` by users in Lithuania on `2023/11/28 12:26 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Vilnius (LT) / Kristiansand (NO)</td>
		<td>106</td>
	</tr>
	<tr>
		<td>191</td>

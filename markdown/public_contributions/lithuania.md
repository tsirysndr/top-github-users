...
The `public contributions` by users in Lithuania on `2022/12/6 3:19 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

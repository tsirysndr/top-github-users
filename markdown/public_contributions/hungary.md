...
The `public contributions` by users in Hungary on `2022/11/17 8:30 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

...
The `public contributions` by users in United States on `2023/6/23 3:09 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `940 users`  in United States. You need at least `472 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/lucidrains">lucidrains</a></td>
		<td>San Francisco</td>
		<td>3552</td>
	</tr>
	<tr>

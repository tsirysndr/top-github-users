...
The `public contributions` by users in Venezuela on `2023/4/19 4:15 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

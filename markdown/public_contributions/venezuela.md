...
The `public contributions` by users in Venezuela on `2022/12/1 9:03 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

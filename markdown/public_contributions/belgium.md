...
The `public contributions` by users in Belgium on `2022/12/21 11:00 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

...
The `public contributions` by users in Norway on `2023/10/17 10:05 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

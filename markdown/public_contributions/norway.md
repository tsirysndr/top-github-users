...
The `public contributions` by users in Norway on `2022/10/23 12:48 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` by users in Norway on `2022/11/19 11:39 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

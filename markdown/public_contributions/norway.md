...
The `public contributions` by users in Norway on `2022/11/10 10:17 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

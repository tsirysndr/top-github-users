...
The `public contributions` by users in New Zealand on `2022/11/2 7:30 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.

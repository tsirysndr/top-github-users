...
The `public contributions` by users in New Zealand on `2022/12/3 12:40 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.

...
The `public contributions` by users in New Zealand on `2022/11/7 2:12 AM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.

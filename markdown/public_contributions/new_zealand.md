...
The `public contributions` by users in New Zealand on `2023/1/2 6:35 PM UTC`. This list contains users from `New Zealand` and cities `Auckland` `Wellington` `Christchurch` `Dunedin`.

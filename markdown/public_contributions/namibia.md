...
The `public contributions` by users in Namibia on `2023/3/13 1:23 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `public contributions` by users in Namibia on `2023/1/22 4:47 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `public contributions` by users in Namibia on `2022/12/20 7:03 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `public contributions` by users in Namibia on `2022/11/18 8:52 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

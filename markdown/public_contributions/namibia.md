...
The `public contributions` by users in Namibia on `2023/4/23 8:16 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
...
<table>
	...
	<tr>
		<td>120</td>
		<td>
			<a href="https://github.com/FredyEmbashu">
				<img src="https://avatars.githubusercontent.com/u/113780166?s=72&v=4" width="24" alt="Avatar of FredyEmbashu"> FredyEmbashu
			</a><br/>
			Fredy Embashu
		</td>
		<td>Cirrus Capital Pty (ltd)<br/></td>
		<td>No Twitter Username</td>
		<td>Namibia</td>
		<td>11</td>
	</tr>

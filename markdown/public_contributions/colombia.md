...
The `public contributions` by users in Colombia on `2023/10/16 7:46 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/6/27 11:39 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

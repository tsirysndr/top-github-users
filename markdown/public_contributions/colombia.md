...
The `public contributions` by users in Colombia on `2022/11/24 9:51 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

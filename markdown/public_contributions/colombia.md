...
The `public contributions` by users in Colombia on `2023/7/14 2:28 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2022/10/20 4:12 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/4/6 3:20 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

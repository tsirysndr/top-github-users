...
The `public contributions` by users in Colombia on `2023/9/13 6:09 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

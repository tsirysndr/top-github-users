...
The `public contributions` by users in Colombia on `2022/12/9 3:02 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

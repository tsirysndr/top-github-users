...
The `public contributions` by users in Colombia on `2022/11/22 7:39 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

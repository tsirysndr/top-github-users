...
The `public contributions` by users in Colombia on `2023/8/19 3:54 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/6/15 5:01 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

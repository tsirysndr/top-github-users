...
The `public contributions` by users in Colombia on `2023/4/13 7:09 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

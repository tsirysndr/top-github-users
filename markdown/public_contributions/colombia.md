...
The `public contributions` by users in Colombia on `2023/11/17 5:03 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

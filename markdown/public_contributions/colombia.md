...
The `public contributions` by users in Colombia on `2022/10/12 9:35 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

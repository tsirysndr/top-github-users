...
The `public contributions` by users in Colombia on `2023/1/27 4:36 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/7/20 2:47 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

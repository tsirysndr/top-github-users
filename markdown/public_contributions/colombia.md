...
The `public contributions` by users in Colombia on `2023/7/23 12:18 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/davrivas">
				<img src="https://avatars.githubusercontent.com/u/15196755?s=72&v=4" width="24" alt="Avatar of davrivas"> davrivas
			</a><br/>
			David Rivas
		</td>

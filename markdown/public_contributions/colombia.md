...
The `public contributions` by users in Colombia on `2023/9/22 4:39 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

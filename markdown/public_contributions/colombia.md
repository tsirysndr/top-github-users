...
The `public contributions` by users in Colombia on `2022/10/28 3:14 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

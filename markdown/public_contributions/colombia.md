...
The `public contributions` by users in Colombia on `2023/8/6 9:02 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

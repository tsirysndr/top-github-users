...
The `public contributions` by users in Colombia on `2022/11/4 8:38 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

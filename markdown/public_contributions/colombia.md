...
The `public contributions` by users in Colombia on `2022/11/7 12:58 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/9/27 3:06 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` by users in Colombia on `2023/10/15 2:18 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

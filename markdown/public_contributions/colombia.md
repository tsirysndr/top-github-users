...
The `public contributions` by users in Colombia on `2023/10/21 2:15 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

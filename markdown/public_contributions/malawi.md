...
The `public contributions` by users in Malawi on `2022/10/7 2:30 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.

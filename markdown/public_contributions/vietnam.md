...
The `public contributions` by users in Vietnam on `2023/8/13 5:00 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

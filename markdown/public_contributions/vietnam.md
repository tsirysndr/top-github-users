...
The `public contributions` by users in Vietnam on `2023/10/18 9:55 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

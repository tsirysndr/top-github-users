...
The `public contributions` by users in Belarus on `2022/11/18 6:00 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

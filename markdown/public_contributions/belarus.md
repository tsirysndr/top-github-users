...
The `public contributions` by users in Belarus on `2022/10/20 2:02 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

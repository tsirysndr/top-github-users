...
The `public contributions` by users in Belarus on `2022/11/14 5:40 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

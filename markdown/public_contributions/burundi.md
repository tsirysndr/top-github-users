...
The `public contributions` by users in Burundi on `2023/6/20 10:00 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

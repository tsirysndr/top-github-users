...
The `public contributions` by users in Burundi on `2023/9/10 12:35 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `365 users`  in Burundi. You need at least `0 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/jspmic">
				<img src="https://avatars.githubusercontent.com/u/46091001?s=72&u=155f48d56da6f3f978f32117b42cde927b931154&v=4" width="24" alt="Avatar of jspmic"> jspmic
			</a><br/>
			jaspe_mic
		</td>
		<td>No Company</td>

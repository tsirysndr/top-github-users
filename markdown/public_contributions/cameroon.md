...
The `public contributions` by users in Cameroon on `2023/8/14 1:08 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/_salomon_D">_salomon_D</a></td>
		<td>Douala, Cameroon</td>
		<td>152</td>
	</tr>
	<tr>

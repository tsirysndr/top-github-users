...
The `public contributions` by users in Estonia on `2022/10/20 5:47 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

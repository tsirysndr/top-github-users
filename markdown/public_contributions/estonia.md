...
The `public contributions` by users in Estonia on `2022/11/7 2:27 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

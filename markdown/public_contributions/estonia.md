...
The `public contributions` by users in Estonia on `2023/1/1 5:15 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

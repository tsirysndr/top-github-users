...
The `public contributions` by users in China on `2023/10/19 8:03 AM UTC`. This list contains users from `China` and cities `Beijing` `Shanghai` `Guangzhou` `Shenzhen` `Chongqing` `Chengdu` `Harbin` `Tianjin`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `962 users`  in China. You need at least `636 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Tencent->netease Games->pazhoulab </td>
		<td>No Twitter Username</td>
		<td>Guangzhou</td>
		<td>58</td>
	</tr>

...
The `public contributions` by users in Mauritania on `2022/11/10 8:11 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

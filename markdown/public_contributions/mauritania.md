...
The `public contributions` by users in Mauritania on `2023/6/10 8:00 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

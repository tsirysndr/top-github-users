...
The `public contributions` by users in Mauritania on `2022/10/12 9:09 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

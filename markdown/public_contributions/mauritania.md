...
The `public contributions` by users in Mauritania on `2023/2/16 12:45 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

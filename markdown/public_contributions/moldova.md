...
The `public contributions` by users in Moldova on `2023/8/9 1:39 PM UTC`. This list contains users from `Moldova` and cities `Chișinău` `Tiraspol`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/vforvasile">vforvasile</a></td>
		<td>Moldova</td>
		<td>43</td>
	</tr>
	<tr>

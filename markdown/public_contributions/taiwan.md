...
The `public contributions` by users in Taiwan on `2022/10/24 6:36 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

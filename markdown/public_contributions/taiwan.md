...
The `public contributions` by users in Taiwan on `2023/6/15 10:45 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` by users in Taiwan on `2022/11/16 10:06 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

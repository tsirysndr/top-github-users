...
The `public contributions` by users in Taiwan on `2023/4/15 12:37 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

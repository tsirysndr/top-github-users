...
The `public contributions` by users in Taiwan on `2023/9/14 11:46 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

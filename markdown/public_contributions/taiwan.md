...
The `public contributions` by users in Taiwan on `2023/6/14 11:08 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

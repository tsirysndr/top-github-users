...
The `public contributions` by users in Taiwan on `2022/11/14 7:49 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

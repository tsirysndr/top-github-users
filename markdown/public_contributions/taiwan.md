...
The `public contributions` by users in Taiwan on `2023/10/13 8:29 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

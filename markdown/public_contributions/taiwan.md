...
The `public contributions` by users in Taiwan on `2022/10/15 11:56 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` by users in Taiwan on `2022/10/28 10:27 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

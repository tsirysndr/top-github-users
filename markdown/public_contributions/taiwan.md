...
The `public contributions` by users in Taiwan on `2023/1/16 12:56 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` by users in Taiwan on `2023/8/28 10:21 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

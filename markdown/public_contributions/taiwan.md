...
The `public contributions` by users in Taiwan on `2022/10/13 6:01 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

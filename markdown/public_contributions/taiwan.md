...
The `public contributions` by users in Taiwan on `2022/12/11 4:57 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

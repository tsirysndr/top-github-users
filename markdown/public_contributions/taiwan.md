...
The `public contributions` by users in Taiwan on `2022/11/14 12:46 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

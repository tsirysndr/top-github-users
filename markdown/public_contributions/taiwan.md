...
The `public contributions` by users in Taiwan on `2022/10/18 2:06 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

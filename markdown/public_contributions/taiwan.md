...
The `public contributions` by users in Taiwan on `2023/5/12 10:41 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

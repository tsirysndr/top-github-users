...
The `public contributions` by users in Taiwan on `2023/11/20 3:14 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` by users in Ukraine on `2023/9/11 7:22 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `980 users`  in Ukraine. You need at least `42 followers` to be on this list.

...
The `public contributions` by users in Ukraine on `2023/6/20 6:03 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `984 users`  in Ukraine. You need at least `40 followers` to be on this list.

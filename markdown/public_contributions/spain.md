...
The `public contributions` by users in Spain on `2022/12/6 9:50 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

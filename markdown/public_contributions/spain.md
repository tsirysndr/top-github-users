...
The `public contributions` by users in Spain on `2023/2/13 2:04 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

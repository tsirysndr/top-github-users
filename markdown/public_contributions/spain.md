...
The `public contributions` by users in Spain on `2023/9/30 1:44 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

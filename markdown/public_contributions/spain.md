...
The `public contributions` by users in Spain on `2022/10/7 1:19 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

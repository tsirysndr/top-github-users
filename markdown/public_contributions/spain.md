...
The `public contributions` by users in Spain on `2023/1/1 8:37 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` by users in Spain on `2022/10/31 8:45 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

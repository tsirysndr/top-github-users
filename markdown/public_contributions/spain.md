...
The `public contributions` by users in Spain on `2023/7/23 10:57 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` by users in Spain on `2023/2/23 1:42 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

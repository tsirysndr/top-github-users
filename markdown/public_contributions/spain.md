...
The `public contributions` by users in Spain on `2022/10/27 12:30 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

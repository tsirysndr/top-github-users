...
The `public contributions` by users in Spain on `2023/6/16 9:50 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` by users in Spain on `2022/12/7 5:21 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

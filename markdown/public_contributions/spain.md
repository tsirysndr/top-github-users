...
The `public contributions` by users in Spain on `2023/1/16 6:01 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` by users in Mozambique  on `2023/4/12 2:11 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `public contributions` by users in Mozambique  on `2023/1/16 1:30 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

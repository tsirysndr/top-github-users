...
The `public contributions` by users in Mozambique  on `2022/10/26 1:00 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

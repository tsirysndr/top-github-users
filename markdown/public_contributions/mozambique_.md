...
The `public contributions` by users in Mozambique  on `2022/12/27 10:20 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

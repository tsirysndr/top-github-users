...
The `public contributions` by users in Mozambique  on `2022/10/14 11:42 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

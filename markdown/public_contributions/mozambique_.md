...
The `public contributions` by users in Mozambique  on `2022/12/10 5:30 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `public contributions` by users in Mozambique  on `2022/10/12 10:09 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

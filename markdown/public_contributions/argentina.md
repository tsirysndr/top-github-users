...
The `public contributions` by users in Argentina on `2023/6/1 4:42 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/ExequielWiedermann">
				<img src="https://avatars.githubusercontent.com/u/3842005?s=72&u=b54e30972d5a76db9c77a7c731be243e0cdad524&v=4" width="24" alt="Avatar of ExequielWiedermann"> ExequielWiedermann
			</a><br/>
			Exequiel Wiedermann
		</td>
		<td>Init-dev </td>

...
The `public contributions` by users in Argentina on `2023/6/12 8:46 PM UTC`. This list contains users from `Argentina` and cities `Buenos-aires` `Cordoba` `Rosario` `La-plata` `Tucumán` `Mar-del-plata` `Salta` `Santa-fe`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/GMaiolo">
				<img src="https://avatars.githubusercontent.com/u/9776436?s=72&u=406dd41fbc0259005abf0a3995a62c4b3a9b5350&v=4" width="24" alt="Avatar of GMaiolo"> GMaiolo
			</a><br/>
			Guillermo Maiolo
		</td>
		<td>@zeta-chain </td>

...
The `public contributions` by users in Luxembourg on `2023/7/30 9:28 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/alexnesov">
				<img src="https://avatars.githubusercontent.com/u/54157485?s=72&u=bf3c5f73e3c9dea0d4bea738726e2813925dab82&v=4" width="24" alt="Avatar of alexnesov"> alexnesov
			</a><br/>
			Alex Nesovic
		</td>
		<td>No Company</td>

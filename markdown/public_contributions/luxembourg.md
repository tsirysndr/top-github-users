...
The `public contributions` by users in Luxembourg on `2023/7/17 12:25 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Sn0wAlice">
				<img src="https://avatars.githubusercontent.com/u/38856824?s=72&u=6977d2f17b48642aae14e4d2da6fa2f0c9a840b6&v=4" width="24" alt="Avatar of Sn0wAlice"> Sn0wAlice
			</a><br/>
			Alice Snow
		</td>

...
The `public contributions` by users in Benin on `2023/6/4 6:37 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		<td>573</td>
		<td>
			<a href="https://github.com/richiemicky-1">
				<img src="https://avatars.githubusercontent.com/u/131937112?s=72&v=4" width="24" alt="Avatar of richiemicky-1"> richiemicky-1
			</a><br/>
			Laz Richard
		</td>
		<td>Student </td>

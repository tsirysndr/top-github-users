...
The `public contributions` by users in Benin on `2023/8/6 7:17 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.
...
<table>
	...
	<tr>
		<td>305</td>
		<td>
			<a href="https://github.com/Esosa-Agbonavbare">
				<img src="https://avatars.githubusercontent.com/u/132369952?s=72&v=4" width="24" alt="Avatar of Esosa-Agbonavbare"> Esosa-Agbonavbare
			</a><br/>
			Esosa Stephen Agbonavbare
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Benin city</td>

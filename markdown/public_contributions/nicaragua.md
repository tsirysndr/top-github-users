...
The `public contributions` by users in Nicaragua on `2022/10/6 1:54 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

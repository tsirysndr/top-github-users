...
The `public contributions` by users in Nicaragua on `2023/10/18 4:00 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

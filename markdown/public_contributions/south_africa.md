...
The `public contributions` by users in South Africa on `2022/12/10 9:50 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

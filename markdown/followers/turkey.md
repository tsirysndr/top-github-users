...
The `number of followers` of users in Turkey on `2022/12/2 3:27 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `number of followers` of users in Turkey on `2023/1/25 5:35 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

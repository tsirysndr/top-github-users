...
The `number of followers` of users in Turkey on `2023/1/21 10:08 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

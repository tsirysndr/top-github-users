...
The `number of followers` of users in Turkey on `2023/11/21 10:09 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `number of followers` of users in Turkey on `2023/5/19 12:12 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

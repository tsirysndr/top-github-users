...
The `number of followers` of users in Turkey on `2023/2/12 4:05 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `number of followers` of users in Turkey on `2023/3/4 6:01 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

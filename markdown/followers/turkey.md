...
The `number of followers` of users in Turkey on `2023/7/21 9:04 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

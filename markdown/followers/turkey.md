...
The `number of followers` of users in Turkey on `2023/7/30 4:08 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

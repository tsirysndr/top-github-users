...
The `number of followers` of users in Turkey on `2022/11/16 4:08 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `number of followers` of users in Malawi on `2022/10/12 8:40 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.

...
The `number of followers` of users in Syria on `2023/7/28 12:29 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

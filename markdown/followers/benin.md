...
The `number of followers` of users in Benin on `2022/11/10 6:54 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

...
The `number of followers` of users in Benin on `2022/10/27 5:43 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

...
The `number of followers` of users in Benin on `2023/6/4 6:37 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

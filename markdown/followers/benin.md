...
The `number of followers` of users in Benin on `2023/6/27 9:50 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

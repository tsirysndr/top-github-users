...
The `number of followers` of users in Benin on `2022/12/18 6:21 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

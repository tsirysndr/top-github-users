...
The `number of followers` of users in Benin on `2022/11/3 11:07 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

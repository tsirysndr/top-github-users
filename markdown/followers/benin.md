...
The `number of followers` of users in Benin on `2023/7/22 5:43 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

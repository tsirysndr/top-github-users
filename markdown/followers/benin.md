...
The `number of followers` of users in Benin on `2023/4/22 12:21 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

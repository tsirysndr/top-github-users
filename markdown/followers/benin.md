...
The `number of followers` of users in Benin on `2023/4/8 6:25 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

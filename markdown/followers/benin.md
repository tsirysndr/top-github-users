...
The `number of followers` of users in Benin on `2022/11/8 6:17 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

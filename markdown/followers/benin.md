...
The `number of followers` of users in Benin on `2023/10/17 6:22 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

...
The `number of followers` of users in Benin on `2022/10/24 4:46 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

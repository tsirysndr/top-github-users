...
The `number of followers` of users in Benin on `2023/10/23 5:42 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

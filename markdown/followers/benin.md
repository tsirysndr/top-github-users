...
The `number of followers` of users in Benin on `2023/11/22 1:37 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

...
The `number of followers` of users in Cameroon on `2023/7/10 1:07 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

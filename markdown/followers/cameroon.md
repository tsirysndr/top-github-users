...
The `number of followers` of users in Cameroon on `2023/10/17 1:01 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

...
The `number of followers` of users in Cameroon on `2023/7/14 1:34 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

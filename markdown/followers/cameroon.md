...
The `number of followers` of users in Cameroon on `2023/6/5 1:10 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

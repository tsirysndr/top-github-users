...
The `number of followers` of users in Cameroon on `2023/9/16 4:08 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

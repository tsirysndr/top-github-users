...
The `number of followers` of users in Cameroon on `2023/8/24 6:09 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

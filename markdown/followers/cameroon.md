...
The `number of followers` of users in Cameroon on `2023/11/23 6:13 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

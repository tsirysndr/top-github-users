...
The `number of followers` of users in Cameroon on `2023/11/22 2:32 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

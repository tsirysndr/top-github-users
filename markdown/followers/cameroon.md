...
The `number of followers` of users in Cameroon on `2023/9/24 2:44 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

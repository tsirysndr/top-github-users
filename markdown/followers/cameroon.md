...
The `number of followers` of users in Cameroon on `2023/8/23 6:28 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

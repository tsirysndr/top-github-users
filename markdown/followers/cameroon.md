...
The `number of followers` of users in Cameroon on `2023/6/26 1:00 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

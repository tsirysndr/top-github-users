...
The `number of followers` of users in Cameroon on `2023/9/29 7:59 AM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

...
The `number of followers` of users in Cameroon on `2023/9/27 8:21 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

...
The `number of followers` of users in Cameroon on `2023/11/7 5:23 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

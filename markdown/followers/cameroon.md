...
The `number of followers` of users in Cameroon on `2023/7/13 7:42 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

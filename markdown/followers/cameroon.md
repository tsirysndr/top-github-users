...
The `number of followers` of users in Cameroon on `2023/10/20 7:45 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

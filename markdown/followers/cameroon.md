...
The `number of followers` of users in Cameroon on `2023/7/25 8:00 PM UTC`. This list contains users from `Cameroon` and cities `Yaoundé` `Douala` `Kumba` `Bamenda` `Garoua` `Ngaoundere`.

...
The `number of followers` of users in Palestine on `2023/11/9 2:39 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

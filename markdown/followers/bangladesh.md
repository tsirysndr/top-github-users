...
The `number of followers` of users in Bangladesh on `2022/12/10 7:31 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

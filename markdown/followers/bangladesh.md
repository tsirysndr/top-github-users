...
The `number of followers` of users in Bangladesh on `2023/1/13 4:04 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

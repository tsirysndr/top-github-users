...
The `number of followers` of users in Bangladesh on `2023/10/6 5:45 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

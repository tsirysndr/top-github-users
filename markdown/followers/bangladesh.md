...
The `number of followers` of users in Bangladesh on `2023/6/7 6:40 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

...
The `number of followers` of users in Bangladesh on `2022/10/29 3:14 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

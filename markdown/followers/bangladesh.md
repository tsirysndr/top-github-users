...
The `number of followers` of users in Bangladesh on `2023/7/2 1:36 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

...
The `number of followers` of users in Bangladesh on `2023/8/7 5:48 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

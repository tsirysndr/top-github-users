...
The `number of followers` of users in Bangladesh on `2023/7/28 4:27 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

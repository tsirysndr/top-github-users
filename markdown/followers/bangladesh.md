...
The `number of followers` of users in Bangladesh on `2023/1/3 10:46 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

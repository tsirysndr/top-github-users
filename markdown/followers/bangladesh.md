...
The `number of followers` of users in Bangladesh on `2023/11/4 9:00 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

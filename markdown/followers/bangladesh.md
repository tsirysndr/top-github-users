...
The `number of followers` of users in Bangladesh on `2022/10/6 3:13 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

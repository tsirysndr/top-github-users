...
The `number of followers` of users in Bangladesh on `2023/3/23 5:55 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

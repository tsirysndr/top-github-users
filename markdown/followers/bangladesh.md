...
The `number of followers` of users in Bangladesh on `2023/10/28 5:34 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

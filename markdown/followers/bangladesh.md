...
The `number of followers` of users in Bangladesh on `2023/9/15 9:28 PM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

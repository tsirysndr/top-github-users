...
The `number of followers` of users in Bangladesh on `2023/8/15 5:05 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

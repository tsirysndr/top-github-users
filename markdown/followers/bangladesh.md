...
The `number of followers` of users in Bangladesh on `2023/2/16 10:16 AM UTC`. This list contains users from `Bangladesh` and cities `Dhaka` `Mymensingh` `Rajshahi` `Rangpur` `Chittagong` `Khulna`.

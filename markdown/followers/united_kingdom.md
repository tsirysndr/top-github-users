...
The `number of followers` of users in United Kingdom on `2023/11/30 3:46 PM UTC`. This list contains users from `United Kingdom` and cities `London` `Birmingham` `Edinburgh` `Manchester` `Glasgow` `Liverpool` `Bristol`.

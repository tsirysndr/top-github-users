...
The `number of followers` of users in Botswana on `2023/7/28 5:08 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

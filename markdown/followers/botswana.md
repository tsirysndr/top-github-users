...
The `number of followers` of users in Botswana on `2023/4/6 1:45 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `635 users`  in Botswana. You need at least `0 followers` to be on this list.

...
The `number of followers` of users in Botswana on `2023/2/8 1:33 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/7/16 5:43 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

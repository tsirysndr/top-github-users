...
The `number of followers` of users in Botswana on `2023/10/10 12:23 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

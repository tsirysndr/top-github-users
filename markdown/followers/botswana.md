...
The `number of followers` of users in Botswana on `2023/6/10 5:56 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/11/4 9:40 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

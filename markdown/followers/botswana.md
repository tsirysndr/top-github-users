...
The `number of followers` of users in Botswana on `2023/12/2 6:36 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

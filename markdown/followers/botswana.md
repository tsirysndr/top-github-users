...
The `number of followers` of users in Botswana on `2023/9/15 4:19 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

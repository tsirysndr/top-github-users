...
The `number of followers` of users in Botswana on `2023/11/18 9:04 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

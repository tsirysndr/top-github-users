...
The `number of followers` of users in Botswana on `2023/6/23 6:25 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/8/15 5:46 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

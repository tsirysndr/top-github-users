...
The `number of followers` of users in Botswana on `2023/7/7 12:04 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

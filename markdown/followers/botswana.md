...
The `number of followers` of users in Botswana on `2023/10/24 11:56 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

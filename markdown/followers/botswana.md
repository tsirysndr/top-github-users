...
The `number of followers` of users in Botswana on `2023/5/25 10:51 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

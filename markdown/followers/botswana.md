...
The `number of followers` of users in Botswana on `2023/1/29 8:01 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/7/6 6:08 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/3/11 12:06 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

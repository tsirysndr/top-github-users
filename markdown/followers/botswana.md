...
The `number of followers` of users in Botswana on `2023/7/17 11:17 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2022/11/25 10:31 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

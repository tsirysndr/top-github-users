...
The `number of followers` of users in Botswana on `2022/11/20 8:32 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

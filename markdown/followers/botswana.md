...
The `number of followers` of users in Botswana on `2023/3/8 4:54 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/11/20 1:47 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

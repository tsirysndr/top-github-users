...
The `number of followers` of users in Botswana on `2022/12/29 10:07 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2023/11/12 4:03 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `number of followers` of users in Botswana on `2022/11/26 5:24 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

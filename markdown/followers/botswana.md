...
The `number of followers` of users in Botswana on `2022/12/27 7:51 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

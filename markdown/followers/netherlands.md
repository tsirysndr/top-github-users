...
The `number of followers` of users in Netherlands on `2023/2/24 9:04 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

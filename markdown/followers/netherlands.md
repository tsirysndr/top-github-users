...
The `number of followers` of users in Netherlands on `2023/2/9 5:25 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

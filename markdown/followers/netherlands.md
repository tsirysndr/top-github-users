...
The `number of followers` of users in Netherlands on `2023/5/16 5:25 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

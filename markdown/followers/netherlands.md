...
The `number of followers` of users in Netherlands on `2022/11/21 1:08 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

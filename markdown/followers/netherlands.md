...
The `number of followers` of users in Netherlands on `2022/11/14 8:42 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

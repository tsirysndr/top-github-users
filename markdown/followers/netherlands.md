...
The `number of followers` of users in Netherlands on `2023/9/13 7:33 AM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

...
The `number of followers` of users in Netherlands on `2023/3/12 7:56 PM UTC`. This list contains users from `Netherlands` and cities `Amsterdam` `The-hague` `Rotterdam` `Utrecht` `Groningen` `Eindhoven`.

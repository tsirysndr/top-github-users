...
The `number of followers` of users in Philippines on `2023/5/17 3:38 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

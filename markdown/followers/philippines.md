...
The `number of followers` of users in Philippines on `2023/4/26 5:24 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

...
The `number of followers` of users in Philippines on `2023/11/24 9:39 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

...
The `number of followers` of users in Philippines on `2023/9/28 6:06 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

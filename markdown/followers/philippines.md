...
The `number of followers` of users in Philippines on `2023/1/25 2:10 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

...
The `number of followers` of users in United States on `2022/12/18 10:32 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

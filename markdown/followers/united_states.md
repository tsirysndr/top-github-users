...
The `number of followers` of users in United States on `2022/11/30 1:10 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

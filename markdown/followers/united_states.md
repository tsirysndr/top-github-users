...
The `number of followers` of users in United States on `2022/11/13 7:45 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

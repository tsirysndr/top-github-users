...
The `number of followers` of users in United States on `2022/10/22 4:14 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

...
The `number of followers` of users in United States on `2022/11/7 7:44 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

...
The `number of followers` of users in United States on `2023/3/2 9:46 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

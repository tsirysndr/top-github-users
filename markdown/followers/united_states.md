...
The `number of followers` of users in United States on `2023/10/13 10:13 PM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

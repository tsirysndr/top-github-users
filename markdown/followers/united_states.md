...
The `number of followers` of users in United States on `2022/10/14 9:53 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

...
The `number of followers` of users in United States on `2023/9/6 4:27 AM UTC`. This list contains users from `United States` and cities `New-york` `Chicago` `Los-angeles` `San-francisco` `Austin` `Seattle`.

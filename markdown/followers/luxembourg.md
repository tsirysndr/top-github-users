...
The `number of followers` of users in Luxembourg on `2022/11/23 1:16 AM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.

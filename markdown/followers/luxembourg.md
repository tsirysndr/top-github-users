...
The `number of followers` of users in Luxembourg on `2022/12/2 3:08 PM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.

...
The `number of followers` of users in Cyprus on `2023/6/20 12:00 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

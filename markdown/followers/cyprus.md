...
The `number of followers` of users in Cyprus on `2023/6/17 10:23 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

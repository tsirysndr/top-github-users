...
The `number of followers` of users in Cyprus on `2023/8/1 8:27 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `number of followers` of users in Cyprus on `2023/10/12 2:41 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

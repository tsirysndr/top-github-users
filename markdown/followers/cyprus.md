...
The `number of followers` of users in Cyprus on `2023/9/18 4:00 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

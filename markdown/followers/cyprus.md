...
The `number of followers` of users in Cyprus on `2023/8/22 2:20 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `number of followers` of users in Cyprus on `2023/9/20 10:01 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `number of followers` of users in Cyprus on `2023/9/30 3:08 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

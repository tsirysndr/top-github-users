...
The `number of followers` of users in Cyprus on `2023/7/24 10:39 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

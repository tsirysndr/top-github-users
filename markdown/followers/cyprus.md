...
The `number of followers` of users in Cyprus on `2023/7/30 4:57 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

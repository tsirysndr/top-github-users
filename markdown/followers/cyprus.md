...
The `number of followers` of users in Cyprus on `2023/10/16 8:17 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

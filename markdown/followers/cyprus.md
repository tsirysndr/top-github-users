...
The `number of followers` of users in Cyprus on `2023/10/14 3:22 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `number of followers` of users in Cyprus on `2023/11/11 12:47 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

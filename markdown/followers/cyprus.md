...
The `number of followers` of users in Cyprus on `2023/8/28 10:59 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

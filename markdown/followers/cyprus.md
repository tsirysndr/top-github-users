...
The `number of followers` of users in Cyprus on `2023/11/25 6:40 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

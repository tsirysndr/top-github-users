...
The `number of followers` of users in Cyprus on `2023/6/9 8:45 AM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

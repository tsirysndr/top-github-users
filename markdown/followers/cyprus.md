...
The `number of followers` of users in Cyprus on `2023/7/29 12:01 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `number of followers` of users in Saudi Arabia on `2022/10/6 4:20 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

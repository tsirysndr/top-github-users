...
The `number of followers` of users in Saudi Arabia on `2022/11/8 6:56 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

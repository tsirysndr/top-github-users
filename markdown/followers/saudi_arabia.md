...
The `number of followers` of users in Saudi Arabia on `2022/11/5 2:24 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

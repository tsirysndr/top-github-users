...
The `number of followers` of users in Saudi Arabia on `2023/2/10 2:19 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

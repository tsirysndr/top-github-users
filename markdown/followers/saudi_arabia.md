...
The `number of followers` of users in Saudi Arabia on `2023/11/9 4:14 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

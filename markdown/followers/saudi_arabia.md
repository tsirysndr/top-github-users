...
The `number of followers` of users in Saudi Arabia on `2023/10/13 7:08 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

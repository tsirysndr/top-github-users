...
The `number of followers` of users in Saudi Arabia on `2023/6/9 6:25 PM UTC`. This list contains users from `Saudi Arabia` and cities `Riyadh` `Jeddah` `Mecca` `Medina` `Khamismushait` `Dammam` `Abha`.

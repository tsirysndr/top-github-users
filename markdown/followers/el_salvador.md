...
The `number of followers` of users in El Salvador on `2022/10/20 5:40 PM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.

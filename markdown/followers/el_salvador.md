...
The `number of followers` of users in El Salvador on `2022/12/16 12:33 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.

...
The `number of followers` of users in El Salvador on `2022/12/27 4:22 AM UTC`. This list contains users from `El Salvador` and cities `San-salvador` `San-miguel` `Santa-ana` `Santa-tecla` `San-martin`.

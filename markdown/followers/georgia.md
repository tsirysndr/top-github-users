...
The `number of followers` of users in Georgia on `2023/11/18 12:38 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

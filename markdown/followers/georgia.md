...
The `number of followers` of users in Georgia on `2022/10/22 11:46 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `number of followers` of users in Georgia on `2022/12/27 11:46 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `number of followers` of users in Georgia on `2023/10/11 10:40 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `number of followers` of users in Georgia on `2023/10/26 10:16 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `number of followers` of users in Georgia on `2022/12/31 10:50 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

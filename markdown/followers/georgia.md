...
The `number of followers` of users in Georgia on `2023/11/19 11:40 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

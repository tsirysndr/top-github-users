...
The `number of followers` of users in Finland on `2022/12/26 9:42 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

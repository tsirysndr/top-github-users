...
The `number of followers` of users in Finland on `2023/7/25 10:33 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

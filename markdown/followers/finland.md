...
The `number of followers` of users in Finland on `2023/1/24 12:36 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

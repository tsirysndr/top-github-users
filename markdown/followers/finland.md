...
The `number of followers` of users in Finland on `2022/10/29 12:31 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

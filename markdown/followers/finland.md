...
The `number of followers` of users in Finland on `2023/11/13 12:50 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2022/10/6 7:33 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

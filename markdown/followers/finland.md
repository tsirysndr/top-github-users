...
The `number of followers` of users in Finland on `2023/8/20 10:34 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

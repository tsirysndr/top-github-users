...
The `number of followers` of users in Finland on `2023/1/11 3:53 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

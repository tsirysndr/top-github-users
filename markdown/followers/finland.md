...
The `number of followers` of users in Finland on `2023/8/13 10:30 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

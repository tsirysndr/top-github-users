...
The `number of followers` of users in Finland on `2023/8/2 2:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

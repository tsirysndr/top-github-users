...
The `number of followers` of users in Finland on `2023/11/24 2:26 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/7/11 4:28 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

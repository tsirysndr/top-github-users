...
The `number of followers` of users in Finland on `2023/7/2 5:25 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/5/20 12:40 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

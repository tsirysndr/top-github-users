...
The `number of followers` of users in Finland on `2022/12/12 8:56 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

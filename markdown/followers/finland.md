...
The `number of followers` of users in Finland on `2023/11/9 7:47 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

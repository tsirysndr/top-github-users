...
The `number of followers` of users in Finland on `2023/8/19 5:33 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/10/20 4:23 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

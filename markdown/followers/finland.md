...
The `number of followers` of users in Finland on `2023/2/12 11:01 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

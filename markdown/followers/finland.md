...
The `number of followers` of users in Finland on `2023/9/7 10:59 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

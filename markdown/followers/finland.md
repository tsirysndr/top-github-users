...
The `number of followers` of users in Finland on `2023/10/29 8:45 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

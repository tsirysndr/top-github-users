...
The `number of followers` of users in Finland on `2023/4/17 7:32 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/2/6 9:53 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2022/10/21 1:45 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

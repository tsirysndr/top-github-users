...
The `number of followers` of users in Finland on `2023/3/23 3:35 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

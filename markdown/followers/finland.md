...
The `number of followers` of users in Finland on `2022/10/11 9:35 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/8/21 9:47 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

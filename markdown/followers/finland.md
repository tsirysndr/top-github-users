...
The `number of followers` of users in Finland on `2023/3/13 7:49 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

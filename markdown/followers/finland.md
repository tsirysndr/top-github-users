...
The `number of followers` of users in Finland on `2023/6/14 1:01 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/1/28 12:13 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

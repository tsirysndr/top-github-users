...
The `number of followers` of users in Finland on `2022/12/30 8:40 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

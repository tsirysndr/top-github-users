...
The `number of followers` of users in Finland on `2022/10/13 8:17 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

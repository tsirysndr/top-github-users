...
The `number of followers` of users in Finland on `2023/7/20 4:30 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2022/12/3 6:29 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

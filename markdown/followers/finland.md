...
The `number of followers` of users in Finland on `2023/6/18 5:02 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

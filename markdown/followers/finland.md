...
The `number of followers` of users in Finland on `2023/9/13 1:52 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

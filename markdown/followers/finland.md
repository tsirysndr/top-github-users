...
The `number of followers` of users in Finland on `2023/1/14 6:18 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

...
The `number of followers` of users in Finland on `2023/11/21 11:10 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

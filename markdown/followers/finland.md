...
The `number of followers` of users in Finland on `2022/11/24 11:37 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

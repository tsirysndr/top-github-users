...
The `number of followers` of users in Finland on `2023/6/16 12:34 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

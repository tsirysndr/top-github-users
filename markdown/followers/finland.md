...
The `number of followers` of users in Finland on `2023/5/6 12:24 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

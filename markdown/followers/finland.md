...
The `number of followers` of users in Finland on `2022/10/17 7:16 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

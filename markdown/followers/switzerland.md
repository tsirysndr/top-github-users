...
The `number of followers` of users in Switzerland on `2023/7/16 1:23 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

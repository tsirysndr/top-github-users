...
The `number of followers` of users in Switzerland on `2023/11/25 5:44 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

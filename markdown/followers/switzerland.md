...
The `number of followers` of users in Switzerland on `2023/6/6 7:24 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/9/4 1:27 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

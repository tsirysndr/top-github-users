...
The `number of followers` of users in Switzerland on `2023/12/1 8:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

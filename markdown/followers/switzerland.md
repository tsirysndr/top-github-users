...
The `number of followers` of users in Switzerland on `2023/9/9 2:34 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

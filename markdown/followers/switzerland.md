...
The `number of followers` of users in Switzerland on `2023/8/3 6:14 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

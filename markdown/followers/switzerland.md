...
The `number of followers` of users in Switzerland on `2023/11/15 10:42 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/7/21 8:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

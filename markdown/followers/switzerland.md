...
The `number of followers` of users in Switzerland on `2023/11/11 6:21 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

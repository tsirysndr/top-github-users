...
The `number of followers` of users in Switzerland on `2023/6/14 5:13 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

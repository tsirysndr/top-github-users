...
The `number of followers` of users in Switzerland on `2023/7/3 8:41 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/7/10 2:21 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/8/10 5:30 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

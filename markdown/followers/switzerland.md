...
The `number of followers` of users in Switzerland on `2023/8/20 3:07 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

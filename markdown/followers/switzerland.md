...
The `number of followers` of users in Switzerland on `2023/7/5 7:49 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/5/31 7:51 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

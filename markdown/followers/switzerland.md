...
The `number of followers` of users in Switzerland on `2023/8/28 4:33 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

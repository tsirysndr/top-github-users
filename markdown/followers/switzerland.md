...
The `number of followers` of users in Switzerland on `2023/8/31 3:58 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/12/2 2:13 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

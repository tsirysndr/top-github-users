...
The `number of followers` of users in Switzerland on `2023/10/2 12:55 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

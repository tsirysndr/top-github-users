...
The `number of followers` of users in Switzerland on `2023/9/27 3:06 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/9/28 8:53 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

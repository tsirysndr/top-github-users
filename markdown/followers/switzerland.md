...
The `number of followers` of users in Switzerland on `2023/10/3 12:57 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/10/11 2:32 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

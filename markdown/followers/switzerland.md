...
The `number of followers` of users in Switzerland on `2023/11/14 4:31 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

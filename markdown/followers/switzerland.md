...
The `number of followers` of users in Switzerland on `2023/7/20 8:47 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

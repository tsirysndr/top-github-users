...
The `number of followers` of users in Switzerland on `2023/11/5 10:54 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/7/1 9:58 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `number of followers` of users in Switzerland on `2023/6/16 10:24 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

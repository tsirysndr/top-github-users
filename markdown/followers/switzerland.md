...
The `number of followers` of users in Switzerland on `2023/11/21 9:29 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

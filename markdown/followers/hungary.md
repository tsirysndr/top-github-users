...
The `number of followers` of users in Hungary on `2022/11/20 1:12 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

...
The `number of followers` of users in Hungary on `2022/12/16 2:09 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

...
The `number of followers` of users in Hungary on `2022/12/31 11:43 PM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

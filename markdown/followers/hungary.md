...
The `number of followers` of users in Hungary on `2022/12/19 7:01 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

...
The `number of followers` of users in Hungary on `2022/12/20 2:17 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

...
The `number of followers` of users in Lithuania on `2023/9/9 1:35 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

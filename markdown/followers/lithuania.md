...
The `number of followers` of users in Lithuania on `2022/10/29 11:27 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

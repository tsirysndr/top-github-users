...
The `number of followers` of users in Lithuania on `2023/10/22 12:53 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

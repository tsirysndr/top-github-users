...
The `number of followers` of users in Lithuania on `2023/11/6 3:37 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `number of followers` of users in Lithuania on `2022/11/24 3:08 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

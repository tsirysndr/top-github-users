...
The `number of followers` of users in Lithuania on `2023/6/27 4:52 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

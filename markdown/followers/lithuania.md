...
The `number of followers` of users in Lithuania on `2023/10/6 7:07 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

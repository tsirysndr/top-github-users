...
The `number of followers` of users in Lithuania on `2023/1/17 2:13 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

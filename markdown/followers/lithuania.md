...
The `number of followers` of users in Lithuania on `2022/12/10 3:43 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

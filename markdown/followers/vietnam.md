...
The `number of followers` of users in Vietnam on `2023/9/20 11:27 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

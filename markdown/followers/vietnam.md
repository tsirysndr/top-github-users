...
The `number of followers` of users in Vietnam on `2023/9/6 11:03 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

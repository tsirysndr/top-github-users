...
The `number of followers` of users in Vietnam on `2023/11/12 7:09 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

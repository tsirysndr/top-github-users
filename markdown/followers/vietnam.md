...
The `number of followers` of users in Vietnam on `2023/11/16 12:40 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

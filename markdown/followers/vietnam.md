...
The `number of followers` of users in Vietnam on `2023/10/10 9:40 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

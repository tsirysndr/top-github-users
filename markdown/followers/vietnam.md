...
The `number of followers` of users in Vietnam on `2023/8/26 2:20 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

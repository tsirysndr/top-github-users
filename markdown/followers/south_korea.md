...
The `number of followers` of users in South Korea on `2022/12/28 9:24 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

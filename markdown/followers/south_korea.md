...
The `number of followers` of users in South Korea on `2023/4/29 5:12 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

...
The `number of followers` of users in South Korea on `2023/1/3 5:43 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

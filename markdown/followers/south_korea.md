...
The `number of followers` of users in South Korea on `2022/10/30 5:44 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

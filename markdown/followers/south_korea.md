...
The `number of followers` of users in South Korea on `2023/9/8 8:06 AM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

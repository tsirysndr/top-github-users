...
The `number of followers` of users in South Korea on `2022/10/31 8:28 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

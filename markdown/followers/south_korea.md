...
The `number of followers` of users in South Korea on `2023/10/16 7:07 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

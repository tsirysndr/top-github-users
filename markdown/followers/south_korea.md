...
The `number of followers` of users in South Korea on `2023/4/8 1:39 PM UTC`. This list contains users from `South Korea` and cities `Seoul` `Busan` `Incheon` `Daegu` `Ulsan` `Daejeon`.

...
The `number of followers` of users in United Arab Emirates on `2023/2/17 7:30 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

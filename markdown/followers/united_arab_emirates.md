...
The `number of followers` of users in United Arab Emirates on `2022/12/30 1:21 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

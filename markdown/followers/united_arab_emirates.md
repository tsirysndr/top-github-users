...
The `number of followers` of users in United Arab Emirates on `2023/9/3 3:31 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

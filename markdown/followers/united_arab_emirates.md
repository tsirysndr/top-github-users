...
The `number of followers` of users in United Arab Emirates on `2023/11/27 8:14 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

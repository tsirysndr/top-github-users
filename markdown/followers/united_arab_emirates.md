...
The `number of followers` of users in United Arab Emirates on `2023/10/13 3:22 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

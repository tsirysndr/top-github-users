...
The `number of followers` of users in United Arab Emirates on `2023/3/1 2:59 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

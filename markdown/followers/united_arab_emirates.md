...
The `number of followers` of users in United Arab Emirates on `2023/5/20 6:06 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

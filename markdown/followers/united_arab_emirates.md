...
The `number of followers` of users in United Arab Emirates on `2023/1/30 10:10 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

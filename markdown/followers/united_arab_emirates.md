...
The `number of followers` of users in United Arab Emirates on `2023/12/2 8:46 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

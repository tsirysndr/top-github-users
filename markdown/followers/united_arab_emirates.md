...
The `number of followers` of users in United Arab Emirates on `2023/10/11 3:30 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

...
The `number of followers` of users in United Arab Emirates on `2023/9/1 4:44 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

...
The `number of followers` of users in United Arab Emirates on `2023/1/24 11:45 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

...
The `number of followers` of users in United Arab Emirates on `2022/12/13 8:33 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

...
The `number of followers` of users in United Arab Emirates on `2023/11/11 7:18 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

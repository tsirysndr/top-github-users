...
The `number of followers` of users in United Arab Emirates on `2022/12/14 10:42 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

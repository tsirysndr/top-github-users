...
The `number of followers` of users in United Arab Emirates on `2023/11/4 6:12 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

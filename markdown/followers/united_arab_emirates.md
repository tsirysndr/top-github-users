...
The `number of followers` of users in United Arab Emirates on `2023/7/23 12:24 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

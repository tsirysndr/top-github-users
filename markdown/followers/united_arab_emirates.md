...
The `number of followers` of users in United Arab Emirates on `2022/11/24 11:35 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

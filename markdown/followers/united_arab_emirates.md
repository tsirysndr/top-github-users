...
The `number of followers` of users in United Arab Emirates on `2023/3/7 12:06 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

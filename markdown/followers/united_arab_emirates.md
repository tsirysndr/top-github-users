...
The `number of followers` of users in United Arab Emirates on `2023/2/12 9:45 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

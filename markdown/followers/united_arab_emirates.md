...
The `number of followers` of users in United Arab Emirates on `2023/10/22 2:41 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

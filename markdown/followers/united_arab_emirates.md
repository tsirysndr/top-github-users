...
The `number of followers` of users in United Arab Emirates on `2023/11/19 4:40 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

...
The `number of followers` of users in United Arab Emirates on `2023/9/14 6:45 AM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

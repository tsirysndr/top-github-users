...
The `number of followers` of users in United Arab Emirates on `2023/10/9 2:52 PM UTC`. This list contains users from `United Arab Emirates` and cities `Dubai` `Sharjah` `Ajman`.

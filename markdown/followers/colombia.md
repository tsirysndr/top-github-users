...
The `number of followers` of users in Colombia on `2023/1/8 8:08 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

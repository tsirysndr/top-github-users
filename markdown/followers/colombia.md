...
The `number of followers` of users in Colombia on `2022/11/28 9:02 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

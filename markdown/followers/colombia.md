...
The `number of followers` of users in Colombia on `2023/6/12 5:55 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

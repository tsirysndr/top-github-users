...
The `number of followers` of users in Colombia on `2023/11/19 4:00 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

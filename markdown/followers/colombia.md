...
The `number of followers` of users in Colombia on `2023/7/28 12:53 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

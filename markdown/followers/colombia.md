...
The `number of followers` of users in Colombia on `2023/10/25 7:53 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

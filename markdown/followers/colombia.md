...
The `number of followers` of users in Colombia on `2023/5/12 10:50 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/10/27 2:05 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

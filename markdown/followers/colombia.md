...
The `number of followers` of users in Colombia on `2023/9/21 3:41 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

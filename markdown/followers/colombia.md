...
The `number of followers` of users in Colombia on `2022/10/9 5:51 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/1/14 4:21 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

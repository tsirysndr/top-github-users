...
The `number of followers` of users in Colombia on `2023/5/26 6:12 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

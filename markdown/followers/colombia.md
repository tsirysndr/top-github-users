...
The `number of followers` of users in Colombia on `2022/10/24 6:46 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

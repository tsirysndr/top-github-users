...
The `number of followers` of users in Colombia on `2023/1/11 2:01 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

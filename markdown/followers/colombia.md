...
The `number of followers` of users in Colombia on `2023/6/19 2:09 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

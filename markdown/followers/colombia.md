...
The `number of followers` of users in Colombia on `2023/3/17 2:11 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

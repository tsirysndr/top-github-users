...
The `number of followers` of users in Colombia on `2023/3/21 1:26 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

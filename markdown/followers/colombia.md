...
The `number of followers` of users in Colombia on `2023/9/18 3:31 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

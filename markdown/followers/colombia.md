...
The `number of followers` of users in Colombia on `2022/12/18 8:21 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

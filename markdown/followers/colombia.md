...
The `number of followers` of users in Colombia on `2022/11/29 11:34 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

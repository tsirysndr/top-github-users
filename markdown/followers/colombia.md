...
The `number of followers` of users in Colombia on `2023/2/19 2:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/8/30 4:17 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

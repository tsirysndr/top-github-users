...
The `number of followers` of users in Colombia on `2023/3/23 8:16 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

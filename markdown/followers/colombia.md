...
The `number of followers` of users in Colombia on `2023/8/16 12:43 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

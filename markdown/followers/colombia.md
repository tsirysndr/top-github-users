...
The `number of followers` of users in Colombia on `2023/8/24 1:13 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

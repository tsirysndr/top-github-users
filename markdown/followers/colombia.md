...
The `number of followers` of users in Colombia on `2022/12/15 11:08 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

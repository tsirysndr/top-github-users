...
The `number of followers` of users in Colombia on `2023/9/1 9:48 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

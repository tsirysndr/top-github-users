...
The `number of followers` of users in Colombia on `2023/1/31 9:24 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

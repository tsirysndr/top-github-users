...
The `number of followers` of users in Colombia on `2023/6/1 2:18 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

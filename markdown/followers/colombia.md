...
The `number of followers` of users in Colombia on `2023/7/4 2:31 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

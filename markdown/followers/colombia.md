...
The `number of followers` of users in Colombia on `2023/3/7 5:18 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/3/26 1:25 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2022/10/22 9:31 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

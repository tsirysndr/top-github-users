...
The `number of followers` of users in Colombia on `2023/11/30 8:47 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/5/10 2:30 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

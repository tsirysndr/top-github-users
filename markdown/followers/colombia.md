...
The `number of followers` of users in Colombia on `2023/10/5 7:30 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

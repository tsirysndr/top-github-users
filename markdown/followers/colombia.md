...
The `number of followers` of users in Colombia on `2023/8/15 7:17 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

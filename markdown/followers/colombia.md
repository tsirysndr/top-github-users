...
The `number of followers` of users in Colombia on `2023/3/31 11:18 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

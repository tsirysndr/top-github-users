...
The `number of followers` of users in Colombia on `2023/4/12 1:04 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

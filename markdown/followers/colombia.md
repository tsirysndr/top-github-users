...
The `number of followers` of users in Colombia on `2023/6/18 3:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

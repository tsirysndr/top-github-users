...
The `number of followers` of users in Colombia on `2023/7/6 7:42 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

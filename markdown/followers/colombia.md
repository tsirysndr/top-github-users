...
The `number of followers` of users in Colombia on `2023/9/11 12:28 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/6/8 2:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

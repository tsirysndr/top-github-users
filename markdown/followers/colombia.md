...
The `number of followers` of users in Colombia on `2023/3/30 5:20 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

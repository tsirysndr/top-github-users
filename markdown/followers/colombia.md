...
The `number of followers` of users in Colombia on `2023/8/26 11:41 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2022/10/29 5:44 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

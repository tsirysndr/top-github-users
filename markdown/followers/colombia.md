...
The `number of followers` of users in Colombia on `2023/3/8 6:32 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

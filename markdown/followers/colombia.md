...
The `number of followers` of users in Colombia on `2023/2/16 12:34 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

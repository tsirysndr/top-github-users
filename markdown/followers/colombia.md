...
The `number of followers` of users in Colombia on `2023/11/29 8:41 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/2/14 3:54 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

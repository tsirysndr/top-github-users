...
The `number of followers` of users in Colombia on `2023/7/13 8:37 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

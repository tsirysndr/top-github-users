...
The `number of followers` of users in Colombia on `2023/9/4 1:41 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

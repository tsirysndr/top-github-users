...
The `number of followers` of users in Colombia on `2023/10/20 8:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

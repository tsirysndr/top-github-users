...
The `number of followers` of users in Colombia on `2023/1/29 3:59 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

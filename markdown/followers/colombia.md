...
The `number of followers` of users in Colombia on `2022/11/27 1:47 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

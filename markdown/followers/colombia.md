...
The `number of followers` of users in Colombia on `2023/4/17 5:43 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

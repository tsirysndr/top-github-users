...
The `number of followers` of users in Colombia on `2022/10/23 11:16 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

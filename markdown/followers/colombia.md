...
The `number of followers` of users in Colombia on `2023/8/4 11:08 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

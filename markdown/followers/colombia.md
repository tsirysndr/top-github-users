...
The `number of followers` of users in Colombia on `2023/3/4 11:14 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `number of followers` of users in Colombia on `2023/7/4 8:09 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

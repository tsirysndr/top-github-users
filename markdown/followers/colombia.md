...
The `number of followers` of users in Colombia on `2023/10/11 8:34 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

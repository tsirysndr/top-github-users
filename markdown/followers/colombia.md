...
The `number of followers` of users in Colombia on `2022/11/25 5:12 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

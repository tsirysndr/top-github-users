...
The `number of followers` of users in Jamaica on `2022/11/6 10:40 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

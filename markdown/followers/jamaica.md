...
The `number of followers` of users in Jamaica on `2023/8/28 2:40 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

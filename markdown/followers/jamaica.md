...
The `number of followers` of users in Jamaica on `2022/11/19 12:49 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

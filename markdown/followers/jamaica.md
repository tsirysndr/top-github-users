...
The `number of followers` of users in Jamaica on `2022/11/15 12:32 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

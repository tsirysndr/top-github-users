...
The `number of followers` of users in Jamaica on `2023/5/20 3:00 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

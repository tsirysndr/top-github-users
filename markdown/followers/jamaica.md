...
The `number of followers` of users in Jamaica on `2023/2/14 8:17 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

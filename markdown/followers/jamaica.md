...
The `number of followers` of users in Jamaica on `2023/5/22 1:45 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

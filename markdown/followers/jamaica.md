...
The `number of followers` of users in Jamaica on `2022/12/20 10:44 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

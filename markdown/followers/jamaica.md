...
The `number of followers` of users in Jamaica on `2023/1/24 9:25 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

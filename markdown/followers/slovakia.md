...
The `number of followers` of users in Slovakia on `2023/7/29 4:46 AM UTC`. This list contains users from `Slovakia` and cities `Bratislava` `Košice`.
...
<table>
	...
	<tr>
		...
		<td>Lukaspastva.sk, Conveior.io </td>
		<td>No Twitter Username</td>
		<td>Slovakia, Bratislava</td>
		<td>13</td>
	</tr>

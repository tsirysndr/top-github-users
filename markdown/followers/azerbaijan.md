...
The `number of followers` of users in Azerbaijan on `2023/11/19 1:33 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

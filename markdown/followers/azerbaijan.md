...
The `number of followers` of users in Azerbaijan on `2023/10/16 5:13 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

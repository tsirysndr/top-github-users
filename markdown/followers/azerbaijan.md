...
The `number of followers` of users in Azerbaijan on `2023/9/9 5:58 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

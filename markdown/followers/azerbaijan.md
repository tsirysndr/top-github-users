...
The `number of followers` of users in Azerbaijan on `2023/6/29 2:30 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

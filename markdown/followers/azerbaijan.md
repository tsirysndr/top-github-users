...
The `number of followers` of users in Azerbaijan on `2023/8/24 4:32 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

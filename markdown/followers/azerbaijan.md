...
The `number of followers` of users in Azerbaijan on `2022/10/18 8:43 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

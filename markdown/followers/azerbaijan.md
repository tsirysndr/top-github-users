...
The `number of followers` of users in Azerbaijan on `2023/9/24 1:08 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

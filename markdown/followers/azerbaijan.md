...
The `number of followers` of users in Azerbaijan on `2023/1/17 5:28 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/2/13 12:11 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/1/25 9:15 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

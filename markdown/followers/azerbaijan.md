...
The `number of followers` of users in Azerbaijan on `2023/8/11 3:31 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/2/23 5:45 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

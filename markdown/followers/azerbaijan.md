...
The `number of followers` of users in Azerbaijan on `2023/10/17 5:41 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

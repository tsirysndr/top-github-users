...
The `number of followers` of users in Azerbaijan on `2023/1/14 8:35 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

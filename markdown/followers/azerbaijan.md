...
The `number of followers` of users in Azerbaijan on `2022/11/13 10:14 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

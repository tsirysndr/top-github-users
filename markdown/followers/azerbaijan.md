...
The `number of followers` of users in Azerbaijan on `2023/8/29 2:12 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

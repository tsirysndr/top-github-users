...
The `number of followers` of users in Azerbaijan on `2022/12/7 2:16 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/6/9 5:43 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

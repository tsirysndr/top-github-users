...
The `number of followers` of users in Azerbaijan on `2022/10/11 4:54 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

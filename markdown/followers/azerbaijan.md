...
The `number of followers` of users in Azerbaijan on `2022/11/9 12:49 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

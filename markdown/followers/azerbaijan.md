...
The `number of followers` of users in Azerbaijan on `2023/9/18 6:52 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/1/24 2:24 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2022/12/18 5:36 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

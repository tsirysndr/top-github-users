...
The `number of followers` of users in Azerbaijan on `2022/12/1 11:10 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2022/12/10 7:15 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/9/7 6:43 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

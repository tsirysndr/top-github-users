...
The `number of followers` of users in Azerbaijan on `2023/2/8 12:32 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

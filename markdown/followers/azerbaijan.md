...
The `number of followers` of users in Azerbaijan on `2022/10/7 5:37 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

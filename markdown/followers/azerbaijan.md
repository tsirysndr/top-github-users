...
The `number of followers` of users in Azerbaijan on `2023/5/19 3:05 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

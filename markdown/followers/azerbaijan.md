...
The `number of followers` of users in Azerbaijan on `2022/12/4 3:59 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

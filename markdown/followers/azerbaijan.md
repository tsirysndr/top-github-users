...
The `number of followers` of users in Azerbaijan on `2023/2/25 10:33 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

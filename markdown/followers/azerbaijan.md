...
The `number of followers` of users in Azerbaijan on `2023/10/3 4:39 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

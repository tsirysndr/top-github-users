...
The `number of followers` of users in Azerbaijan on `2023/11/5 2:17 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Azerbaijan on `2023/3/20 4:40 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

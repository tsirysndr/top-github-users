...
The `number of followers` of users in Azerbaijan on `2023/4/4 6:43 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

...
The `number of followers` of users in Belarus on `2022/10/12 7:20 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

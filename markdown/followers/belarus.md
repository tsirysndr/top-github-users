...
The `number of followers` of users in Belarus on `2023/11/7 1:56 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2022/10/11 5:19 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/7/31 12:31 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

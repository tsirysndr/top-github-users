...
The `number of followers` of users in Belarus on `2023/9/25 12:37 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

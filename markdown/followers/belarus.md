...
The `number of followers` of users in Belarus on `2023/8/20 6:53 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

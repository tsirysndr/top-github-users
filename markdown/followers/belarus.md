...
The `number of followers` of users in Belarus on `2023/7/17 10:44 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

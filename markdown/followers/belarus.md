...
The `number of followers` of users in Belarus on `2023/11/25 9:30 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

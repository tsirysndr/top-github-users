...
The `number of followers` of users in Belarus on `2023/11/21 7:03 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

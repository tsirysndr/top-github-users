...
The `number of followers` of users in Belarus on `2022/11/10 6:39 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

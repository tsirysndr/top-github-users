...
The `number of followers` of users in Belarus on `2022/11/28 6:40 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

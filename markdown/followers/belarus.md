...
The `number of followers` of users in Belarus on `2022/11/25 2:53 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

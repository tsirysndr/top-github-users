...
The `number of followers` of users in Belarus on `2023/4/23 11:12 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/5/15 2:08 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/6/20 9:02 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

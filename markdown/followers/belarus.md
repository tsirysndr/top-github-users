...
The `number of followers` of users in Belarus on `2023/4/16 9:41 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

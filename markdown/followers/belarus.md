...
The `number of followers` of users in Belarus on `2023/3/19 10:50 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

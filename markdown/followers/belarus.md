...
The `number of followers` of users in Belarus on `2023/10/20 12:32 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/1/24 2:49 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

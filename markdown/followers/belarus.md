...
The `number of followers` of users in Belarus on `2022/11/9 1:16 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/4/13 11:11 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/8/10 10:18 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

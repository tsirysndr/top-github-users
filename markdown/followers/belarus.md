...
The `number of followers` of users in Belarus on `2023/9/24 1:32 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

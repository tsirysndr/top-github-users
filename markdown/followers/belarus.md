...
The `number of followers` of users in Belarus on `2022/12/30 11:34 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

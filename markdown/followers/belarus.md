...
The `number of followers` of users in Belarus on `2023/11/18 8:31 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

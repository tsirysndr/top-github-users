...
The `number of followers` of users in Belarus on `2023/10/5 11:45 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

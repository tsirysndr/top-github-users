...
The `number of followers` of users in Belarus on `2023/4/17 3:34 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

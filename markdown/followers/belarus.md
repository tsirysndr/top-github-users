...
The `number of followers` of users in Belarus on `2022/12/14 6:51 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

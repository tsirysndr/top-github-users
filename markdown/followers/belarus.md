...
The `number of followers` of users in Belarus on `2023/10/17 6:05 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

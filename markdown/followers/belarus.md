...
The `number of followers` of users in Belarus on `2023/1/29 7:29 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/1/23 8:39 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/2/14 1:43 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2022/10/27 5:21 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

...
The `number of followers` of users in Belarus on `2023/1/28 8:24 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

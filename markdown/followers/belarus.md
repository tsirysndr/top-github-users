...
The `number of followers` of users in Belarus on `2022/10/15 9:39 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

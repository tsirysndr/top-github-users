...
The `number of followers` of users in Belarus on `2023/7/5 11:46 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

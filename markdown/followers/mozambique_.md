...
The `number of followers` of users in Mozambique  on `2022/10/17 1:33 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

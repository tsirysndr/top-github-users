...
The `number of followers` of users in Mozambique  on `2023/10/12 9:28 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

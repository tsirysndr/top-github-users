...
The `number of followers` of users in Mozambique  on `2023/12/2 3:07 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

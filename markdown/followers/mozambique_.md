...
The `number of followers` of users in Mozambique  on `2022/10/28 10:40 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

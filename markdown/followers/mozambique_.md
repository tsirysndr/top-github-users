...
The `number of followers` of users in Mozambique  on `2023/11/6 5:21 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

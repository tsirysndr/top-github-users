...
The `number of followers` of users in Mozambique  on `2023/10/16 2:56 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

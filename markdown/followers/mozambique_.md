...
The `number of followers` of users in Mozambique  on `2022/12/25 12:59 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

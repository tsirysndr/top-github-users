...
The `number of followers` of users in Mozambique  on `2023/4/17 6:37 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

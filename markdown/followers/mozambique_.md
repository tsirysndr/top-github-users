...
The `number of followers` of users in Mozambique  on `2023/3/22 2:51 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

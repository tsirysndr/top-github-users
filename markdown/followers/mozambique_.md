...
The `number of followers` of users in Mozambique  on `2022/11/24 4:59 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

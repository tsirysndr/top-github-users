...
The `number of followers` of users in Mozambique  on `2023/8/15 2:04 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

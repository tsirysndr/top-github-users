...
The `number of followers` of users in Mozambique  on `2023/7/27 2:25 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

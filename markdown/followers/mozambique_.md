...
The `number of followers` of users in Mozambique  on `2023/8/27 11:47 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

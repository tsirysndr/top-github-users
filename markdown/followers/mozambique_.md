...
The `number of followers` of users in Mozambique  on `2023/2/14 11:04 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

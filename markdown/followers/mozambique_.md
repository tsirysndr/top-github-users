...
The `number of followers` of users in Mozambique  on `2023/10/29 8:24 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2023/6/17 4:37 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2023/8/19 5:20 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

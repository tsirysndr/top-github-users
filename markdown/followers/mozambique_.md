...
The `number of followers` of users in Mozambique  on `2023/9/24 10:20 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2022/11/15 3:30 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

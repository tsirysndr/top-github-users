...
The `number of followers` of users in Mozambique  on `2023/7/28 7:37 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

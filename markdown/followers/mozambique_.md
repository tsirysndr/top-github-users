...
The `number of followers` of users in Mozambique  on `2023/3/15 9:00 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

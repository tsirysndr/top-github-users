...
The `number of followers` of users in Mozambique  on `2023/5/31 3:00 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

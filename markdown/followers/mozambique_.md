...
The `number of followers` of users in Mozambique  on `2023/11/24 1:58 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2023/1/31 4:42 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

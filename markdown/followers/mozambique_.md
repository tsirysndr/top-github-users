...
The `number of followers` of users in Mozambique  on `2023/9/1 10:51 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2023/1/9 11:06 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mozambique  on `2023/12/4 1:43 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

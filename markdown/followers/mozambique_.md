...
The `number of followers` of users in Mozambique  on `2023/12/1 9:29 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

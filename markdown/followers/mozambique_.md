...
The `number of followers` of users in Mozambique  on `2023/2/25 2:18 PM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

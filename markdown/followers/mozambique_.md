...
The `number of followers` of users in Mozambique  on `2023/6/18 10:07 AM UTC`. This list contains users from `Mozambique ` and cities `Maputo` `Beira` `Quelimane` `Chimoio` `Matola` `Nacala`.

...
The `number of followers` of users in Mauritius on `2023/6/13 11:37 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

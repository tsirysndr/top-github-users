...
The `number of followers` of users in Mauritius on `2023/1/3 12:13 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

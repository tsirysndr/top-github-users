...
The `number of followers` of users in Mauritius on `2023/2/11 4:29 AM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

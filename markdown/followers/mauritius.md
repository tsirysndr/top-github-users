...
The `number of followers` of users in Mauritius on `2022/12/17 7:52 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

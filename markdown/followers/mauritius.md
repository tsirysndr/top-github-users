...
The `number of followers` of users in Mauritius on `2023/1/30 9:50 PM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.

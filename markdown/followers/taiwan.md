...
The `number of followers` of users in Taiwan on `2022/12/25 12:33 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

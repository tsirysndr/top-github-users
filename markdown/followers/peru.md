...
The `number of followers` of users in Peru on `2023/7/23 8:44 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/8/25 3:55 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

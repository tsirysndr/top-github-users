...
The `number of followers` of users in Peru on `2023/11/8 9:15 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

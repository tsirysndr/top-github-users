...
The `number of followers` of users in Peru on `2023/8/29 1:35 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

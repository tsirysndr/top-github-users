...
The `number of followers` of users in Peru on `2023/6/21 1:51 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/7/17 3:53 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/7/4 11:15 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

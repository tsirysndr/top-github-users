...
The `number of followers` of users in Peru on `2023/11/26 8:16 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/11/12 2:29 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

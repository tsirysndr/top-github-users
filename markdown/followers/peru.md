...
The `number of followers` of users in Peru on `2023/6/28 2:08 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

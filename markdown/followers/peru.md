...
The `number of followers` of users in Peru on `2023/6/17 1:18 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

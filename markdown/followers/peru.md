...
The `number of followers` of users in Peru on `2023/9/25 11:51 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

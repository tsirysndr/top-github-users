...
The `number of followers` of users in Peru on `2023/9/2 6:26 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/7/28 9:32 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

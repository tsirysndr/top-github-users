...
The `number of followers` of users in Peru on `2023/8/20 5:24 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

...
The `number of followers` of users in Peru on `2023/7/31 11:16 PM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

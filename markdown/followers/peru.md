...
The `number of followers` of users in Peru on `2023/9/11 3:30 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

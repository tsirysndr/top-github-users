...
The `number of followers` of users in Peru on `2023/9/20 12:39 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

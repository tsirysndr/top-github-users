...
The `number of followers` of users in Peru on `2023/10/4 4:13 AM UTC`. This list contains users from `Peru` and cities `Lima ` `Arequipa` `Cusco` `Chiclayo` `Huancayo` `Piura`.

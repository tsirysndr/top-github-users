...
The `number of followers` of users in Bulgaria on `2023/9/1 2:41 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

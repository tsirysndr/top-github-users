...
The `number of followers` of users in Bulgaria on `2023/6/10 6:14 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/8/8 12:16 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2022/12/12 5:32 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

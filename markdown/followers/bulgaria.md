...
The `number of followers` of users in Bulgaria on `2023/10/13 7:20 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/6/14 10:01 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

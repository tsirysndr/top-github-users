...
The `number of followers` of users in Bulgaria on `2023/4/2 2:36 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

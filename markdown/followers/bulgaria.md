...
The `number of followers` of users in Bulgaria on `2022/11/7 11:36 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/11/27 12:04 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

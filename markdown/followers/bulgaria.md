...
The `number of followers` of users in Bulgaria on `2023/11/18 9:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

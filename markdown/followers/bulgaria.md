...
The `number of followers` of users in Bulgaria on `2023/6/4 7:12 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/3/2 1:23 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/5/3 7:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/8/9 5:51 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

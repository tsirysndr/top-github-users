...
The `number of followers` of users in Bulgaria on `2023/7/27 6:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

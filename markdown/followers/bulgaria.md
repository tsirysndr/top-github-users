...
The `number of followers` of users in Bulgaria on `2022/12/8 6:34 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

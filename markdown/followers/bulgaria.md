...
The `number of followers` of users in Bulgaria on `2023/2/13 1:23 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/8/1 6:44 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

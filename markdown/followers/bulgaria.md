...
The `number of followers` of users in Bulgaria on `2023/7/31 1:22 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

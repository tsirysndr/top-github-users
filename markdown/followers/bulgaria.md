...
The `number of followers` of users in Bulgaria on `2023/6/18 2:09 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

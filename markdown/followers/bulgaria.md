...
The `number of followers` of users in Bulgaria on `2023/3/3 10:11 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/6/17 8:42 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

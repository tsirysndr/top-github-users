...
The `number of followers` of users in Bulgaria on `2023/6/26 12:40 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

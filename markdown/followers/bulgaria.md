...
The `number of followers` of users in Bulgaria on `2023/8/10 4:19 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

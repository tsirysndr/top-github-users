...
The `number of followers` of users in Bulgaria on `2023/1/22 8:14 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/9/27 1:52 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

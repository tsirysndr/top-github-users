...
The `number of followers` of users in Bulgaria on `2022/12/21 11:47 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

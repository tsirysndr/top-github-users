...
The `number of followers` of users in Bulgaria on `2023/1/10 4:56 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/10/26 6:57 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

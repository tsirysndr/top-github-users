...
The `number of followers` of users in Bulgaria on `2023/10/14 1:39 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/3/5 3:26 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

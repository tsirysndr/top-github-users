...
The `number of followers` of users in Bulgaria on `2023/11/1 5:28 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

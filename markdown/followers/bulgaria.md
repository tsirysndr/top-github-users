...
The `number of followers` of users in Bulgaria on `2022/12/15 2:57 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

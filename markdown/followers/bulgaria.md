...
The `number of followers` of users in Bulgaria on `2023/4/16 10:31 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

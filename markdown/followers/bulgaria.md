...
The `number of followers` of users in Bulgaria on `2023/10/29 12:21 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

...
The `number of followers` of users in Bulgaria on `2023/4/30 3:59 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

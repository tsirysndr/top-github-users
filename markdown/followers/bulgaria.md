...
The `number of followers` of users in Bulgaria on `2023/3/18 12:42 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

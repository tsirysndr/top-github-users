...
The `number of followers` of users in Bulgaria on `2023/10/5 6:14 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

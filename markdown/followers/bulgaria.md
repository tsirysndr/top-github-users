...
The `number of followers` of users in Bulgaria on `2023/8/15 6:03 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

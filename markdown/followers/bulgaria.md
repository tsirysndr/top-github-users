...
The `number of followers` of users in Bulgaria on `2023/8/23 11:59 PM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

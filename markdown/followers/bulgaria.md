...
The `number of followers` of users in Bulgaria on `2023/5/29 2:14 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

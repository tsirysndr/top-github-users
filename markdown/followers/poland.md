...
The `number of followers` of users in Poland on `2023/1/2 8:09 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

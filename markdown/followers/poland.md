...
The `number of followers` of users in Poland on `2023/5/16 7:03 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/11/20 6:40 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

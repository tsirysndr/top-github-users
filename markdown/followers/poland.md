...
The `number of followers` of users in Poland on `2023/10/12 5:16 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

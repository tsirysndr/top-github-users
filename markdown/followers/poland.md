...
The `number of followers` of users in Poland on `2023/2/15 1:18 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2022/10/23 9:12 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

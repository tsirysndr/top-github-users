...
The `number of followers` of users in Poland on `2023/3/30 8:19 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2022/10/19 10:38 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

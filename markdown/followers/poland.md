...
The `number of followers` of users in Poland on `2022/10/23 1:57 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

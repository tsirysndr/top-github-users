...
The `number of followers` of users in Poland on `2023/12/1 5:48 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

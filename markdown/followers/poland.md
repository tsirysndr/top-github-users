...
The `number of followers` of users in Poland on `2022/12/2 7:12 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

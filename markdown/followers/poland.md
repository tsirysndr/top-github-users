...
The `number of followers` of users in Poland on `2023/7/14 11:35 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/3/3 2:43 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

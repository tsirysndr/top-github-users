...
The `number of followers` of users in Poland on `2023/11/4 2:43 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

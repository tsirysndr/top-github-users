...
The `number of followers` of users in Poland on `2022/12/6 7:24 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

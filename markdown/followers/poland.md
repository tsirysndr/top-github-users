...
The `number of followers` of users in Poland on `2023/10/23 10:38 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

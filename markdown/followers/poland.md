...
The `number of followers` of users in Poland on `2023/6/28 2:27 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

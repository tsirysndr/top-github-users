...
The `number of followers` of users in Poland on `2023/7/6 4:57 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

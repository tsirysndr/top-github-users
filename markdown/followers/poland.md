...
The `number of followers` of users in Poland on `2023/6/30 8:32 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

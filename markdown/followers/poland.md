...
The `number of followers` of users in Poland on `2022/11/7 3:45 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

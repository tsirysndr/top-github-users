...
The `number of followers` of users in Poland on `2023/11/22 12:37 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/9/28 6:16 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

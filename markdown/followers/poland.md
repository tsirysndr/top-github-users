...
The `number of followers` of users in Poland on `2022/11/27 11:19 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

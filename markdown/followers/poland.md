...
The `number of followers` of users in Poland on `2023/8/7 11:30 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/9/9 12:03 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

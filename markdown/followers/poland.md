...
The `number of followers` of users in Poland on `2023/8/29 1:54 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

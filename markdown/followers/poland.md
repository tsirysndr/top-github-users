...
The `number of followers` of users in Poland on `2022/12/17 4:06 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/12/2 5:15 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

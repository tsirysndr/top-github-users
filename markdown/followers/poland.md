...
The `number of followers` of users in Poland on `2023/4/15 9:53 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/5/6 7:40 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

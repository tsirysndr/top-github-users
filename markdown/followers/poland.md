...
The `number of followers` of users in Poland on `2023/1/6 1:07 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

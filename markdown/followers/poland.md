...
The `number of followers` of users in Poland on `2023/9/7 12:23 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

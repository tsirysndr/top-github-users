...
The `number of followers` of users in Poland on `2022/12/10 12:46 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

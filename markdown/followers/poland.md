...
The `number of followers` of users in Poland on `2023/7/26 5:40 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

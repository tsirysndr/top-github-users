...
The `number of followers` of users in Poland on `2023/3/4 2:47 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

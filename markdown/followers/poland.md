...
The `number of followers` of users in Poland on `2022/12/13 11:38 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `number of followers` of users in Poland on `2023/1/14 2:11 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

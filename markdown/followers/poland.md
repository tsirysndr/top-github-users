...
The `number of followers` of users in Poland on `2023/3/9 10:35 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

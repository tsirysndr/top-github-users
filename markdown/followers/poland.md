...
The `number of followers` of users in Poland on `2022/12/8 10:25 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

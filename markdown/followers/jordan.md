...
The `number of followers` of users in Jordan on `2023/9/6 1:52 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

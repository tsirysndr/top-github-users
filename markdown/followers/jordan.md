...
The `number of followers` of users in Jordan on `2023/11/27 5:53 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

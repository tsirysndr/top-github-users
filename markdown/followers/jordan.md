...
The `number of followers` of users in Jordan on `2023/6/19 6:33 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `number of followers` of users in Jordan on `2023/10/23 5:54 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

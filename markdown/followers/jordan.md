...
The `number of followers` of users in Jordan on `2023/11/5 3:42 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

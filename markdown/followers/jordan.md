...
The `number of followers` of users in Jordan on `2023/8/30 8:47 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `number of followers` of users in Jordan on `2023/6/1 6:41 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

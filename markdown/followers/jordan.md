...
The `number of followers` of users in Jordan on `2023/6/23 6:31 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

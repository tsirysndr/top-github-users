...
The `number of followers` of users in Jordan on `2023/7/20 1:44 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

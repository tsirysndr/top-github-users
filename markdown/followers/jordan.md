...
The `number of followers` of users in Jordan on `2023/7/30 8:39 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

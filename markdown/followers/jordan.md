...
The `number of followers` of users in Jordan on `2023/11/20 7:55 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

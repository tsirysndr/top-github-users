...
The `number of followers` of users in Jordan on `2023/10/10 7:07 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

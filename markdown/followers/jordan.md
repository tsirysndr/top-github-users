...
The `number of followers` of users in Jordan on `2023/7/16 11:35 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

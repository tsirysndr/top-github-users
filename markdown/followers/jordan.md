...
The `number of followers` of users in Jordan on `2023/8/24 11:29 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

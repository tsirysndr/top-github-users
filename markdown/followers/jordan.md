...
The `number of followers` of users in Jordan on `2023/11/26 4:03 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `number of followers` of users in Jordan on `2023/7/31 7:04 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

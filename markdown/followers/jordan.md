...
The `number of followers` of users in Jordan on `2023/10/3 5:32 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

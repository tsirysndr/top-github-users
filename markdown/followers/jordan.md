...
The `number of followers` of users in Jordan on `2023/9/24 7:56 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `number of followers` of users in Estonia on `2022/10/14 5:18 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

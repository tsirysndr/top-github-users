...
The `number of followers` of users in Estonia on `2023/4/19 4:00 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

...
The `number of followers` of users in Estonia on `2023/1/5 4:53 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

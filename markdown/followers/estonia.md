...
The `number of followers` of users in Estonia on `2022/10/29 12:10 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

...
The `number of followers` of users in Estonia on `2022/10/18 4:04 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

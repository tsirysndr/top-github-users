...
The `number of followers` of users in Estonia on `2022/12/1 3:37 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

...
The `number of followers` of users in Estonia on `2022/12/5 4:12 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

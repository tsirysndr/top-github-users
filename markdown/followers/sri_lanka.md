...
The `number of followers` of users in Sri Lanka on `2023/10/5 1:04 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

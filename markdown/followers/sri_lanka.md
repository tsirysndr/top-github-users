...
The `number of followers` of users in Sri Lanka on `2023/8/12 10:00 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

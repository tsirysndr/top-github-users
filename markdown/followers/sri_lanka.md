...
The `number of followers` of users in Sri Lanka on `2023/7/30 3:06 PM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

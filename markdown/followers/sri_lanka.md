...
The `number of followers` of users in Sri Lanka on `2023/10/19 2:00 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

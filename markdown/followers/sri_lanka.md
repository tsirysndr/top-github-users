...
The `number of followers` of users in Sri Lanka on `2023/10/16 1:17 AM UTC`. This list contains users from `Sri Lanka` and cities `Colombo` `Kandy` `Gampaha` `Galle` `Jaffna` `Matara`.

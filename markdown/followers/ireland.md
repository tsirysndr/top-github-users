...
The `number of followers` of users in Ireland on `2022/10/9 2:46 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

...
The `number of followers` of users in Ireland on `2023/1/19 3:16 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

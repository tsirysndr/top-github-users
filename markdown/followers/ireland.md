...
The `number of followers` of users in Ireland on `2023/1/30 7:15 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

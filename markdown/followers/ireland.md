...
The `number of followers` of users in Ireland on `2022/11/24 1:42 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

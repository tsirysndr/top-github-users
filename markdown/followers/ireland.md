...
The `number of followers` of users in Ireland on `2022/11/22 4:37 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

...
The `number of followers` of users in Ireland on `2023/6/13 3:30 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

...
The `number of followers` of users in Ireland on `2022/11/20 2:10 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

...
The `number of followers` of users in Ireland on `2023/1/22 1:16 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

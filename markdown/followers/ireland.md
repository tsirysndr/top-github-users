...
The `number of followers` of users in Ireland on `2023/6/4 6:48 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

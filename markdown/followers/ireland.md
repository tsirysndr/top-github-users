...
The `number of followers` of users in Ireland on `2022/12/14 1:12 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

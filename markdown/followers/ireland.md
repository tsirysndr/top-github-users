...
The `number of followers` of users in Ireland on `2023/4/22 11:30 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

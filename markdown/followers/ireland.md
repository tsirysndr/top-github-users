...
The `number of followers` of users in Ireland on `2022/10/15 4:37 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

...
The `number of followers` of users in Ireland on `2023/1/5 7:28 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

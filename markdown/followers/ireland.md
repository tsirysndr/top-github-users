...
The `number of followers` of users in Ireland on `2023/5/6 7:40 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.

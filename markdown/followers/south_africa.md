...
The `number of followers` of users in South Africa on `2022/11/14 12:35 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

...
The `number of followers` of users in South Africa on `2023/1/31 2:29 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

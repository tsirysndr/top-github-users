...
The `number of followers` of users in South Africa on `2023/7/12 1:46 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

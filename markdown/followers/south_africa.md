...
The `number of followers` of users in South Africa on `2022/12/31 1:24 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

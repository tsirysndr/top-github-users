...
The `number of followers` of users in South Africa on `2022/11/12 3:21 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

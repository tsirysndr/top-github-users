...
The `number of followers` of users in South Africa on `2023/11/21 8:35 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

...
The `number of followers` of users in South Africa on `2023/6/30 10:15 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

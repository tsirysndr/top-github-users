...
The `number of followers` of users in South Africa on `2023/5/7 7:51 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

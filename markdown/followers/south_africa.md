...
The `number of followers` of users in South Africa on `2023/9/9 1:42 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

...
The `number of followers` of users in South Africa on `2023/7/23 10:40 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

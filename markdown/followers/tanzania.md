...
The `number of followers` of users in Tanzania on `2023/12/1 8:37 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

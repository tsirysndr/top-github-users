...
The `number of followers` of users in Tanzania on `2023/10/15 8:33 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

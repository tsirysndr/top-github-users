...
The `number of followers` of users in Tanzania on `2023/9/24 3:13 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

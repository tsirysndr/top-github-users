...
The `number of followers` of users in Tanzania on `2023/8/17 5:53 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

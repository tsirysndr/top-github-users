...
The `number of followers` of users in Tanzania on `2023/10/4 7:20 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `number of followers` of users in Tanzania on `2023/10/23 1:38 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

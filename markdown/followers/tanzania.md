...
The `number of followers` of users in Tanzania on `2023/10/5 1:45 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

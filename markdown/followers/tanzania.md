...
The `number of followers` of users in Tanzania on `2023/8/27 11:15 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

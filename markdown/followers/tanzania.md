...
The `number of followers` of users in Tanzania on `2023/9/12 6:25 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

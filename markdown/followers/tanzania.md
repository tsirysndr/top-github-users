...
The `number of followers` of users in Tanzania on `2023/9/9 8:09 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

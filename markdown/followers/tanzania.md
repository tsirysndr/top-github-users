...
The `number of followers` of users in Tanzania on `2023/8/18 4:49 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `number of followers` of users in Tanzania on `2023/11/1 12:57 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `number of followers` of users in Namibia on `2023/6/24 9:24 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

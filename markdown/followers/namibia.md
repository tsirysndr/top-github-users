...
The `number of followers` of users in Namibia on `2022/11/15 10:21 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

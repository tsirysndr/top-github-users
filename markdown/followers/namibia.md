...
The `number of followers` of users in Namibia on `2023/6/14 12:36 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

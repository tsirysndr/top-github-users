...
The `number of followers` of users in Namibia on `2023/2/14 4:47 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/9/7 10:21 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

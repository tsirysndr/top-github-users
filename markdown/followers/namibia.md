...
The `number of followers` of users in Namibia on `2023/2/13 9:51 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

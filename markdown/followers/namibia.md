...
The `number of followers` of users in Namibia on `2023/5/6 11:01 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/2/19 3:54 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

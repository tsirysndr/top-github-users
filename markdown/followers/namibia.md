...
The `number of followers` of users in Namibia on `2023/4/19 9:49 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

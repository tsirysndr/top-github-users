...
The `number of followers` of users in Namibia on `2023/3/10 2:49 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

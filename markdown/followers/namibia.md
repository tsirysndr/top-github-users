...
The `number of followers` of users in Namibia on `2023/3/22 3:05 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/2/25 2:30 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

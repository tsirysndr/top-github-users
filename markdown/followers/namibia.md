...
The `number of followers` of users in Namibia on `2023/5/2 10:41 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2022/11/29 11:57 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

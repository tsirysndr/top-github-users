...
The `number of followers` of users in Namibia on `2023/7/21 9:28 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

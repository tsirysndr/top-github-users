...
The `number of followers` of users in Namibia on `2023/9/16 11:59 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

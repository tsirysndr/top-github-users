...
The `number of followers` of users in Namibia on `2023/11/24 7:52 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/7/16 8:48 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

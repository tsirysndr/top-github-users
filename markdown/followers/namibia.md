...
The `number of followers` of users in Namibia on `2023/2/7 9:40 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

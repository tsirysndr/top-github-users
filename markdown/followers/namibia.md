...
The `number of followers` of users in Namibia on `2023/9/8 4:19 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/9/8 10:04 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

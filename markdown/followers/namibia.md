...
The `number of followers` of users in Namibia on `2022/10/17 1:46 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

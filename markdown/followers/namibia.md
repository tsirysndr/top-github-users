...
The `number of followers` of users in Namibia on `2023/8/1 3:02 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

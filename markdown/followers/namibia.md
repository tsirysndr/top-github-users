...
The `number of followers` of users in Namibia on `2023/6/23 9:10 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

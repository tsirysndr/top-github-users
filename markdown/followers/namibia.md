...
The `number of followers` of users in Namibia on `2023/2/2 4:27 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

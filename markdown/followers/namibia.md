...
The `number of followers` of users in Namibia on `2022/10/30 1:28 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

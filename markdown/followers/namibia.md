...
The `number of followers` of users in Namibia on `2022/12/1 2:19 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

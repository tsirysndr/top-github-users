...
The `number of followers` of users in Namibia on `2023/7/20 4:20 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/6/5 3:28 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

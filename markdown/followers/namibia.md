...
The `number of followers` of users in Namibia on `2023/3/24 9:38 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

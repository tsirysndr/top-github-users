...
The `number of followers` of users in Namibia on `2023/3/6 5:54 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

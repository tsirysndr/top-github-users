...
The `number of followers` of users in Namibia on `2023/8/31 5:25 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2022/12/29 7:31 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/7/3 4:08 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

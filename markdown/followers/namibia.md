...
The `number of followers` of users in Namibia on `2023/8/12 12:53 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

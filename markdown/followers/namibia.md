...
The `number of followers` of users in Namibia on `2023/10/26 9:15 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

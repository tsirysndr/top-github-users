...
The `number of followers` of users in Namibia on `2023/9/22 11:49 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

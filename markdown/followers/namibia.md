...
The `number of followers` of users in Namibia on `2023/1/10 6:31 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

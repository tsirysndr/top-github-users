...
The `number of followers` of users in Namibia on `2023/9/14 1:17 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

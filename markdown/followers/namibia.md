...
The `number of followers` of users in Namibia on `2023/7/14 3:48 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

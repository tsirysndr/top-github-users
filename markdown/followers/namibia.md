...
The `number of followers` of users in Namibia on `2022/11/12 6:01 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

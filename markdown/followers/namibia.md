...
The `number of followers` of users in Namibia on `2023/5/24 7:49 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

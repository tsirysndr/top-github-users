...
The `number of followers` of users in Namibia on `2023/1/12 6:39 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

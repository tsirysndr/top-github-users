...
The `number of followers` of users in Namibia on `2022/10/27 3:35 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

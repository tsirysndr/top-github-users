...
The `number of followers` of users in Namibia on `2023/6/15 12:09 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

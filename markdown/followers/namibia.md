...
The `number of followers` of users in Namibia on `2023/10/7 3:22 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

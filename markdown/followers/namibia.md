...
The `number of followers` of users in Namibia on `2023/5/17 1:51 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/9/3 3:26 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

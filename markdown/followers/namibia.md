...
The `number of followers` of users in Namibia on `2023/12/1 9:42 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

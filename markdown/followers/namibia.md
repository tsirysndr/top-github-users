...
The `number of followers` of users in Namibia on `2022/10/9 6:29 AM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/4/15 7:55 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

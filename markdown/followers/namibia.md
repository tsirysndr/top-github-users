...
The `number of followers` of users in Namibia on `2023/6/17 4:50 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

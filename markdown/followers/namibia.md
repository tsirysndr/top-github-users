...
The `number of followers` of users in Namibia on `2023/4/30 12:14 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

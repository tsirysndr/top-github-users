...
The `number of followers` of users in Namibia on `2023/8/12 6:00 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2023/10/18 9:51 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

...
The `number of followers` of users in Namibia on `2022/10/11 3:08 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.

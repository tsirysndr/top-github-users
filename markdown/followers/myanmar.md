...
The `number of followers` of users in Myanmar on `2023/4/28 7:30 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2022/12/8 8:18 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2023/8/23 2:30 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2022/11/1 11:40 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

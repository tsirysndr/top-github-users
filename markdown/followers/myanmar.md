...
The `number of followers` of users in Myanmar on `2023/10/6 9:00 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2022/10/28 10:48 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

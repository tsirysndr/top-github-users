...
The `number of followers` of users in Myanmar on `2023/6/23 9:05 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

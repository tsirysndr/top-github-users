...
The `number of followers` of users in Myanmar on `2022/10/6 1:15 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

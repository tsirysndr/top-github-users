...
The `number of followers` of users in Myanmar on `2023/2/9 5:00 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2023/8/1 2:57 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

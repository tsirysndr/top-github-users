...
The `number of followers` of users in Myanmar on `2022/10/21 7:21 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

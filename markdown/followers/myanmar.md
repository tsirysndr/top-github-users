...
The `number of followers` of users in Myanmar on `2023/1/16 1:38 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

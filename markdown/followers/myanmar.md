...
The `number of followers` of users in Myanmar on `2023/1/8 3:48 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

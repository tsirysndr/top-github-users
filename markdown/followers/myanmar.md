...
The `number of followers` of users in Myanmar on `2022/11/13 1:18 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

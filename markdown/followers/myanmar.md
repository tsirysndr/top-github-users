...
The `number of followers` of users in Myanmar on `2023/6/24 9:18 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

...
The `number of followers` of users in Myanmar on `2023/4/2 5:22 AM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

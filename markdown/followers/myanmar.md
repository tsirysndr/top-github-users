...
The `number of followers` of users in Myanmar on `2023/10/5 2:52 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

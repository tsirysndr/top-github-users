...
The `number of followers` of users in Myanmar on `2022/12/2 4:56 PM UTC`. This list contains users from `Myanmar` and cities `Yangon` `Mandalay` `Naypyitaw` `Bago` `Mawlamyine` `Taunggyi`.

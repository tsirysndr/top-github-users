...
The `number of followers` of users in Morocco on `2023/10/18 9:29 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

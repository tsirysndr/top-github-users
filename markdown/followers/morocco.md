...
The `number of followers` of users in Morocco on `2023/6/20 12:11 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

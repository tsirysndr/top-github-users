...
The `number of followers` of users in Morocco on `2023/9/11 7:19 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

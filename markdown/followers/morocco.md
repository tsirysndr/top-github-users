...
The `number of followers` of users in Morocco on `2023/10/18 3:06 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/Abdellahmaarifa">Abdellahmaarifa</a></td>
		<td>Marrakech, Morocco</td>
		<td>23</td>
	</tr>
	<tr>

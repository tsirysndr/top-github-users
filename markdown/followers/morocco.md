...
The `number of followers` of users in Morocco on `2023/7/8 2:36 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

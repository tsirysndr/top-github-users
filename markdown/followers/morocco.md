...
The `number of followers` of users in Morocco on `2023/10/9 8:41 AM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

...
The `number of followers` of users in Morocco on `2023/8/20 3:27 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

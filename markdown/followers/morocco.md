...
The `number of followers` of users in Morocco on `2023/9/9 3:08 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

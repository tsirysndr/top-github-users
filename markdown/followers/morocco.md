...
The `number of followers` of users in Morocco on `2023/11/25 1:00 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

...
The `number of followers` of users in Morocco on `2023/6/11 7:20 PM UTC`. This list contains users from `Morocco` and cities `Casablanca` `Tangier` `Marrakesh` `Meknes` `Rabat` `Fes`.

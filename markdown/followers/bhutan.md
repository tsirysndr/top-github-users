...
The `number of followers` of users in Bhutan on `2023/9/30 12:52 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

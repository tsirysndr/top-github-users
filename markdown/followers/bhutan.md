...
The `number of followers` of users in Bhutan on `2022/10/15 10:00 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

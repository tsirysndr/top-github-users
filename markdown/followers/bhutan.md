...
The `number of followers` of users in Bhutan on `2023/7/6 5:55 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

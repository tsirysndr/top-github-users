...
The `number of followers` of users in Bhutan on `2022/10/13 4:05 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/6/18 1:38 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

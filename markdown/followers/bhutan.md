...
The `number of followers` of users in Bhutan on `2023/5/2 1:42 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

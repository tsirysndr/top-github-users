...
The `number of followers` of users in Bhutan on `2023/4/10 11:15 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2022/10/14 1:18 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

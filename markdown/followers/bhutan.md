...
The `number of followers` of users in Bhutan on `2023/4/16 10:00 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/4/15 11:00 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/7/19 3:41 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/11/23 5:19 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/1/28 8:44 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2022/11/8 6:21 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

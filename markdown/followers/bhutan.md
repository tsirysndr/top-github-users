...
The `number of followers` of users in Bhutan on `2023/8/30 2:27 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

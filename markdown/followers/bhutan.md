...
The `number of followers` of users in Bhutan on `2023/2/22 12:15 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

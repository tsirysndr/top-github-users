...
The `number of followers` of users in Bhutan on `2023/1/20 7:33 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

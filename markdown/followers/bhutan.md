...
The `number of followers` of users in Bhutan on `2022/11/17 11:14 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

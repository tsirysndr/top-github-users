...
The `number of followers` of users in Bhutan on `2023/2/13 7:19 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

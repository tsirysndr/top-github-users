...
The `number of followers` of users in Bhutan on `2022/12/25 10:46 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

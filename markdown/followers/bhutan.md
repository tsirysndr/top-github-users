...
The `number of followers` of users in Bhutan on `2023/8/13 2:23 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

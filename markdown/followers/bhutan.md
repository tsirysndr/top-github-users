...
The `number of followers` of users in Bhutan on `2022/10/25 3:43 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/1/23 1:41 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

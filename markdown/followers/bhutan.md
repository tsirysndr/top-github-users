...
The `number of followers` of users in Bhutan on `2022/10/20 2:18 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/2/7 12:42 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

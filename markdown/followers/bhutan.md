...
The `number of followers` of users in Bhutan on `2022/10/17 3:03 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/11/7 4:28 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

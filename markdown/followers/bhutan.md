...
The `number of followers` of users in Bhutan on `2022/11/11 1:52 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

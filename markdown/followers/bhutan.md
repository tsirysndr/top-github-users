...
The `number of followers` of users in Bhutan on `2023/6/15 9:08 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

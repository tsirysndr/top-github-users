...
The `number of followers` of users in Bhutan on `2023/6/6 11:35 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

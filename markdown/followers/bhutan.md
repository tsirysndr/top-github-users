...
The `number of followers` of users in Bhutan on `2022/10/18 12:13 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/9/20 7:40 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/8/11 4:14 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

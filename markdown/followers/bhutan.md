...
The `number of followers` of users in Bhutan on `2023/4/24 11:45 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

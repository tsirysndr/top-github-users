...
The `number of followers` of users in Bhutan on `2023/9/18 7:36 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/7/2 7:26 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

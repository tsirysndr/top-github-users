...
The `number of followers` of users in Bhutan on `2023/1/6 8:41 AM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

...
The `number of followers` of users in Bhutan on `2023/1/10 4:16 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

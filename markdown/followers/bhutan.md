...
The `number of followers` of users in Bhutan on `2023/8/1 11:39 PM UTC`. This list contains users from `Bhutan` and cities `Thimphu` `Phuntsholing` `Phuntsholing` `Gelephu`.

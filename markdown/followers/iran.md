...
The `number of followers` of users in Iran on `2023/2/27 4:34 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2023/4/22 5:43 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

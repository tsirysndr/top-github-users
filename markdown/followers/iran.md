...
The `number of followers` of users in Iran on `2022/10/19 3:53 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

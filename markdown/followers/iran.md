...
The `number of followers` of users in Iran on `2023/6/4 6:33 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2023/1/23 7:01 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2022/11/5 7:39 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

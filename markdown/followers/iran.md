...
The `number of followers` of users in Iran on `2023/1/27 8:11 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

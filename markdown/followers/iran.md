...
The `number of followers` of users in Iran on `2023/6/23 5:30 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

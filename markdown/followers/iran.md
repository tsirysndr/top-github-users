...
The `number of followers` of users in Iran on `2023/6/13 8:57 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

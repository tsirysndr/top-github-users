...
The `number of followers` of users in Iran on `2022/12/12 3:47 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

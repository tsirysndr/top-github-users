...
The `number of followers` of users in Iran on `2022/12/30 10:28 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

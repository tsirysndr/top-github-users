...
The `number of followers` of users in Iran on `2022/10/26 4:22 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

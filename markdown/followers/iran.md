...
The `number of followers` of users in Iran on `2022/10/30 4:33 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2022/12/29 3:31 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

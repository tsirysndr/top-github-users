...
The `number of followers` of users in Iran on `2022/12/6 1:25 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

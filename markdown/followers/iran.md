...
The `number of followers` of users in Iran on `2023/2/6 11:42 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

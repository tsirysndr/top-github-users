...
The `number of followers` of users in Iran on `2023/3/8 3:38 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

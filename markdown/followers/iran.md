...
The `number of followers` of users in Iran on `2023/4/6 12:57 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

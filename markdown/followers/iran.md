...
The `number of followers` of users in Iran on `2022/12/3 8:14 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2022/10/23 3:07 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2022/10/20 1:04 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

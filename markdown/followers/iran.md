...
The `number of followers` of users in Iran on `2023/6/5 5:29 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

...
The `number of followers` of users in Iran on `2023/1/21 1:00 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

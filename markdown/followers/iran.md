...
The `number of followers` of users in Iran on `2022/10/25 2:13 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

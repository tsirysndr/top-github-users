...
The `number of followers` of users in Iran on `2022/12/2 1:01 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

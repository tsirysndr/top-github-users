...
The `number of followers` of users in Iran on `2023/1/11 5:43 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

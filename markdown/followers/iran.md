...
The `number of followers` of users in Iran on `2023/1/30 12:56 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

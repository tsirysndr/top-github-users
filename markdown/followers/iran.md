...
The `number of followers` of users in Iran on `2023/4/16 9:44 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

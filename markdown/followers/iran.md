...
The `number of followers` of users in Iran on `2022/11/6 2:30 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

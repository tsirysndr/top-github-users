...
The `number of followers` of users in Armenia on `2023/7/27 10:05 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

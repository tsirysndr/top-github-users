...
The `number of followers` of users in Armenia on `2023/6/7 4:08 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

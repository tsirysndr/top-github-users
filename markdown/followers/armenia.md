...
The `number of followers` of users in Armenia on `2023/11/1 3:47 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

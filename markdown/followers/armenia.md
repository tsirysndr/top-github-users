...
The `number of followers` of users in Armenia on `2023/5/31 10:51 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

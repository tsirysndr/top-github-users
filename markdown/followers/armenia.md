...
The `number of followers` of users in Armenia on `2023/11/16 1:52 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

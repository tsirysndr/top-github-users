...
The `number of followers` of users in Armenia on `2023/6/18 5:48 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

...
The `number of followers` of users in Armenia on `2023/11/16 7:58 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

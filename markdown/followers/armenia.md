...
The `number of followers` of users in Armenia on `2023/12/1 11:28 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

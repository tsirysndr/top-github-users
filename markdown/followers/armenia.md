...
The `number of followers` of users in Armenia on `2023/9/16 2:09 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

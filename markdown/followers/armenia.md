...
The `number of followers` of users in Armenia on `2023/10/8 4:42 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

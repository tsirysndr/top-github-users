...
The `number of followers` of users in Armenia on `2023/11/5 1:52 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

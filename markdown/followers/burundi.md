...
The `number of followers` of users in Burundi on `2023/2/23 7:04 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

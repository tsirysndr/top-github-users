...
The `number of followers` of users in Burundi on `2023/5/24 5:30 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/10/23 6:23 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/6/28 4:10 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2022/12/19 9:51 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

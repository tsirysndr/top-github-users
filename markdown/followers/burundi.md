...
The `number of followers` of users in Burundi on `2023/2/15 8:48 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

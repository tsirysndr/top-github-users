...
The `number of followers` of users in Burundi on `2023/7/23 4:05 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

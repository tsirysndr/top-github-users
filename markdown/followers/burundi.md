...
The `number of followers` of users in Burundi on `2023/9/24 7:42 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

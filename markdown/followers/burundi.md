...
The `number of followers` of users in Burundi on `2023/2/26 5:38 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

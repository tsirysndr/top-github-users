...
The `number of followers` of users in Burundi on `2023/11/7 5:07 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

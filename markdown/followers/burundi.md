...
The `number of followers` of users in Burundi on `2023/4/27 7:12 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

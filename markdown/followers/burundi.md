...
The `number of followers` of users in Burundi on `2022/10/24 5:30 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/6/12 4:47 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/5/23 5:41 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

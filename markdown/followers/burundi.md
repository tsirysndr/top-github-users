...
The `number of followers` of users in Burundi on `2023/5/20 9:53 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

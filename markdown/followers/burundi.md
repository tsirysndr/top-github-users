...
The `number of followers` of users in Burundi on `2023/5/26 10:45 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

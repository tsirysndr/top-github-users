...
The `number of followers` of users in Burundi on `2023/2/13 7:58 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

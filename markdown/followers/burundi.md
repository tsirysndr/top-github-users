...
The `number of followers` of users in Burundi on `2023/1/22 8:19 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2022/11/20 8:57 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

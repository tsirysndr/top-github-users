...
The `number of followers` of users in Burundi on `2023/9/15 4:42 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

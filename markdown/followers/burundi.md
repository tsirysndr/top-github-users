...
The `number of followers` of users in Burundi on `2023/7/26 1:02 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

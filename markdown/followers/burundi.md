...
The `number of followers` of users in Burundi on `2023/8/29 3:34 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

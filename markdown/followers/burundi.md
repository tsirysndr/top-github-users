...
The `number of followers` of users in Burundi on `2023/1/25 10:39 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/8/18 3:55 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

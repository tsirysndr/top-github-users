...
The `number of followers` of users in Burundi on `2023/10/22 6:30 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

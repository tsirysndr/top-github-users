...
The `number of followers` of users in Burundi on `2023/7/10 12:52 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/9/7 8:05 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

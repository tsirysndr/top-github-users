...
The `number of followers` of users in Burundi on `2023/8/2 12:14 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/7/27 11:47 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

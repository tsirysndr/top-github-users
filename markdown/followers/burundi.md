...
The `number of followers` of users in Burundi on `2023/9/10 5:48 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

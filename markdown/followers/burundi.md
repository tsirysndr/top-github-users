...
The `number of followers` of users in Burundi on `2023/10/19 7:17 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

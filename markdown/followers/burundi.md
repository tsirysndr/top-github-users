...
The `number of followers` of users in Burundi on `2023/1/8 6:54 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

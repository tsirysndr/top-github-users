...
The `number of followers` of users in Burundi on `2023/11/18 9:29 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

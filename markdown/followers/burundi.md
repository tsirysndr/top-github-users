...
The `number of followers` of users in Burundi on `2023/11/23 12:07 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/5/5 9:31 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

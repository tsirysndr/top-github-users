...
The `number of followers` of users in Burundi on `2022/11/6 4:34 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/2/20 6:40 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

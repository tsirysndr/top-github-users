...
The `number of followers` of users in Burundi on `2023/10/16 6:34 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/1/11 12:40 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Burundi on `2023/4/22 6:40 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

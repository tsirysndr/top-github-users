...
The `number of followers` of users in Burundi on `2023/12/3 12:31 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

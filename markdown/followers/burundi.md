...
The `number of followers` of users in Burundi on `2023/10/27 12:53 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

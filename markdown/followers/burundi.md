...
The `number of followers` of users in Burundi on `2022/11/30 5:22 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `number of followers` of users in Malta on `2023/7/7 7:41 AM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `902 users`  in Malta. You need at least `0 followers` to be on this list.

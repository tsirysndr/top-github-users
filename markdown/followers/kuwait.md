...
The `number of followers` of users in Kuwait on `2023/7/30 9:02 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

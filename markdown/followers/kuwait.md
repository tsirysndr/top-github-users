...
The `number of followers` of users in Kuwait on `2023/2/10 9:00 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

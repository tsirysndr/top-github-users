...
The `number of followers` of users in Kuwait on `2022/11/11 8:59 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

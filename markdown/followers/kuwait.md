...
The `number of followers` of users in Kuwait on `2023/11/20 8:19 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

...
The `number of followers` of users in Kuwait on `2023/10/7 6:51 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

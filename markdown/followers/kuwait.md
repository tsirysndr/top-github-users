...
The `number of followers` of users in Kuwait on `2022/11/12 3:35 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

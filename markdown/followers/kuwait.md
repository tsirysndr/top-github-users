...
The `number of followers` of users in Kuwait on `2022/12/30 12:00 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

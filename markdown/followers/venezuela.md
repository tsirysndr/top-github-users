...
The `number of followers` of users in Venezuela on `2023/1/28 11:45 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

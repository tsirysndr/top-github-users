...
The `number of followers` of users in Venezuela on `2023/12/2 9:30 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

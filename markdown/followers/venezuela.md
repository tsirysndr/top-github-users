...
The `number of followers` of users in Venezuela on `2023/2/2 10:49 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

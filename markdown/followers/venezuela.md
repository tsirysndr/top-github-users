...
The `number of followers` of users in Venezuela on `2023/11/24 8:21 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

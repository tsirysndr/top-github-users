...
The `number of followers` of users in Venezuela on `2023/10/1 9:20 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

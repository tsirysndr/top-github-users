...
The `number of followers` of users in Venezuela on `2022/10/19 4:19 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

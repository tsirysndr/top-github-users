...
The `number of followers` of users in Venezuela on `2023/7/16 3:04 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

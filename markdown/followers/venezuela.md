...
The `number of followers` of users in Venezuela on `2023/7/14 10:10 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

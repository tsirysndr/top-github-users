...
The `number of followers` of users in Venezuela on `2022/10/13 1:09 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

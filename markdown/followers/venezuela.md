...
The `number of followers` of users in Venezuela on `2022/12/18 3:42 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/10/19 4:07 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

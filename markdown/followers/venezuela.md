...
The `number of followers` of users in Venezuela on `2023/4/29 7:36 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/11/1 2:26 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2022/10/6 12:49 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2022/10/22 4:45 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

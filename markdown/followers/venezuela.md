...
The `number of followers` of users in Venezuela on `2023/11/16 6:39 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/5/5 6:23 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

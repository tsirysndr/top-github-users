...
The `number of followers` of users in Venezuela on `2022/10/11 3:07 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/8/8 9:13 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/4/17 1:17 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

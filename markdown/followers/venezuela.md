...
The `number of followers` of users in Venezuela on `2023/6/22 9:52 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

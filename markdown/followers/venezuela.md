...
The `number of followers` of users in Venezuela on `2022/11/17 12:44 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

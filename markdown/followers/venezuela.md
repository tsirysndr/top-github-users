...
The `number of followers` of users in Venezuela on `2023/9/4 3:11 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/5/21 12:04 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

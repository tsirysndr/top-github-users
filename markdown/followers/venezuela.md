...
The `number of followers` of users in Venezuela on `2022/12/27 4:50 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

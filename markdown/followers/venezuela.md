...
The `number of followers` of users in Venezuela on `2023/1/29 5:20 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/2/6 3:46 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

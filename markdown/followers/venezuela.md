...
The `number of followers` of users in Venezuela on `2023/3/27 8:14 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

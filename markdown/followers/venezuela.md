...
The `number of followers` of users in Venezuela on `2023/9/11 8:08 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

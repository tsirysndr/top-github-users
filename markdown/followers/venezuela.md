...
The `number of followers` of users in Venezuela on `2023/2/25 8:46 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

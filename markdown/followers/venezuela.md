...
The `number of followers` of users in Venezuela on `2023/11/22 5:02 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

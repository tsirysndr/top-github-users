...
The `number of followers` of users in Venezuela on `2023/3/28 3:00 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

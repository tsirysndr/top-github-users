...
The `number of followers` of users in Venezuela on `2023/10/26 3:47 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

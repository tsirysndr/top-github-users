...
The `number of followers` of users in Venezuela on `2022/12/16 1:25 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

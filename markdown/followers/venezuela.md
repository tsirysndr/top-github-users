...
The `number of followers` of users in Venezuela on `2023/5/26 7:39 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

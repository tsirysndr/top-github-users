...
The `number of followers` of users in Venezuela on `2023/11/15 6:19 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

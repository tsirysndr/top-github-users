...
The `number of followers` of users in Venezuela on `2023/5/18 1:47 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

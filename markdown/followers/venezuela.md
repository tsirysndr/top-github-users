...
The `number of followers` of users in Venezuela on `2023/7/26 9:54 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

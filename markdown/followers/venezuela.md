...
The `number of followers` of users in Venezuela on `2023/2/3 5:14 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

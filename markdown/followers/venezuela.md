...
The `number of followers` of users in Venezuela on `2022/10/17 9:24 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

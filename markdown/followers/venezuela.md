...
The `number of followers` of users in Venezuela on `2023/9/28 10:40 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2023/9/12 1:55 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2022/10/16 3:48 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

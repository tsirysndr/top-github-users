...
The `number of followers` of users in Venezuela on `2023/11/6 5:50 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

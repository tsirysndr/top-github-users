...
The `number of followers` of users in Venezuela on `2023/2/5 10:21 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

...
The `number of followers` of users in Venezuela on `2022/11/21 7:48 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

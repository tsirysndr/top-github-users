...
The `number of followers` of users in Yemen on `2022/11/15 10:14 AM UTC`. This list contains users from `Yemen` and cities ` Sana'a`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `941 users`  in Yemen. You need at least `0 followers` to be on this list.

...
The `number of followers` of users in Croatia on `2023/1/31 9:38 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

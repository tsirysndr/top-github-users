...
The `number of followers` of users in Croatia on `2023/2/5 2:47 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

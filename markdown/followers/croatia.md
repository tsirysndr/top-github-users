...
The `number of followers` of users in Croatia on `2023/6/13 12:03 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

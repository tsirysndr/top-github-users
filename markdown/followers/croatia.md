...
The `number of followers` of users in Croatia on `2023/3/6 10:34 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

...
The `number of followers` of users in Croatia on `2023/11/21 9:27 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

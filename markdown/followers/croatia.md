...
The `number of followers` of users in Croatia on `2022/12/13 2:14 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

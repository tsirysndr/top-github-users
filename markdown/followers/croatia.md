...
The `number of followers` of users in Croatia on `2023/3/17 8:37 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

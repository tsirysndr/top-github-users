...
The `number of followers` of users in Croatia on `2023/3/20 1:07 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

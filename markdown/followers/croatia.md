...
The `number of followers` of users in Croatia on `2023/9/7 3:25 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

...
The `number of followers` of users in Croatia on `2022/12/5 2:54 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

...
The `number of followers` of users in Croatia on `2023/8/30 4:32 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

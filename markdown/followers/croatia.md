...
The `number of followers` of users in Croatia on `2023/12/3 7:11 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

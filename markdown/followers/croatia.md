...
The `number of followers` of users in Croatia on `2023/5/30 2:53 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

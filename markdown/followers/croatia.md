...
The `number of followers` of users in Croatia on `2023/8/12 11:23 AM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

...
The `number of followers` of users in Croatia on `2023/11/24 12:55 PM UTC`. This list contains users from `Croatia` and cities `Zagreb` `Split` `Dubrovnik` `Rijeka` `Osijek` `Zadar`.

...
The `number of followers` of users in Ecuador on `2023/11/19 10:39 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

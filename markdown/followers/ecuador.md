...
The `number of followers` of users in Ecuador on `2023/10/4 2:25 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/3/30 6:24 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

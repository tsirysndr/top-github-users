...
The `number of followers` of users in Ecuador on `2023/11/27 2:26 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/1/25 12:56 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/1/2 11:43 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

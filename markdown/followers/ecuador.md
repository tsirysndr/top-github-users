...
The `number of followers` of users in Ecuador on `2023/7/2 10:12 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/8/15 8:20 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

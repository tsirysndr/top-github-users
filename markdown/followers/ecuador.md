...
The `number of followers` of users in Ecuador on `2023/1/17 9:29 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

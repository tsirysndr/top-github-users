...
The `number of followers` of users in Ecuador on `2022/11/4 9:42 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/9/29 9:59 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/10/10 3:10 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

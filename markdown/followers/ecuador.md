...
The `number of followers` of users in Ecuador on `2023/4/26 3:29 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/2/17 7:37 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

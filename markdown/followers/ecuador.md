...
The `number of followers` of users in Ecuador on `2023/3/13 7:06 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

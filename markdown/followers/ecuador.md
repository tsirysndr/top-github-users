...
The `number of followers` of users in Ecuador on `2023/9/14 1:02 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

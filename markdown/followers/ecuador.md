...
The `number of followers` of users in Ecuador on `2022/12/12 1:10 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

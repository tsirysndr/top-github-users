...
The `number of followers` of users in Ecuador on `2022/10/11 8:46 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

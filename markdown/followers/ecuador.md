...
The `number of followers` of users in Ecuador on `2023/10/7 3:05 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

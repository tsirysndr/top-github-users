...
The `number of followers` of users in Ecuador on `2022/11/23 3:47 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

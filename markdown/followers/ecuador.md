...
The `number of followers` of users in Ecuador on `2023/7/19 1:05 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

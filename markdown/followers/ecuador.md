...
The `number of followers` of users in Ecuador on `2023/10/31 8:01 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

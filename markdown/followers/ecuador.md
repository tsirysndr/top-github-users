...
The `number of followers` of users in Ecuador on `2023/8/4 6:45 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

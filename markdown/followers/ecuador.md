...
The `number of followers` of users in Ecuador on `2023/7/16 2:44 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

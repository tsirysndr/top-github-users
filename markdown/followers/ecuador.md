...
The `number of followers` of users in Ecuador on `2023/11/24 1:47 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2022/11/28 10:06 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

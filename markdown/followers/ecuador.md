...
The `number of followers` of users in Ecuador on `2023/6/10 3:11 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

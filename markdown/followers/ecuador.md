...
The `number of followers` of users in Ecuador on `2022/11/11 4:55 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

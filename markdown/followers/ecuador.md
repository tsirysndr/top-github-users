...
The `number of followers` of users in Ecuador on `2023/7/12 9:45 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

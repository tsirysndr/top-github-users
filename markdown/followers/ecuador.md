...
The `number of followers` of users in Ecuador on `2022/10/28 11:46 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

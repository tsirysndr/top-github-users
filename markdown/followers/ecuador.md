...
The `number of followers` of users in Ecuador on `2022/11/17 6:37 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

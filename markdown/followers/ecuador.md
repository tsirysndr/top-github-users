...
The `number of followers` of users in Ecuador on `2023/3/19 8:31 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/9/30 3:41 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/1/4 9:39 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

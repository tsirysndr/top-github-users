...
The `number of followers` of users in Ecuador on `2023/5/21 5:20 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2022/12/23 11:42 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

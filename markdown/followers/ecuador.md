...
The `number of followers` of users in Ecuador on `2023/6/26 2:59 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

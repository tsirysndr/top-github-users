...
The `number of followers` of users in Ecuador on `2023/1/29 10:34 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

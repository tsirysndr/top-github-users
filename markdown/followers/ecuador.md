...
The `number of followers` of users in Ecuador on `2023/11/17 12:12 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/2/11 4:59 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

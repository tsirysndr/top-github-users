...
The `number of followers` of users in Ecuador on `2023/8/10 6:39 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

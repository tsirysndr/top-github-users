...
The `number of followers` of users in Ecuador on `2022/12/16 12:16 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2023/8/2 7:59 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `number of followers` of users in Ecuador on `2022/10/29 6:59 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

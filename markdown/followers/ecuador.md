...
The `number of followers` of users in Ecuador on `2023/6/24 3:13 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

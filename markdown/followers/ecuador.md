...
The `number of followers` of users in Ecuador on `2023/3/17 9:27 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

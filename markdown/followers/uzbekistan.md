...
The `number of followers` of users in Uzbekistan on `2023/10/25 3:22 AM UTC`. This list contains users from `Uzbekistan` and cities `Samarkand` `Tashkent`.
...
<table>
	...
	<tr>
		...
		<td>Kattakurgan, Samarkand, Uzbekistan</td>
		<td>23</td>
	</tr>
	<tr>
		<td>372</td>

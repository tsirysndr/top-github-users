...
The `number of followers` of users in Uzbekistan on `2023/6/13 1:09 PM UTC`. This list contains users from `Uzbekistan` and cities `Samarkand` `Tashkent`.
...
<table>
	...
	<tr>
		...
		<td>Uic Group </td>
		<td><a href="https://twitter.com/shohruhmustang">shohruhmustang</a></td>
		<td>Tashkent</td>
		<td>11</td>
	</tr>
	<tr>

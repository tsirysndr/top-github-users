...
The `number of followers` of users in Uzbekistan on `2023/10/3 2:37 PM UTC`. This list contains users from `Uzbekistan` and cities `Samarkand` `Tashkent`.

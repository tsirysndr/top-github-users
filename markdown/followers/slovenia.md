...
The `number of followers` of users in Slovenia on `2022/12/24 10:06 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

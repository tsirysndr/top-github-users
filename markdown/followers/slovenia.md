...
The `number of followers` of users in Slovenia on `2023/2/6 7:20 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

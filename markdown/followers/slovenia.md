...
The `number of followers` of users in Slovenia on `2023/4/23 6:22 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

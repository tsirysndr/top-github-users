...
The `number of followers` of users in Slovenia on `2023/7/24 3:26 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

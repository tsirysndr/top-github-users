...
The `number of followers` of users in Slovenia on `2022/11/18 12:39 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/1/12 10:31 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

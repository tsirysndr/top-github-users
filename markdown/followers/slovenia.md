...
The `number of followers` of users in Slovenia on `2022/11/10 1:22 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

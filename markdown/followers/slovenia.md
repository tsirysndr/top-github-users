...
The `number of followers` of users in Slovenia on `2023/7/31 7:41 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

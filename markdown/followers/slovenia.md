...
The `number of followers` of users in Slovenia on `2023/7/6 12:38 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

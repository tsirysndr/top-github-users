...
The `number of followers` of users in Slovenia on `2023/3/9 5:34 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

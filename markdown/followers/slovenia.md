...
The `number of followers` of users in Slovenia on `2023/2/2 7:58 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2022/11/7 5:30 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/3/18 6:59 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

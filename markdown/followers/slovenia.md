...
The `number of followers` of users in Slovenia on `2023/8/21 12:45 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/7/9 6:52 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

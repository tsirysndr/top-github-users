...
The `number of followers` of users in Slovenia on `2022/11/22 12:10 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

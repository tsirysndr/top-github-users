...
The `number of followers` of users in Slovenia on `2022/12/26 12:04 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

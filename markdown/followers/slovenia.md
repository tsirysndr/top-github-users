...
The `number of followers` of users in Slovenia on `2023/8/26 4:50 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/10/27 6:53 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/6/13 10:33 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

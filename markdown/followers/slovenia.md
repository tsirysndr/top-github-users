...
The `number of followers` of users in Slovenia on `2023/7/16 12:22 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

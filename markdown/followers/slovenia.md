...
The `number of followers` of users in Slovenia on `2023/8/22 6:42 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/2/28 12:14 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/10/15 7:17 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

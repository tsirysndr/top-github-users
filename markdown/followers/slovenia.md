...
The `number of followers` of users in Slovenia on `2023/4/26 7:08 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

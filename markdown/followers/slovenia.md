...
The `number of followers` of users in Slovenia on `2023/4/17 10:30 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

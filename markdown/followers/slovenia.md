...
The `number of followers` of users in Slovenia on `2023/9/14 10:56 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

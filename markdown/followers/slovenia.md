...
The `number of followers` of users in Slovenia on `2023/11/3 5:22 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

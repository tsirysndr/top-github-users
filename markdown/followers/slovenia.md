...
The `number of followers` of users in Slovenia on `2023/6/18 1:49 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

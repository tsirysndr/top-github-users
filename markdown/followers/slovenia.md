...
The `number of followers` of users in Slovenia on `2023/10/9 12:44 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

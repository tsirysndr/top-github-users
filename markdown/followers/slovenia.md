...
The `number of followers` of users in Slovenia on `2022/10/22 1:53 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

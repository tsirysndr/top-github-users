...
The `number of followers` of users in Slovenia on `2023/7/13 1:26 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

...
The `number of followers` of users in Slovenia on `2023/2/17 5:28 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

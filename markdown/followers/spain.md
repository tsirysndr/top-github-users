...
The `number of followers` of users in Spain on `2023/9/28 8:19 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

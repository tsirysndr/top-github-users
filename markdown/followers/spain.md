...
The `number of followers` of users in Spain on `2023/3/13 5:40 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

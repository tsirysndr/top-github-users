...
The `number of followers` of users in Spain on `2023/2/4 2:47 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

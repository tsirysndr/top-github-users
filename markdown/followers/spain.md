...
The `number of followers` of users in Spain on `2023/8/7 1:31 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

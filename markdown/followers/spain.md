...
The `number of followers` of users in Spain on `2022/12/1 6:33 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/3/12 11:34 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

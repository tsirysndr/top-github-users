...
The `number of followers` of users in Spain on `2023/8/5 9:48 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

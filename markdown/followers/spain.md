...
The `number of followers` of users in Spain on `2022/10/9 10:51 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

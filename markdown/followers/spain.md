...
The `number of followers` of users in Spain on `2022/10/30 6:01 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

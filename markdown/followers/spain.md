...
The `number of followers` of users in Spain on `2022/11/18 1:08 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

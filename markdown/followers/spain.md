...
The `number of followers` of users in Spain on `2023/11/18 9:37 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

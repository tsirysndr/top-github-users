...
The `number of followers` of users in Spain on `2022/11/6 10:52 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

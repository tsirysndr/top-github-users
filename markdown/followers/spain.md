...
The `number of followers` of users in Spain on `2023/3/16 1:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

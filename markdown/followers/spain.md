...
The `number of followers` of users in Spain on `2022/12/5 7:24 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

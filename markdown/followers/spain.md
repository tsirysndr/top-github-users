...
The `number of followers` of users in Spain on `2022/11/13 5:54 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/1/23 3:08 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

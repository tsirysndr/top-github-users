...
The `number of followers` of users in Spain on `2023/1/3 5:56 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/10/2 12:21 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

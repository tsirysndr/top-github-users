...
The `number of followers` of users in Spain on `2023/6/8 8:02 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

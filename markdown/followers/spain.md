...
The `number of followers` of users in Spain on `2022/12/24 10:27 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

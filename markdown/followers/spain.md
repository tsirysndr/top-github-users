...
The `number of followers` of users in Spain on `2022/12/28 9:33 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/4/10 6:19 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

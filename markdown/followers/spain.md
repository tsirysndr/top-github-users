...
The `number of followers` of users in Spain on `2022/11/14 12:47 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

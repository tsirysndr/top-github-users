...
The `number of followers` of users in Spain on `2023/6/27 5:08 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

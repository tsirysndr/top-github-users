...
The `number of followers` of users in Spain on `2023/10/5 7:11 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2022/12/16 11:15 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/8/3 11:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2022/10/18 3:57 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

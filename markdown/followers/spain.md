...
The `number of followers` of users in Spain on `2022/10/21 4:24 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

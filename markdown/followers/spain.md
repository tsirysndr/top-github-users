...
The `number of followers` of users in Spain on `2022/12/26 12:47 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

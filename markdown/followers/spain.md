...
The `number of followers` of users in Spain on `2022/12/22 8:49 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/5/7 8:10 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

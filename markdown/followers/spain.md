...
The `number of followers` of users in Spain on `2023/11/15 4:04 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

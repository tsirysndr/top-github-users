...
The `number of followers` of users in Spain on `2022/12/31 1:44 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/4/17 10:58 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

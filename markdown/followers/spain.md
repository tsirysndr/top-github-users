...
The `number of followers` of users in Spain on `2023/10/13 1:49 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

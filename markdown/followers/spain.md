...
The `number of followers` of users in Spain on `2022/11/12 10:25 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

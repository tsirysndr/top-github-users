...
The `number of followers` of users in Spain on `2023/2/28 12:43 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

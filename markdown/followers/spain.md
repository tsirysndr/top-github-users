...
The `number of followers` of users in Spain on `2022/10/20 9:11 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

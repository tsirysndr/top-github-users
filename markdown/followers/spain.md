...
The `number of followers` of users in Spain on `2023/1/21 8:53 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

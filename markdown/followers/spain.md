...
The `number of followers` of users in Spain on `2023/2/11 9:28 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

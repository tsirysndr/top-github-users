...
The `number of followers` of users in Spain on `2022/12/6 2:36 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

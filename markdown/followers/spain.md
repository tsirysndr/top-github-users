...
The `number of followers` of users in Spain on `2023/6/9 1:42 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

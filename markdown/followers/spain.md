...
The `number of followers` of users in Spain on `2023/7/6 7:00 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

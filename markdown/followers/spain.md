...
The `number of followers` of users in Spain on `2022/12/15 3:58 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

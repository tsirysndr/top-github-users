...
The `number of followers` of users in Spain on `2022/11/16 10:17 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

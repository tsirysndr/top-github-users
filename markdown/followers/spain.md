...
The `number of followers` of users in Spain on `2022/11/12 3:42 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

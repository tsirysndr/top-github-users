...
The `number of followers` of users in Spain on `2023/6/13 11:01 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

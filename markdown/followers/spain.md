...
The `number of followers` of users in Spain on `2023/11/10 11:10 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

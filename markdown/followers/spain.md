...
The `number of followers` of users in Spain on `2022/11/22 12:36 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

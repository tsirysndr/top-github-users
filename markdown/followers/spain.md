...
The `number of followers` of users in Spain on `2022/11/20 3:13 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/9/22 9:56 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

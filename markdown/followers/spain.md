...
The `number of followers` of users in Spain on `2022/11/4 1:38 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/7/13 1:54 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/1/28 3:56 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Spain on `2023/6/28 4:28 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

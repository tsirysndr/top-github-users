...
The `number of followers` of users in Spain on `2022/11/24 9:53 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

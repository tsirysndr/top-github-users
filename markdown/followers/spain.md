...
The `number of followers` of users in Spain on `2022/12/3 4:36 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `number of followers` of users in Andorra on `2023/6/22 10:47 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

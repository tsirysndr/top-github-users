...
The `number of followers` of users in Andorra on `2023/1/27 1:05 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

...
The `number of followers` of users in Andorra on `2022/11/22 3:45 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

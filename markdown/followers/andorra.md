...
The `number of followers` of users in Andorra on `2023/6/22 5:10 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

...
The `number of followers` of users in Andorra on `2023/10/7 10:38 AM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

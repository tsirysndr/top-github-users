...
The `number of followers` of users in Andorra on `2023/4/22 4:29 PM UTC`. This list contains users from `Andorra` and cities `Andorra-la-vella` `Santa-coloma` `La-margineda` `Engolasters`.

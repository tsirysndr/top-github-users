...
The `number of followers` of users in Mauritania on `2023/11/25 12:13 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

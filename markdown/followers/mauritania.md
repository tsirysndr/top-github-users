...
The `number of followers` of users in Mauritania on `2022/12/1 1:09 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

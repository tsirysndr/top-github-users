...
The `number of followers` of users in Mauritania on `2023/6/15 11:01 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

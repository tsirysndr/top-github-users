...
The `number of followers` of users in Mauritania on `2023/9/17 4:03 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2023/9/14 6:12 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

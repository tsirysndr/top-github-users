...
The `number of followers` of users in Mauritania on `2022/12/9 2:26 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2023/8/21 8:03 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

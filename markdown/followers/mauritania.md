...
The `number of followers` of users in Mauritania on `2023/4/29 5:37 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

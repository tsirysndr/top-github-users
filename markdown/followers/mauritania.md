...
The `number of followers` of users in Mauritania on `2022/11/27 8:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2023/9/15 11:55 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

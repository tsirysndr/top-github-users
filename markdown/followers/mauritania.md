...
The `number of followers` of users in Mauritania on `2023/9/19 3:23 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

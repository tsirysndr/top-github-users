...
The `number of followers` of users in Mauritania on `2023/8/18 10:58 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

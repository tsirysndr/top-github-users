...
The `number of followers` of users in Mauritania on `2023/7/22 1:08 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

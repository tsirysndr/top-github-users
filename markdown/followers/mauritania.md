...
The `number of followers` of users in Mauritania on `2023/8/3 12:47 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

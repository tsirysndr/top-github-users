...
The `number of followers` of users in Mauritania on `2022/11/30 5:59 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

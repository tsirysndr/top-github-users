...
The `number of followers` of users in Mauritania on `2022/11/15 2:32 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

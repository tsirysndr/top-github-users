...
The `number of followers` of users in Mauritania on `2023/7/3 3:02 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

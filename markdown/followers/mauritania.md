...
The `number of followers` of users in Mauritania on `2023/7/1 4:24 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

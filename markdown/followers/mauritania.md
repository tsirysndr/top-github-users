...
The `number of followers` of users in Mauritania on `2023/5/30 2:56 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

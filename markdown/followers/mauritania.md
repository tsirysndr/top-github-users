...
The `number of followers` of users in Mauritania on `2023/2/16 6:49 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

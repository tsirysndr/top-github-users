...
The `number of followers` of users in Mauritania on `2023/8/13 9:49 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

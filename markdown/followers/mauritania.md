...
The `number of followers` of users in Mauritania on `2023/4/9 7:31 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

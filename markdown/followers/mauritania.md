...
The `number of followers` of users in Mauritania on `2023/5/13 9:51 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

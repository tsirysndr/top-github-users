...
The `number of followers` of users in Mauritania on `2023/3/29 1:54 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2023/4/26 2:30 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

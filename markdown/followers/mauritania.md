...
The `number of followers` of users in Mauritania on `2023/10/15 8:11 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

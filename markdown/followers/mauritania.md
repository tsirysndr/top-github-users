...
The `number of followers` of users in Mauritania on `2023/8/11 11:50 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

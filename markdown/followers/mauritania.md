...
The `number of followers` of users in Mauritania on `2023/2/24 7:34 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

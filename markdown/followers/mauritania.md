...
The `number of followers` of users in Mauritania on `2022/10/23 5:53 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

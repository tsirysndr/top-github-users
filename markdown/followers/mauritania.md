...
The `number of followers` of users in Mauritania on `2023/6/13 11:30 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

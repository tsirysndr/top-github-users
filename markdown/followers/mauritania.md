...
The `number of followers` of users in Mauritania on `2023/1/16 12:31 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

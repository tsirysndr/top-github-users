...
The `number of followers` of users in Mauritania on `2022/10/26 12:00 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

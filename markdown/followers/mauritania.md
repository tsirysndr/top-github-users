...
The `number of followers` of users in Mauritania on `2022/10/22 10:43 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

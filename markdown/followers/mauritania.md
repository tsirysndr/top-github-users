...
The `number of followers` of users in Mauritania on `2023/5/17 12:44 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

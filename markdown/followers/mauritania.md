...
The `number of followers` of users in Mauritania on `2023/6/13 5:48 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

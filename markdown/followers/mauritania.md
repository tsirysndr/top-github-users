...
The `number of followers` of users in Mauritania on `2023/3/30 11:27 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

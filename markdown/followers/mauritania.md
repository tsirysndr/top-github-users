...
The `number of followers` of users in Mauritania on `2023/2/27 7:20 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2023/5/29 9:24 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

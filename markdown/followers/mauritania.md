...
The `number of followers` of users in Mauritania on `2023/1/13 1:09 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

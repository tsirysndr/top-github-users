...
The `number of followers` of users in Mauritania on `2023/10/6 7:58 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

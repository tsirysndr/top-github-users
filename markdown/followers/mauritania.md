...
The `number of followers` of users in Mauritania on `2023/6/8 8:38 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `number of followers` of users in Mauritania on `2022/12/6 4:10 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

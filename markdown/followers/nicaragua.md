...
The `number of followers` of users in Nicaragua on `2023/9/1 11:41 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/11/2 8:37 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

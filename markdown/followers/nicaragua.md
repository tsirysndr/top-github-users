...
The `number of followers` of users in Nicaragua on `2023/7/30 11:44 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

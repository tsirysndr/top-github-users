...
The `number of followers` of users in Nicaragua on `2023/10/4 3:06 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

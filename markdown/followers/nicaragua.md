...
The `number of followers` of users in Nicaragua on `2023/8/9 3:01 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/8/13 11:27 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

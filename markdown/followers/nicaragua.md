...
The `number of followers` of users in Nicaragua on `2023/10/30 8:49 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

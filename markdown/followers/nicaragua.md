...
The `number of followers` of users in Nicaragua on `2023/6/11 8:15 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

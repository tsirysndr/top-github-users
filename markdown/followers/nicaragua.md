...
The `number of followers` of users in Nicaragua on `2023/7/14 4:24 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

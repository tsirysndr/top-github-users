...
The `number of followers` of users in Nicaragua on `2023/12/4 2:31 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

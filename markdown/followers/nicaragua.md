...
The `number of followers` of users in Nicaragua on `2023/6/18 10:54 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

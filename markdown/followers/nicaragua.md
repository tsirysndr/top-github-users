...
The `number of followers` of users in Nicaragua on `2023/6/16 6:25 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

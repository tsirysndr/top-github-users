...
The `number of followers` of users in Nicaragua on `2023/9/9 4:02 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

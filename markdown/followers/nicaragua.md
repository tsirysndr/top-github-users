...
The `number of followers` of users in Nicaragua on `2023/10/31 2:46 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

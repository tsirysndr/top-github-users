...
The `number of followers` of users in Nicaragua on `2023/7/14 10:12 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/8/5 11:30 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

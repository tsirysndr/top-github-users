...
The `number of followers` of users in Nicaragua on `2023/8/19 6:08 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

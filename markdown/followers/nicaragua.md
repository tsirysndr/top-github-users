...
The `number of followers` of users in Nicaragua on `2023/8/22 9:38 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/10/21 9:52 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

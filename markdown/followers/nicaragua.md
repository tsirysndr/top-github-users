...
The `number of followers` of users in Nicaragua on `2023/11/19 11:47 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

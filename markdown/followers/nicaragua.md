...
The `number of followers` of users in Nicaragua on `2023/6/28 1:00 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

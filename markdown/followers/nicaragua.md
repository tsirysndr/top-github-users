...
The `number of followers` of users in Nicaragua on `2023/7/31 10:13 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/6/23 9:45 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

...
The `number of followers` of users in Nicaragua on `2023/10/5 3:37 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

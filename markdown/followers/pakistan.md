...
The `number of followers` of users in Pakistan on `2023/9/18 11:52 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

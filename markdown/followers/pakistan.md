...
The `number of followers` of users in Pakistan on `2023/10/23 9:49 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

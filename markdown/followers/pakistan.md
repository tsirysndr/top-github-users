...
The `number of followers` of users in Pakistan on `2023/11/9 2:31 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

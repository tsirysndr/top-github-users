...
The `number of followers` of users in Pakistan on `2023/11/24 3:19 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

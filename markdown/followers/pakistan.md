...
The `number of followers` of users in Pakistan on `2023/11/6 6:43 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

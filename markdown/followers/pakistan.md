...
The `number of followers` of users in Pakistan on `2023/8/28 1:07 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

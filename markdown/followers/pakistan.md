...
The `number of followers` of users in Pakistan on `2023/8/31 6:35 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

...
The `number of followers` of users in Pakistan on `2023/10/8 4:05 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

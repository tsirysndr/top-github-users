...
The `number of followers` of users in Pakistan on `2023/10/4 9:58 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

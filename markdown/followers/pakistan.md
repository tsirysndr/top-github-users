...
The `number of followers` of users in Pakistan on `2023/7/9 4:25 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

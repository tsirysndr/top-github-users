...
The `number of followers` of users in Pakistan on `2023/7/3 5:17 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

...
The `number of followers` of users in Pakistan on `2023/10/26 10:27 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

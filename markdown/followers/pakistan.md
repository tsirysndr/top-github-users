...
The `number of followers` of users in Pakistan on `2023/6/23 10:21 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

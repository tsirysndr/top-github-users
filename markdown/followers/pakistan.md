...
The `number of followers` of users in Pakistan on `2023/8/6 12:03 AM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

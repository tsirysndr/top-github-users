...
The `number of followers` of users in Pakistan on `2023/8/20 4:54 PM UTC`. This list contains users from `Pakistan` and cities `Islamabad` `Karachi` `Lahore` `Faisalabad` `Peshawar`.

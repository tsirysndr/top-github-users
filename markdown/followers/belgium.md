...
The `number of followers` of users in Belgium on `2023/7/8 11:51 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

...
The `number of followers` of users in Belgium on `2022/10/11 5:30 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

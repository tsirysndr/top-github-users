...
The `number of followers` of users in Belgium on `2023/9/7 1:13 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

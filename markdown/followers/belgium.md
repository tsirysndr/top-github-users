...
The `number of followers` of users in Belgium on `2022/12/24 3:29 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

...
The `number of followers` of users in Belgium on `2022/10/10 10:54 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

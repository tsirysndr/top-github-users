...
The `public contributions` and `private contributions` by users in Syria on `2023/2/8 9:00 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

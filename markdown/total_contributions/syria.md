...
The `public contributions` and `private contributions` by users in Syria on `2022/10/24 12:21 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

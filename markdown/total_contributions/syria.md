...
The `public contributions` and `private contributions` by users in Syria on `2023/8/23 7:21 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2022/11/26 12:56 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

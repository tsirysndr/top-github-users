...
The `public contributions` and `private contributions` by users in Syria on `2022/11/24 3:23 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

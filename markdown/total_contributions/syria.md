...
The `public contributions` and `private contributions` by users in Syria on `2023/1/8 9:04 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

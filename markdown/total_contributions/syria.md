...
The `public contributions` and `private contributions` by users in Syria on `2023/5/18 6:01 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/2/17 12:43 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

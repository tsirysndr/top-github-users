...
The `public contributions` and `private contributions` by users in Syria on `2023/9/15 12:03 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

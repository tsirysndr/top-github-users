...
The `public contributions` and `private contributions` by users in Syria on `2023/2/28 7:57 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

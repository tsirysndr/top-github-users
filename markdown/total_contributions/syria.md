...
The `public contributions` and `private contributions` by users in Syria on `2023/1/2 11:11 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/1/14 4:55 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

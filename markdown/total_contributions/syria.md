...
The `public contributions` and `private contributions` by users in Syria on `2023/1/8 1:48 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

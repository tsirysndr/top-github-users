...
The `public contributions` and `private contributions` by users in Syria on `2023/3/14 1:04 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

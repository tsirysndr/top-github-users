...
The `public contributions` and `private contributions` by users in Syria on `2023/10/28 2:02 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/2/9 3:32 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

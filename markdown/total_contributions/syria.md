...
The `public contributions` and `private contributions` by users in Syria on `2022/11/5 4:22 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

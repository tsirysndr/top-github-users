...
The `public contributions` and `private contributions` by users in Syria on `2023/6/19 8:14 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

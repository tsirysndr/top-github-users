...
The `public contributions` and `private contributions` by users in Syria on `2023/3/7 5:46 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

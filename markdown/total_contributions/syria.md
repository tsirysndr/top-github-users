...
The `public contributions` and `private contributions` by users in Syria on `2023/9/18 3:27 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

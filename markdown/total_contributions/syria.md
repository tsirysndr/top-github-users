...
The `public contributions` and `private contributions` by users in Syria on `2023/11/17 10:59 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

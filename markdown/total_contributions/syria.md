...
The `public contributions` and `private contributions` by users in Syria on `2023/8/4 5:22 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

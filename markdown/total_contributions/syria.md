...
The `public contributions` and `private contributions` by users in Syria on `2023/6/8 8:43 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

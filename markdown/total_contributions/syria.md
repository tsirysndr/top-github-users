...
The `public contributions` and `private contributions` by users in Syria on `2023/11/15 4:44 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

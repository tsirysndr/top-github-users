...
The `public contributions` and `private contributions` by users in Syria on `2023/11/18 10:16 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

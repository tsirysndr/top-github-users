...
The `public contributions` and `private contributions` by users in Syria on `2023/10/25 1:52 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/HanadiDar">
				<img src="https://avatars.githubusercontent.com/u/56400283?s=72&v=4" width="24" alt="Avatar of HanadiDar"> HanadiDar
			</a><br/>

...
The `public contributions` and `private contributions` by users in Syria on `2023/9/28 9:01 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/7/19 11:33 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

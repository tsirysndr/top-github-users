...
The `public contributions` and `private contributions` by users in Syria on `2023/12/2 2:19 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

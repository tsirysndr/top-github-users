...
The `public contributions` and `private contributions` by users in Syria on `2023/5/8 2:15 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2022/10/5 11:09 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/abodyzazo">
				<img src="https://avatars.githubusercontent.com/u/89407337?s=72&v=4" width="24" alt="Avatar of abodyzazo"> abodyzazo
			</a><br/>
			Abdalrahman_zazo
		</td>
		<td>No Company</td>

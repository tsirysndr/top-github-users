...
The `public contributions` and `private contributions` by users in Syria on `2023/11/25 5:50 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

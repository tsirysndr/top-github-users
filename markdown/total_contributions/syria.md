...
The `public contributions` and `private contributions` by users in Syria on `2023/10/8 7:39 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

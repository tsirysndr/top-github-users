...
The `public contributions` and `private contributions` by users in Syria on `2023/6/23 1:55 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

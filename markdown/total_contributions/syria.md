...
The `public contributions` and `private contributions` by users in Syria on `2022/10/16 10:17 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

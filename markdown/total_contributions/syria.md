...
The `public contributions` and `private contributions` by users in Syria on `2022/11/11 9:29 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

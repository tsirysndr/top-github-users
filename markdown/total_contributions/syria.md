...
The `public contributions` and `private contributions` by users in Syria on `2023/8/27 11:07 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

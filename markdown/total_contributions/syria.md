...
The `public contributions` and `private contributions` by users in Syria on `2023/6/13 11:42 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/11/21 9:37 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

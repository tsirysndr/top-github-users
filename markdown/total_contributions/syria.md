...
The `public contributions` and `private contributions` by users in Syria on `2022/11/3 6:54 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

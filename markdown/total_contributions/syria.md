...
The `public contributions` and `private contributions` by users in Syria on `2023/10/11 2:40 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

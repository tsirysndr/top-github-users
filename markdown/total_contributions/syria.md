...
The `public contributions` and `private contributions` by users in Syria on `2023/11/30 2:45 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

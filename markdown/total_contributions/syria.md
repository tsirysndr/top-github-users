...
The `public contributions` and `private contributions` by users in Syria on `2022/12/23 4:17 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

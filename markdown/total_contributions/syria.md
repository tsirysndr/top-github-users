...
The `public contributions` and `private contributions` by users in Syria on `2023/8/22 7:51 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

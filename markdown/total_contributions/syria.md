...
The `public contributions` and `private contributions` by users in Syria on `2023/7/20 8:54 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

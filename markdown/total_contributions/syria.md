...
The `public contributions` and `private contributions` by users in Syria on `2023/8/20 3:14 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

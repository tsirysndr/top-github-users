...
The `public contributions` and `private contributions` by users in Syria on `2023/9/17 4:35 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/1/3 6:42 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

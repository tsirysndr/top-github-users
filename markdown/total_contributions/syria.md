...
The `public contributions` and `private contributions` by users in Syria on `2022/11/12 4:26 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/4/16 12:34 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

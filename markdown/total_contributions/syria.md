...
The `public contributions` and `private contributions` by users in Syria on `2023/7/10 2:29 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/2/15 4:02 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.
...
<table>
	...
	<tr>
		<td>345</td>
		<td>
			<a href="https://github.com/Stupidgangsa">
				<img src="https://avatars.githubusercontent.com/u/125271867?s=72&v=4" width="24" alt="Avatar of Stupidgangsa"> Stupidgangsa
			</a><br/>
			crack ganger
		</td>
		<td>Stupid_gang </td>

...
The `public contributions` and `private contributions` by users in Syria on `2023/1/12 4:20 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

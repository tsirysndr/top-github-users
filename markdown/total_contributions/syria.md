...
The `public contributions` and `private contributions` by users in Syria on `2022/12/22 9:29 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/10/18 8:07 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

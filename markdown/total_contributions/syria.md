...
The `public contributions` and `private contributions` by users in Syria on `2023/6/28 5:09 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

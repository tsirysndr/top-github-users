...
The `public contributions` and `private contributions` by users in Syria on `2023/4/10 7:00 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

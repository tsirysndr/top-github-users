...
The `public contributions` and `private contributions` by users in Syria on `2023/2/10 4:17 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

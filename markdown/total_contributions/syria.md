...
The `public contributions` and `private contributions` by users in Syria on `2023/8/1 2:10 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

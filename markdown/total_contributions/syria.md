...
The `public contributions` and `private contributions` by users in Syria on `2023/1/5 9:10 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

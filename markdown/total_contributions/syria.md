...
The `public contributions` and `private contributions` by users in Syria on `2023/9/20 3:36 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/2/23 2:22 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

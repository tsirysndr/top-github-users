...
The `public contributions` and `private contributions` by users in Syria on `2023/4/30 4:46 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

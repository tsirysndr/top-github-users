...
The `public contributions` and `private contributions` by users in Syria on `2023/1/17 9:28 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2022/10/14 8:17 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

...
The `public contributions` and `private contributions` by users in Syria on `2023/10/12 8:04 AM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

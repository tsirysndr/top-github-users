...
The `public contributions` and `private contributions` by users in Syria on `2023/1/13 7:33 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

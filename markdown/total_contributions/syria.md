...
The `public contributions` and `private contributions` by users in Syria on `2023/11/3 6:32 PM UTC`. This list contains users from `Syria` and cities `Damascus` `Aleppo` `Homs` `Latakia`.

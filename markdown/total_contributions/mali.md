...
The `public contributions` and `private contributions` by users in Mali on `2023/11/8 6:18 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/6/8 8:28 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

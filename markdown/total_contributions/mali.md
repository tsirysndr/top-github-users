...
The `public contributions` and `private contributions` by users in Mali on `2022/11/8 2:24 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

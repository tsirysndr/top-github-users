...
The `public contributions` and `private contributions` by users in Mali on `2023/6/4 8:55 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

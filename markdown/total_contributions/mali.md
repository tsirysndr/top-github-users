...
The `public contributions` and `private contributions` by users in Mali on `2023/4/4 3:21 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

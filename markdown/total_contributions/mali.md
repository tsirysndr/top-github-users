...
The `public contributions` and `private contributions` by users in Mali on `2023/7/25 9:12 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

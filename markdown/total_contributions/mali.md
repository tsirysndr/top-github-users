...
The `public contributions` and `private contributions` by users in Mali on `2023/6/22 2:20 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

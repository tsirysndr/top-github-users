...
The `public contributions` and `private contributions` by users in Mali on `2023/6/6 1:39 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

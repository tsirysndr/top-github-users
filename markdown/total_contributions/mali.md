...
The `public contributions` and `private contributions` by users in Mali on `2022/10/11 1:43 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

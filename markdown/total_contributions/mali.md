...
The `public contributions` and `private contributions` by users in Mali on `2022/11/7 7:20 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

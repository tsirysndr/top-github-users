...
The `public contributions` and `private contributions` by users in Mali on `2023/9/17 3:54 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/4/29 12:07 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

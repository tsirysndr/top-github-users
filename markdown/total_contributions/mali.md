...
The `public contributions` and `private contributions` by users in Mali on `2022/10/27 2:07 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

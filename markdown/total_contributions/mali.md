...
The `public contributions` and `private contributions` by users in Mali on `2023/5/19 5:42 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/6/5 2:14 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2022/10/23 5:43 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

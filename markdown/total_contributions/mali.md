...
The `public contributions` and `private contributions` by users in Mali on `2022/12/18 2:34 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/1/11 12:50 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

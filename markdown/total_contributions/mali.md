...
The `public contributions` and `private contributions` by users in Mali on `2023/9/14 6:02 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/11/10 11:42 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/7/5 1:53 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

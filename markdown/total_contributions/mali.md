...
The `public contributions` and `private contributions` by users in Mali on `2023/10/12 2:00 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

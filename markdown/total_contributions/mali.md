...
The `public contributions` and `private contributions` by users in Mali on `2023/2/8 9:27 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

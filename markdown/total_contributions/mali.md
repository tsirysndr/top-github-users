...
The `public contributions` and `private contributions` by users in Mali on `2022/12/7 11:22 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

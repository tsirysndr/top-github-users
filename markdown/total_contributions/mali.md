...
The `public contributions` and `private contributions` by users in Mali on `2023/1/21 3:27 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

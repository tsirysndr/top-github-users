...
The `public contributions` and `private contributions` by users in Mali on `2022/11/15 2:21 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

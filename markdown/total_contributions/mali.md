...
The `public contributions` and `private contributions` by users in Mali on `2023/1/23 9:31 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

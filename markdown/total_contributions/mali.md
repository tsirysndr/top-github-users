...
The `public contributions` and `private contributions` by users in Mali on `2023/8/25 6:48 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

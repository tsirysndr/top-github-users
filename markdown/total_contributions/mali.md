...
The `public contributions` and `private contributions` by users in Mali on `2023/1/31 3:35 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

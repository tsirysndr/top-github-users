...
The `public contributions` and `private contributions` by users in Mali on `2022/10/31 2:40 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

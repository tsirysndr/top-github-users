...
The `public contributions` and `private contributions` by users in Mali on `2022/12/11 11:18 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

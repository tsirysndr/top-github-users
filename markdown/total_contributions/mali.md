...
The `public contributions` and `private contributions` by users in Mali on `2023/1/22 3:29 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/5/17 6:17 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

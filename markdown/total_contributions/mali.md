...
The `public contributions` and `private contributions` by users in Mali on `2023/9/16 5:27 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

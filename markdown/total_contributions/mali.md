...
The `public contributions` and `private contributions` by users in Mali on `2023/7/23 10:49 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

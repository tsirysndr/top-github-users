...
The `public contributions` and `private contributions` by users in Mali on `2023/10/6 7:47 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/8/7 8:15 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/6/23 7:52 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2022/12/23 10:10 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

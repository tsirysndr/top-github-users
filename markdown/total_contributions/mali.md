...
The `public contributions` and `private contributions` by users in Mali on `2022/12/21 12:33 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

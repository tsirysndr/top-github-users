...
The `public contributions` and `private contributions` by users in Mali on `2022/12/6 4:00 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

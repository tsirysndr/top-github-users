...
The `public contributions` and `private contributions` by users in Mali on `2023/1/10 5:09 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/2/24 7:25 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

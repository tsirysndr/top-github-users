...
The `public contributions` and `private contributions` by users in Mali on `2022/11/12 4:40 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/8/28 4:25 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

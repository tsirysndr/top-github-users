...
The `public contributions` and `private contributions` by users in Mali on `2023/9/23 3:50 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

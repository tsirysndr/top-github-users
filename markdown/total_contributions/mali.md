...
The `public contributions` and `private contributions` by users in Mali on `2023/3/29 1:44 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/7/8 7:53 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/10/25 2:00 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/11/25 12:03 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

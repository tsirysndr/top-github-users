...
The `public contributions` and `private contributions` by users in Mali on `2023/6/24 1:55 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/2/10 10:01 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

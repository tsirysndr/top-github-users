...
The `public contributions` and `private contributions` by users in Mali on `2022/10/30 7:18 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

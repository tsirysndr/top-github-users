...
The `public contributions` and `private contributions` by users in Mali on `2023/5/24 6:33 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

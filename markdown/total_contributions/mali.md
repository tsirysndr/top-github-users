...
The `public contributions` and `private contributions` by users in Mali on `2023/11/6 4:16 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

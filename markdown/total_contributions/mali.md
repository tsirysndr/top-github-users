...
The `public contributions` and `private contributions` by users in Mali on `2023/6/20 5:30 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

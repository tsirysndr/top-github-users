...
The `public contributions` and `private contributions` by users in Mali on `2023/7/30 9:58 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2022/12/22 2:54 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

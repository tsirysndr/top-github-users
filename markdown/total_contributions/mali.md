...
The `public contributions` and `private contributions` by users in Mali on `2023/10/30 6:48 PM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

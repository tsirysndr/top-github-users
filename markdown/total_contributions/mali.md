...
The `public contributions` and `private contributions` by users in Mali on `2023/9/30 8:30 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

...
The `public contributions` and `private contributions` by users in Mali on `2023/1/30 3:18 AM UTC`. This list contains users from `Mali` and cities `Bamako` `Timbuktu` `Segou` `Mopti`.

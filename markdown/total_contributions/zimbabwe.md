...
The `public contributions` and `private contributions` by users in Zimbabwe on `2023/6/23 4:05 PM UTC`. This list contains users from `Zimbabwe` and cities `Harare` `Bulawayo`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `944 users`  in Zimbabwe. You need at least `1 followers` to be on this list.

...
The `public contributions` and `private contributions` by users in Ecuador on `2022/10/7 9:45 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

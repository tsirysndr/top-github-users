...
The `public contributions` and `private contributions` by users in Ecuador on `2022/10/21 1:00 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

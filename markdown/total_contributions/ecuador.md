...
The `public contributions` and `private contributions` by users in Ecuador on `2023/9/20 10:36 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

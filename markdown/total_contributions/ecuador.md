...
The `public contributions` and `private contributions` by users in Ecuador on `2022/12/8 1:47 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` and `private contributions` by users in Ecuador on `2023/11/18 11:41 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

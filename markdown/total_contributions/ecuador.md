...
The `public contributions` and `private contributions` by users in Ecuador on `2023/9/7 10:20 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

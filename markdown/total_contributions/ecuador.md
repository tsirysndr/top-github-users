...
The `public contributions` and `private contributions` by users in Ecuador on `2023/1/14 5:26 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

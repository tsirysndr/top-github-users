...
The `public contributions` and `private contributions` by users in Ecuador on `2023/5/19 6:41 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

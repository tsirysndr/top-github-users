...
The `public contributions` and `private contributions` by users in Ecuador on `2022/11/10 9:56 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` and `private contributions` by users in Ecuador on `2023/5/8 3:35 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` and `private contributions` by users in Ecuador on `2023/2/2 4:26 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` and `private contributions` by users in Ecuador on `2022/11/6 7:07 PM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

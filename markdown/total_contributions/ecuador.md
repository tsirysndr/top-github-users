...
The `public contributions` and `private contributions` by users in Ecuador on `2023/6/17 10:56 AM UTC`. This list contains users from `Ecuador` and cities `Quito` `Guayaquil` `Cuenca` `Ambato` `Manta`.

...
The `public contributions` and `private contributions` by users in Albania on `2023/10/20 5:05 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/BTabaku">
				<img src="https://avatars.githubusercontent.com/u/48714734?s=72&u=a759481b02b8a8b69b1177bae13c1aaf02898a3b&v=4" width="24" alt="Avatar of BTabaku"> BTabaku
			</a><br/>
			Baft Tabaku
		</td>
		<td>Lufthansa Industry Solutions </td>

...
The `public contributions` and `private contributions` by users in Albania on `2023/4/26 10:45 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

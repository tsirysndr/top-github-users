...
The `public contributions` and `private contributions` by users in Albania on `2022/11/17 1:31 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

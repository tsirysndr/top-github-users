...
The `public contributions` and `private contributions` by users in Albania on `2023/8/18 7:01 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

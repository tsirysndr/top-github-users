...
The `public contributions` and `private contributions` by users in Albania on `2023/6/7 3:33 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.
...
<table>
	...
	<tr>
		<td>332</td>
		<td>
			<a href="https://github.com/enxhiabazi">
				<img src="https://avatars.githubusercontent.com/u/25501189?s=72&v=4" width="24" alt="Avatar of enxhiabazi"> enxhiabazi
			</a><br/>
			Enxhi Abazi
		</td>
		<td>No Company</td>

...
The `public contributions` and `private contributions` by users in Albania on `2023/11/16 7:23 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

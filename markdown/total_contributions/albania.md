...
The `public contributions` and `private contributions` by users in Albania on `2023/7/4 4:40 PM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

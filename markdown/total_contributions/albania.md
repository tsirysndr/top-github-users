...
The `public contributions` and `private contributions` by users in Albania on `2023/7/22 4:08 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

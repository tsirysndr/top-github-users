...
The `public contributions` and `private contributions` by users in Albania on `2023/2/4 12:15 AM UTC`. This list contains users from `Albania` and cities `Tirana` `Durrës` `Vlorë` `Elbasan` `Shkodër` `Kamëz` `Fier` `Korçë`.

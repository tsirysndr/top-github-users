...
The `public contributions` and `private contributions` by users in Colombia on `2022/11/26 12:07 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

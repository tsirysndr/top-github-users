...
The `public contributions` and `private contributions` by users in Colombia on `2022/10/18 11:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` and `private contributions` by users in Colombia on `2023/4/1 5:06 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

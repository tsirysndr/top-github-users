...
The `public contributions` and `private contributions` by users in Colombia on `2023/4/5 3:20 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` and `private contributions` by users in Colombia on `2023/7/11 2:40 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

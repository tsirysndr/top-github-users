...
The `public contributions` and `private contributions` by users in Colombia on `2023/2/25 7:23 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` and `private contributions` by users in Colombia on `2023/10/7 1:59 PM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` and `private contributions` by users in Colombia on `2023/4/22 2:10 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

...
The `public contributions` and `private contributions` by users in Colombia on `2023/8/1 7:58 AM UTC`. This list contains users from `Colombia` and cities `Bogotá` `Medellín` `Cali` `Cartagena` `Barranquilla`.

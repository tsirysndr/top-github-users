...
The `public contributions` and `private contributions` by users in Afghanistan on `2023/9/29 10:59 PM UTC`. This list contains users from `Afghanistan` and cities `Kabul` `Kandahar` `Herat` `Kunduz` `Lashkargah` `Ghazni` `Khost` `Zaranj`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `911 users`  in Afghanistan. You need at least `0 followers` to be on this list.

...
The `public contributions` and `private contributions` by users in Nigeria on `2023/4/14 9:09 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

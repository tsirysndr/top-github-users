...
The `public contributions` and `private contributions` by users in Nigeria on `2022/12/28 6:00 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

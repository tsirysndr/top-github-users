...
The `public contributions` and `private contributions` by users in Nigeria on `2023/1/16 2:30 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

...
The `public contributions` and `private contributions` by users in Nigeria on `2023/8/8 3:41 AM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

...
The `public contributions` and `private contributions` by users in Nigeria on `2022/12/6 6:09 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

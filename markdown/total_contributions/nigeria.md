...
The `public contributions` and `private contributions` by users in Nigeria on `2023/3/18 9:44 PM UTC`. This list contains users from `Nigeria` and cities `Lagos` `Ibadan` `Abuja` `Port-harcourt` `Benin-city` `Ilorin` `Kano`.

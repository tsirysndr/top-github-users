...
The `public contributions` and `private contributions` by users in Nicaragua on `2023/2/19 9:51 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

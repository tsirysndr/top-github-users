...
The `public contributions` and `private contributions` by users in Nicaragua on `2022/11/30 7:48 AM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

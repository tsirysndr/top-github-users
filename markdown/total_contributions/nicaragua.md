...
The `public contributions` and `private contributions` by users in Nicaragua on `2022/11/24 5:48 PM UTC`. This list contains users from `Nicaragua` and cities `Managua` `Leon` `Granada` `Masaya` `Esteli`.

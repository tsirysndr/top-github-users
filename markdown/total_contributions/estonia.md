...
The `public contributions` and `private contributions` by users in Estonia on `2022/11/2 7:54 PM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

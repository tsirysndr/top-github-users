...
The `public contributions` and `private contributions` by users in Estonia on `2023/2/4 5:12 AM UTC`. This list contains users from `Estonia` and cities `Tallinn` `Tartu` `Pärnu` `Narva` `Kohtla-järve`.

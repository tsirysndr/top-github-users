...
The `public contributions` and `private contributions` by users in Iceland on `2022/11/17 8:38 AM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.

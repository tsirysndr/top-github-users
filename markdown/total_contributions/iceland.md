...
The `public contributions` and `private contributions` by users in Iceland on `2023/7/29 2:23 PM UTC`. This list contains users from `Iceland` and cities `Reykjavík` `Hafnarfjordur` `Kópavogur` `Reykjanesbær` `Akureyri`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/daniel-bergmann">
				<img src="https://avatars.githubusercontent.com/u/61001914?s=72&v=4" width="24" alt="Avatar of daniel-bergmann"> daniel-bergmann
			</a><br/>
			Daniel Bergmann
		</td>
		<td>No Company</td>

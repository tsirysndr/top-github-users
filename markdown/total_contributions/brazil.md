...
The `public contributions` and `private contributions` by users in Brazil on `2023/8/7 1:08 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `965 users`  in Brazil. You need at least `207 followers` to be on this list.

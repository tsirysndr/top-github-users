...
The `public contributions` and `private contributions` by users in Brazil on `2023/8/2 12:01 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `964 users`  in Brazil. You need at least `203 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/AnaGaunaDev">
				<img src="https://avatars.githubusercontent.com/u/11474885?s=72&u=beb0812682b891235d18f73f3f29f47f9b671142&v=4" width="24" alt="Avatar of AnaGaunaDev"> AnaGaunaDev
			</a><br/>
			Ana Mercedes Gauna
		</td>

...
The `public contributions` and `private contributions` by users in Brazil on `2023/9/15 10:19 PM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/elidianaandrade">
				<img src="https://avatars.githubusercontent.com/u/97471199?s=72&u=815768cf1d54a20bfb785aecfa06b13757a7923f&v=4" width="24" alt="Avatar of elidianaandrade"> elidianaandrade
			</a><br/>
			Elidiana Andrade
		</td>
		<td>No Company</td>

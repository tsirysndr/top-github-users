...
The `public contributions` and `private contributions` by users in Brazil on `2023/8/9 5:43 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/F3lip32010">
				<img src="https://avatars.githubusercontent.com/u/78237060?s=72&v=4" width="24" alt="Avatar of F3lip32010"> F3lip32010
			</a><br/>
			Felipe Meireles
		</td>
		<td>No Company</td>

...
The `public contributions` and `private contributions` by users in Brazil on `2023/11/12 4:11 AM UTC`. This list contains users from `Brazil` and cities `Rio-de-janeiro` `São-paulo` `Manaus` `Brasilia` `Fortaleza` `Belém` `Goiânia` `Belo-horizonte` `Curitiba`.
...
<table>
	...
	<tr>
		...
		<td>Tabula </td>
		<td><a href="https://twitter.com/_ordepp">_ordepp</a></td>
		<td>São Paulo</td>
		<td>607</td>
		<td>614</td>
	</tr>

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/2/6 9:24 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

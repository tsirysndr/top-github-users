...
The `public contributions` and `private contributions` by users in Ukraine on `2023/2/20 8:49 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/6/13 12:32 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/audiowaves">
				<img src="https://avatars.githubusercontent.com/u/2100323?s=72&u=0ec3fb3cd00f3bd751d1bdabbfc449af8f6db120&v=4" width="24" alt="Avatar of audiowaves"> audiowaves
			</a><br/>
			Oleh Chaplia
		</td>
		<td>Eleks </td>

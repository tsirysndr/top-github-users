...
The `public contributions` and `private contributions` by users in Ukraine on `2023/4/17 12:31 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2022/10/7 2:50 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/6/28 5:59 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

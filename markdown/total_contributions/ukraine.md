...
The `public contributions` and `private contributions` by users in Ukraine on `2023/6/15 5:51 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/4/13 2:10 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/5/2 10:23 AM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

...
The `public contributions` and `private contributions` by users in Ukraine on `2023/8/2 1:53 PM UTC`. This list contains users from `Ukraine` and cities `Kyiv` `Lviv` `Kharkiv` `Odesa`.

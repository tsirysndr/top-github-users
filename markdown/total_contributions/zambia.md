...
The `public contributions` and `private contributions` by users in Zambia on `2022/12/22 4:16 AM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.

...
The `public contributions` and `private contributions` by users in Zambia on `2022/10/17 9:49 PM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.

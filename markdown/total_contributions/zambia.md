...
The `public contributions` and `private contributions` by users in Zambia on `2022/12/15 6:47 PM UTC`. This list contains users from `Zambia` and cities ` Lusaka`.

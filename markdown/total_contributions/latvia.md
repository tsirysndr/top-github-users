...
The `public contributions` and `private contributions` by users in Latvia on `2023/5/13 3:44 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

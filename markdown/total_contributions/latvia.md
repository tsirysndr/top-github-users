...
The `public contributions` and `private contributions` by users in Latvia on `2023/2/25 12:27 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

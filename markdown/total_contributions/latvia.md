...
The `public contributions` and `private contributions` by users in Latvia on `2022/11/19 8:35 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

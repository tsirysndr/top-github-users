...
The `public contributions` and `private contributions` by users in Latvia on `2023/8/27 9:58 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

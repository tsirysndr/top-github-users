...
The `public contributions` and `private contributions` by users in Latvia on `2023/5/27 10:01 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

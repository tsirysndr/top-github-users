...
The `public contributions` and `private contributions` by users in Latvia on `2022/10/6 11:00 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

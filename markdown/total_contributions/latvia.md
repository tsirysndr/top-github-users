...
The `public contributions` and `private contributions` by users in Latvia on `2022/11/23 12:59 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

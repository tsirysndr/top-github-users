...
The `public contributions` and `private contributions` by users in Latvia on `2022/12/29 5:18 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

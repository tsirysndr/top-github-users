...
The `public contributions` and `private contributions` by users in Latvia on `2023/9/13 11:14 PM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

...
The `public contributions` and `private contributions` by users in Latvia on `2022/12/4 4:58 AM UTC`. This list contains users from `Latvia` and cities `Riga` `Daugavpils` `Liepāja` `Jūrmala` `Ventspils` `Jelgava` `Cēsis`.

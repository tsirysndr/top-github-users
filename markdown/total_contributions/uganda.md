...
The `public contributions` and `private contributions` by users in Uganda on `2023/2/14 10:29 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.

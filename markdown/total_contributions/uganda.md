...
The `public contributions` and `private contributions` by users in Uganda on `2023/5/14 5:52 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.

...
The `public contributions` and `private contributions` by users in Uganda on `2023/9/11 7:13 AM UTC`. This list contains users from `Uganda` and cities `Kampala`.

...
The `public contributions` and `private contributions` by users in Taiwan on `2023/9/9 8:20 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

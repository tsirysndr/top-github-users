...
The `public contributions` and `private contributions` by users in Taiwan on `2022/12/2 9:02 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` and `private contributions` by users in Taiwan on `2023/9/13 12:03 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` and `private contributions` by users in Taiwan on `2022/12/30 6:39 AM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

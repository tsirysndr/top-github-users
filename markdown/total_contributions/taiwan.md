...
The `public contributions` and `private contributions` by users in Taiwan on `2022/12/21 1:03 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

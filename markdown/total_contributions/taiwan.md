...
The `public contributions` and `private contributions` by users in Taiwan on `2023/5/13 3:50 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

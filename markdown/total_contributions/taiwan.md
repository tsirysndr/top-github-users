...
The `public contributions` and `private contributions` by users in Taiwan on `2022/12/16 6:01 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

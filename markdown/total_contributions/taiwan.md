...
The `public contributions` and `private contributions` by users in Taiwan on `2023/9/11 12:19 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

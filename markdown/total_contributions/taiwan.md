...
The `public contributions` and `private contributions` by users in Taiwan on `2023/7/5 1:47 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

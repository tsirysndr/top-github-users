...
The `public contributions` and `private contributions` by users in Taiwan on `2023/6/12 11:41 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

...
The `public contributions` and `private contributions` by users in Taiwan on `2022/10/20 4:02 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

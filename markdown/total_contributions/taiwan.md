...
The `public contributions` and `private contributions` by users in Taiwan on `2023/2/11 3:47 PM UTC`. This list contains users from `Taiwan` and cities `Taipei` `Kaohsiung` `Tainan` `Taichung `.

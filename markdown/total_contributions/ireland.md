...
The `public contributions` and `private contributions` by users in Ireland on `2023/7/7 11:27 PM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LajosNeto">
				<img src="https://avatars.githubusercontent.com/u/19560506?s=72&u=7d76cf4ef49cc8a5cbd1e9e09ff98a043ee77bbd&v=4" width="24" alt="Avatar of LajosNeto"> LajosNeto
			</a><br/>
			Lajos Neto
		</td>
		<td>Squarespace </td>

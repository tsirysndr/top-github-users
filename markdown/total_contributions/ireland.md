...
The `public contributions` and `private contributions` by users in Ireland on `2023/6/26 5:41 AM UTC`. This list contains users from `Ireland` and cities `Dublin` `Galway` `Cork` `Waterford` `Limerick`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/splatterxl">
				<img src="https://avatars.githubusercontent.com/u/67709748?s=72&u=2c963fac7cfdfe4fe4e89adcd1183d96727ea222&v=4" width="24" alt="Avatar of splatterxl"> splatterxl
			</a><br/>
			Ruairi
		</td>
		<td>No Company</td>

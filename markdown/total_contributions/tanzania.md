...
The `public contributions` and `private contributions` by users in Tanzania on `2023/7/5 8:04 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

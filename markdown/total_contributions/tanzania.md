...
The `public contributions` and `private contributions` by users in Tanzania on `2023/9/17 4:42 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

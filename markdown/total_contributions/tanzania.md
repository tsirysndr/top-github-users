...
The `public contributions` and `private contributions` by users in Tanzania on `2023/7/3 8:56 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `public contributions` and `private contributions` by users in Tanzania on `2023/7/27 2:06 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

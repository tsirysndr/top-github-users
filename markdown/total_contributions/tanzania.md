...
The `public contributions` and `private contributions` by users in Tanzania on `2023/7/19 11:40 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

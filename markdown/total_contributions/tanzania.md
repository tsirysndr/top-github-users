...
The `public contributions` and `private contributions` by users in Tanzania on `2023/10/26 2:16 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `public contributions` and `private contributions` by users in Tanzania on `2023/9/29 8:55 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

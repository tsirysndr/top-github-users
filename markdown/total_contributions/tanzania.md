...
The `public contributions` and `private contributions` by users in Tanzania on `2023/10/19 8:51 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

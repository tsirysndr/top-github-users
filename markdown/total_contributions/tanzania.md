...
The `public contributions` and `private contributions` by users in Tanzania on `2023/11/6 10:21 PM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

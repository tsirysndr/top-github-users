...
The `public contributions` and `private contributions` by users in Tanzania on `2023/8/26 12:46 AM UTC`. This list contains users from `Tanzania` and cities `Dar-es-salaam` `Mwanza` `Dodoma` `Mbeya`.

...
The `public contributions` and `private contributions` by users in Jordan on `2023/9/4 11:49 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

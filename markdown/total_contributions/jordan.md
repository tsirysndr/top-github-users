...
The `public contributions` and `private contributions` by users in Jordan on `2023/2/22 12:29 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

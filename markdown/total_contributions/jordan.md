...
The `public contributions` and `private contributions` by users in Jordan on `2022/11/4 1:19 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

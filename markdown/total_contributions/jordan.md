...
The `public contributions` and `private contributions` by users in Jordan on `2023/4/26 12:58 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

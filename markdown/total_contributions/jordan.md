...
The `public contributions` and `private contributions` by users in Jordan on `2022/10/13 2:32 AM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` and `private contributions` by users in Jordan on `2023/8/3 4:39 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

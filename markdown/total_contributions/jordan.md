...
The `public contributions` and `private contributions` by users in Jordan on `2022/10/23 4:14 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

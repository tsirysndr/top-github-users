...
The `public contributions` and `private contributions` by users in Jordan on `2023/3/20 11:52 PM UTC`. This list contains users from `Jordan` and cities `Amman` `Aqaba` `Zarqa` `Mafraq` `Jerash` `Irbid`.

...
The `public contributions` and `private contributions` by users in Finland on `2023/10/7 3:44 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

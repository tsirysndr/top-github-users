...
The `public contributions` and `private contributions` by users in Finland on `2023/8/2 2:58 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `968 users`  in Finland. You need at least `36 followers` to be on this list.

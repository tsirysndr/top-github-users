...
The `public contributions` and `private contributions` by users in Finland on `2023/5/18 7:50 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

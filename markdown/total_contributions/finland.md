...
The `public contributions` and `private contributions` by users in Finland on `2022/12/4 8:39 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

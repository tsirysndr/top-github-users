...
The `public contributions` and `private contributions` by users in Finland on `2023/1/22 11:15 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

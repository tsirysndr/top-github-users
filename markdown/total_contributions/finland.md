...
The `public contributions` and `private contributions` by users in Finland on `2023/5/24 8:27 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

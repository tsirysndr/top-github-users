...
The `public contributions` and `private contributions` by users in Finland on `2022/10/31 10:28 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

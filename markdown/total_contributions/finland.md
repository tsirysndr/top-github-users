...
The `public contributions` and `private contributions` by users in Finland on `2022/11/26 8:47 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

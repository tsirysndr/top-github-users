...
The `public contributions` and `private contributions` by users in Finland on `2023/7/30 6:05 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `966 users`  in Finland. You need at least `34 followers` to be on this list.
...
<table>
	...
	<tr>
		...
		<td>Digious By Innokas Medical<br/></td>
		<td>No Twitter Username</td>
		<td>Helsinki</td>
		<td>10</td>
		<td>10</td>

...
The `public contributions` and `private contributions` by users in Finland on `2023/10/13 10:27 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `957 users`  in Finland. You need at least `37 followers` to be on this list.

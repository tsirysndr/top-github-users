...
The `public contributions` and `private contributions` by users in Finland on `2023/6/10 9:12 PM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

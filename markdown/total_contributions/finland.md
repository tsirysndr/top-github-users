...
The `public contributions` and `private contributions` by users in Finland on `2022/12/14 11:00 AM UTC`. This list contains users from `Finland` and cities `Helsinki` `Tampere` `Oulu` `Espoo` `Vantaa`.

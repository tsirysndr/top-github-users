...
The `public contributions` and `private contributions` by users in Iraq on `2022/10/25 9:34 PM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

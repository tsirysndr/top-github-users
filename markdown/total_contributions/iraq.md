...
The `public contributions` and `private contributions` by users in Iraq on `2023/7/22 10:48 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

...
The `public contributions` and `private contributions` by users in Iraq on `2022/10/6 9:35 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

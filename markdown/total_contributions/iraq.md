...
The `public contributions` and `private contributions` by users in Iraq on `2023/9/3 11:58 AM UTC`. This list contains users from `Iraq` and cities `Baghdad` `Mosul` `Basra` `Erbil` `Najaf`.

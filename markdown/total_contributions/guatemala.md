...
The `public contributions` and `private contributions` by users in Guatemala on `2022/10/27 10:30 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

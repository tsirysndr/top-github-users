...
The `public contributions` and `private contributions` by users in Guatemala on `2023/4/2 6:29 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

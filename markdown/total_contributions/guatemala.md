...
The `public contributions` and `private contributions` by users in Guatemala on `2023/8/8 4:11 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

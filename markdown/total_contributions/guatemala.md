...
The `public contributions` and `private contributions` by users in Guatemala on `2023/7/10 11:28 PM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/destrada-2018259">
				<img src="https://avatars.githubusercontent.com/u/106627911?s=72&v=4" width="24" alt="Avatar of destrada-2018259"> destrada-2018259
			</a><br/>
			Daniel Rojo
		</td>

...
The `public contributions` and `private contributions` by users in Guatemala on `2023/6/16 1:26 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

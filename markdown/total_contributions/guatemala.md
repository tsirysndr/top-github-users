...
The `public contributions` and `private contributions` by users in Guatemala on `2023/9/4 4:15 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

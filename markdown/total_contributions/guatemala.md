...
The `public contributions` and `private contributions` by users in Guatemala on `2022/12/20 1:58 AM UTC`. This list contains users from `Guatemala` and cities `Guatemala-city` `Antigua-guatemala` `Quetzaltenango` `Chichicastenango` `Villa-nueva` `Totonicapán`.

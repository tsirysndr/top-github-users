...
The `public contributions` and `private contributions` by users in Paraguay on `2022/11/4 5:49 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.

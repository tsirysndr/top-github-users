...
The `public contributions` and `private contributions` by users in Paraguay on `2023/1/19 8:33 AM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.

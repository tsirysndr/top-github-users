...
The `public contributions` and `private contributions` by users in Paraguay on `2022/12/29 2:00 AM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.

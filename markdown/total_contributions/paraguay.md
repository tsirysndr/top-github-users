...
The `public contributions` and `private contributions` by users in Paraguay on `2022/11/27 10:52 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.

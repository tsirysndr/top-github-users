...
The `public contributions` and `private contributions` by users in Paraguay on `2023/7/11 11:36 PM UTC`. This list contains users from `Paraguay` and cities `Asunción ` `Ciudad-del-este` `Encarnacion` `Luque-paraguay`.

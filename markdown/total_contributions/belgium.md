...
The `public contributions` and `private contributions` by users in Belgium on `2023/11/2 10:39 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

...
The `public contributions` and `private contributions` by users in Belgium on `2023/8/10 3:37 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nouraellm">
				<img src="https://avatars.githubusercontent.com/u/26191219?s=72&u=45060e156781a6ab682615d58d8427395f323a4c&v=4" width="24" alt="Avatar of nouraellm"> nouraellm
			</a><br/>
			Noura
		</td>
		<td>@odoo </td>

...
The `public contributions` and `private contributions` by users in Belgium on `2023/9/9 6:30 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>@siine-project @databrainsdz @sapayio </td>
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Namenega">
				<img src="https://avatars.githubusercontent.com/u/57675135?s=72&u=34225fb1be1c154715ae5dc5eebece54535eaf77&v=4" width="24" alt="Avatar of Namenega"> Namenega
			</a><br/>
			Pyg Argus
		</td>
		<td>No Company</td>

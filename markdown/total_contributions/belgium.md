...
The `public contributions` and `private contributions` by users in Belgium on `2023/8/29 8:35 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>457</td>
		<td>
			<a href="https://github.com/laudeco">
				<img src="https://avatars.githubusercontent.com/u/3658458?s=72&v=4" width="24" alt="Avatar of laudeco"> laudeco
			</a><br/>
			De Coninck Laurent
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Han-sur-Lesse (Belgium)</td>
		<td>8</td>
		<td>238</td>
	</tr>
	<tr>

...
The `public contributions` and `private contributions` by users in Belgium on `2023/10/23 5:34 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		<td>242</td>
		<td>
			<a href="https://github.com/petermorlion">
				<img src="https://avatars.githubusercontent.com/u/3483719?s=72&v=4" width="24" alt="Avatar of petermorlion"> petermorlion
			</a><br/>
			Peter Morlion
		</td>
		<td>Red Star It </td>
		<td><a href="https://twitter.com/petermorlion">petermorlion</a></td>

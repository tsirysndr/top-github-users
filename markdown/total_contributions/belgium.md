...
The `public contributions` and `private contributions` by users in Belgium on `2023/10/9 6:04 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/futtta">
				<img src="https://avatars.githubusercontent.com/u/181297?s=72&u=60770ee290f8bc14ff14615ea40add57f8354a7f&v=4" width="24" alt="Avatar of futtta"> futtta
			</a><br/>
			frank goossens
		</td>

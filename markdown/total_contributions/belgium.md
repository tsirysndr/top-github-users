...
The `public contributions` and `private contributions` by users in Belgium on `2023/8/7 6:05 PM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.

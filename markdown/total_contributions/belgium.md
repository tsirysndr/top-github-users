...
The `public contributions` and `private contributions` by users in Belgium on `2023/9/12 4:12 AM UTC`. This list contains users from `Belgium` and cities `Antwerp` `Brussels` `Ghent` `Bruges` `Leuven` `Liège` `Namur`.
...
<table>
	...
	<tr>
		...
		<td>Masivotech Bv </td>
		<td><a href="https://twitter.com/bitcelium">bitcelium</a></td>

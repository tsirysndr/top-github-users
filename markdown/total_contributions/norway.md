...
The `public contributions` and `private contributions` by users in Norway on `2023/10/13 5:09 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

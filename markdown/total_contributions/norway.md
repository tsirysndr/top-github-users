...
The `public contributions` and `private contributions` by users in Norway on `2023/3/20 8:59 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

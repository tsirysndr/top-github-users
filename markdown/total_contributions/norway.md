...
The `public contributions` and `private contributions` by users in Norway on `2023/4/30 1:06 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

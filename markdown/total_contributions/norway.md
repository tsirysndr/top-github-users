...
The `public contributions` and `private contributions` by users in Norway on `2022/11/11 5:36 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

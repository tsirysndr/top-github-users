...
The `public contributions` and `private contributions` by users in Norway on `2023/8/7 10:26 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

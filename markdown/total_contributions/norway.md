...
The `public contributions` and `private contributions` by users in Norway on `2023/11/28 3:23 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/4/13 3:25 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

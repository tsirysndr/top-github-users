...
The `public contributions` and `private contributions` by users in Norway on `2022/10/18 12:02 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

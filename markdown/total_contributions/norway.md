...
The `public contributions` and `private contributions` by users in Norway on `2023/2/15 12:13 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/9/25 4:54 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/10/23 9:33 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/10/5 3:57 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

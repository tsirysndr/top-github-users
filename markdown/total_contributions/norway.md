...
The `public contributions` and `private contributions` by users in Norway on `2023/8/19 6:27 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

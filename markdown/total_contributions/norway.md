...
The `public contributions` and `private contributions` by users in Norway on `2023/5/31 4:09 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

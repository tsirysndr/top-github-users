...
The `public contributions` and `private contributions` by users in Norway on `2023/6/12 2:05 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

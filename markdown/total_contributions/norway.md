...
The `public contributions` and `private contributions` by users in Norway on `2022/12/18 4:52 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

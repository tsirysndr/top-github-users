...
The `public contributions` and `private contributions` by users in Norway on `2023/11/20 5:35 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/3/2 4:39 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

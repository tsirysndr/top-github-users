...
The `public contributions` and `private contributions` by users in Norway on `2023/5/28 6:06 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

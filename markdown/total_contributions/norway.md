...
The `public contributions` and `private contributions` by users in Norway on `2023/9/23 12:42 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

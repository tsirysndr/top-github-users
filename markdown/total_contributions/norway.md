...
The `public contributions` and `private contributions` by users in Norway on `2023/2/27 9:33 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

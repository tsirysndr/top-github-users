...
The `public contributions` and `private contributions` by users in Norway on `2023/3/22 4:02 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

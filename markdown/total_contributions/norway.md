...
The `public contributions` and `private contributions` by users in Norway on `2022/12/26 4:24 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

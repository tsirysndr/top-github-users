...
The `public contributions` and `private contributions` by users in Norway on `2023/9/14 8:16 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

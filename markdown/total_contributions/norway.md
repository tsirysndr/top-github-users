...
The `public contributions` and `private contributions` by users in Norway on `2023/2/19 4:47 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

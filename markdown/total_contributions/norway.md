...
The `public contributions` and `private contributions` by users in Norway on `2023/7/16 9:44 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

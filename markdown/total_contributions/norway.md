...
The `public contributions` and `private contributions` by users in Norway on `2023/7/7 9:49 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/11/27 9:27 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2022/10/6 2:10 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

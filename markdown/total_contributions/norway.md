...
The `public contributions` and `private contributions` by users in Norway on `2022/11/22 9:13 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/6/2 3:33 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/1/28 12:46 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

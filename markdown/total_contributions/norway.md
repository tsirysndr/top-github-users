...
The `public contributions` and `private contributions` by users in Norway on `2023/6/17 12:32 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

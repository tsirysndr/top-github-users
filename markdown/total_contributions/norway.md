...
The `public contributions` and `private contributions` by users in Norway on `2023/9/8 5:10 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

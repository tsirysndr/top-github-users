...
The `public contributions` and `private contributions` by users in Norway on `2022/12/5 4:00 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

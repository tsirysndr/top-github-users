...
The `public contributions` and `private contributions` by users in Norway on `2023/5/6 11:53 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

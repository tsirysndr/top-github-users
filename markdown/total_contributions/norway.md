...
The `public contributions` and `private contributions` by users in Norway on `2023/5/16 5:59 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

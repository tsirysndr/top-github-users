...
The `public contributions` and `private contributions` by users in Norway on `2023/9/4 9:42 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

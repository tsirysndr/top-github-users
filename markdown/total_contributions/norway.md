...
The `public contributions` and `private contributions` by users in Norway on `2022/12/20 7:55 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

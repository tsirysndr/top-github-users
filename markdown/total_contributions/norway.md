...
The `public contributions` and `private contributions` by users in Norway on `2023/11/19 12:05 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

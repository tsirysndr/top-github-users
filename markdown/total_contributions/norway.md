...
The `public contributions` and `private contributions` by users in Norway on `2022/11/16 6:47 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/1/21 11:43 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

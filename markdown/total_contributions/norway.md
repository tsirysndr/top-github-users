...
The `public contributions` and `private contributions` by users in Norway on `2023/10/15 4:38 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

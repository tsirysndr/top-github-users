...
The `public contributions` and `private contributions` by users in Norway on `2023/8/17 7:32 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

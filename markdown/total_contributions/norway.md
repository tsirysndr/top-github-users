...
The `public contributions` and `private contributions` by users in Norway on `2023/8/20 4:39 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

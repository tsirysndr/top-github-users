...
The `public contributions` and `private contributions` by users in Norway on `2023/9/11 8:36 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

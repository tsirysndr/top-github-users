...
The `public contributions` and `private contributions` by users in Norway on `2023/4/26 4:30 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2022/11/27 3:21 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

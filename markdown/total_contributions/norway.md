...
The `public contributions` and `private contributions` by users in Norway on `2023/11/17 7:09 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

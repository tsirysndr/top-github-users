...
The `public contributions` and `private contributions` by users in Norway on `2022/12/21 10:04 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

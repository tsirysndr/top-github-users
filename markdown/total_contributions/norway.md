...
The `public contributions` and `private contributions` by users in Norway on `2023/3/30 7:12 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

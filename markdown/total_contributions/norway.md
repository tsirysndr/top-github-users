...
The `public contributions` and `private contributions` by users in Norway on `2023/1/12 12:14 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

...
The `public contributions` and `private contributions` by users in Norway on `2023/11/26 7:32 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

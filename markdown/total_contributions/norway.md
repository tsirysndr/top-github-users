...
The `public contributions` and `private contributions` by users in Norway on `2023/11/29 4:54 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

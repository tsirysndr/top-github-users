...
The `public contributions` and `private contributions` by users in Norway on `2022/10/21 12:50 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

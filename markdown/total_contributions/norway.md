...
The `public contributions` and `private contributions` by users in Norway on `2022/11/8 4:49 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

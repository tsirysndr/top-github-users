...
The `public contributions` and `private contributions` by users in Norway on `2023/11/15 12:58 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

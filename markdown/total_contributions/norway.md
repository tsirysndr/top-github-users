...
The `public contributions` and `private contributions` by users in Norway on `2023/4/23 3:44 AM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

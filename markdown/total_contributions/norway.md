...
The `public contributions` and `private contributions` by users in Norway on `2023/7/1 6:21 PM UTC`. This list contains users from `Norway` and cities `Oslo` `Bergen` `Trondheim` `Stavanger`.

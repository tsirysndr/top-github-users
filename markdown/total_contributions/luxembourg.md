...
The `public contributions` and `private contributions` by users in Luxembourg on `2022/11/12 4:09 PM UTC`. This list contains users from `Luxembourg` and cities`Luxembourg` and cities `Echternach` `Esch-sur-alzette` `Pétange`.

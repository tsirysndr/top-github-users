...
The `public contributions` and `private contributions` by users in Benin on `2022/12/16 4:12 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

...
The `public contributions` and `private contributions` by users in Benin on `2022/10/12 7:35 PM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

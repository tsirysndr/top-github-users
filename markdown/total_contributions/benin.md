...
The `public contributions` and `private contributions` by users in Benin on `2023/5/23 5:00 AM UTC`. This list contains users from `Benin` and cities `Cotonou` `Porto-novo` `Parakou` `Kandi` `Abomey-calavi`.

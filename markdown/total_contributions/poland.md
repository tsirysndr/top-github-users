...
The `public contributions` and `private contributions` by users in Poland on `2022/11/29 1:59 PM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` and `private contributions` by users in Poland on `2023/6/13 8:56 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

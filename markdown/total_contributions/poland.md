...
The `public contributions` and `private contributions` by users in Poland on `2022/11/30 9:13 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

...
The `public contributions` and `private contributions` by users in Poland on `2023/11/30 11:57 AM UTC`. This list contains users from `Poland` and cities `Warsaw` `Kraków` `Wrocław` `Gdańsk` `Poznań`.

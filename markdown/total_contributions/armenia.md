...
The `public contributions` and `private contributions` by users in Armenia on `2023/6/4 5:32 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

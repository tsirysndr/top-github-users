...
The `public contributions` and `private contributions` by users in Armenia on `2023/6/17 7:03 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

...
The `public contributions` and `private contributions` by users in Armenia on `2023/2/6 5:05 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

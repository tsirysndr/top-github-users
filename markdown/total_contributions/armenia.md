...
The `public contributions` and `private contributions` by users in Armenia on `2022/11/25 8:58 PM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

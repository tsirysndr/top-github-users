...
The `public contributions` and `private contributions` by users in Armenia on `2023/7/27 4:47 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

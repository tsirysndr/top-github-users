...
The `public contributions` and `private contributions` by users in Armenia on `2023/11/7 1:07 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

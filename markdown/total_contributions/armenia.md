...
The `public contributions` and `private contributions` by users in Armenia on `2023/4/9 10:42 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

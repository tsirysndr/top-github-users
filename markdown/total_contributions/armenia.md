...
The `public contributions` and `private contributions` by users in Armenia on `2022/12/11 1:52 AM UTC`. This list contains users from `Armenia` and cities `Yerevan` `Gyumri` `Vanadzor` `Vagharshapat` `Abovyan `.

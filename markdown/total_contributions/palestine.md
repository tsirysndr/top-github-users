...
The `public contributions` and `private contributions` by users in Palestine on `2023/8/14 10:21 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

...
The `public contributions` and `private contributions` by users in Palestine on `2023/11/2 3:16 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

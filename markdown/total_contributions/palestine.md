...
The `public contributions` and `private contributions` by users in Palestine on `2023/10/18 4:42 AM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

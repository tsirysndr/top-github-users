...
The `public contributions` and `private contributions` by users in Palestine on `2023/9/12 2:49 PM UTC`. This list contains users from `Palestine` and cities `Gaza` `Khan-yunis` `Jabalia ` `Hebron` `Nablus`.

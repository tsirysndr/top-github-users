...
The `public contributions` and `private contributions` by users in Philippines on `2023/9/8 6:04 AM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
...
<table>
	...
	<tr>
		...
		<td>University Of San Carlos<br/></td>

...
The `public contributions` and `private contributions` by users in Philippines on `2023/9/14 9:11 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

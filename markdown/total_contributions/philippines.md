...
The `public contributions` and `private contributions` by users in Philippines on `2022/10/31 6:03 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

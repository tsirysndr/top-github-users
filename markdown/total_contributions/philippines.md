...
The `public contributions` and `private contributions` by users in Philippines on `2023/7/8 11:03 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

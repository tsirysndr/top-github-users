...
The `public contributions` and `private contributions` by users in Philippines on `2023/10/24 10:57 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.

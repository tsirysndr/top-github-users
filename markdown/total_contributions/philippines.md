...
The `public contributions` and `private contributions` by users in Philippines on `2023/9/20 6:47 PM UTC`. This list contains users from `Philippines` and cities `Manila` `Quezon-city` `Davao-city` `Cebu-city` `Makati` `Baguio`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/nolikecode">
				<img src="https://avatars.githubusercontent.com/u/51563020?s=72&u=ed47385c31eb75476cea53cc7919ba1509623241&v=4" width="24" alt="Avatar of nolikecode"> nolikecode
			</a><br/>
			llinz
		</td>
		<td>No Company</td>

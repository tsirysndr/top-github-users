...
The `public contributions` and `private contributions` by users in Spain on `2023/8/3 5:42 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` and `private contributions` by users in Spain on `2023/4/22 1:19 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

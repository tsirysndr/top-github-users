...
The `public contributions` and `private contributions` by users in Spain on `2023/2/2 8:26 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` and `private contributions` by users in Spain on `2023/1/19 11:18 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` and `private contributions` by users in Spain on `2023/4/30 4:06 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` and `private contributions` by users in Spain on `2023/9/29 2:20 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

...
The `public contributions` and `private contributions` by users in Spain on `2022/12/18 1:19 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

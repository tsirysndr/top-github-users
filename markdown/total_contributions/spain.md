...
The `public contributions` and `private contributions` by users in Spain on `2022/11/25 5:08 PM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

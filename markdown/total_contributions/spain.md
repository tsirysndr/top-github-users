...
The `public contributions` and `private contributions` by users in Spain on `2023/7/29 5:19 AM UTC`. This list contains users from `Spain` and cities `Madrid` `Barcelona` `Seville` `Valencia ` `Bilbao`.

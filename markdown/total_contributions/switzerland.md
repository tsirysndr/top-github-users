...
The `public contributions` and `private contributions` by users in Switzerland on `2022/11/20 3:47 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` and `private contributions` by users in Switzerland on `2023/8/8 7:30 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

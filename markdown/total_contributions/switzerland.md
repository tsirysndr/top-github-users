...
The `public contributions` and `private contributions` by users in Switzerland on `2023/6/13 11:34 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` and `private contributions` by users in Switzerland on `2022/11/16 3:23 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` and `private contributions` by users in Switzerland on `2022/10/27 8:28 PM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

...
The `public contributions` and `private contributions` by users in Switzerland on `2023/4/23 7:22 AM UTC`. This list contains users from `Switzerland` and cities `Zürich` `Geneva` `Basel` `Lausanne`.

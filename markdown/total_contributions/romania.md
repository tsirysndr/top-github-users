...
The `public contributions` and `private contributions` by users in Romania on `2022/11/6 9:00 AM UTC`. This list contains users from `Romania` and cities `Bucharest` `Constanța`.

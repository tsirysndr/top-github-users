...
The `public contributions` and `private contributions` by users in Botswana on `2022/11/19 1:33 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

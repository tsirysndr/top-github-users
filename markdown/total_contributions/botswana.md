...
The `public contributions` and `private contributions` by users in Botswana on `2023/8/26 10:11 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

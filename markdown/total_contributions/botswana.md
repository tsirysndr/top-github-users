...
The `public contributions` and `private contributions` by users in Botswana on `2023/8/20 7:26 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

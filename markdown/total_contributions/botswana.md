...
The `public contributions` and `private contributions` by users in Botswana on `2023/3/23 12:18 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

...
The `public contributions` and `private contributions` by users in Botswana on `2022/12/10 8:17 AM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

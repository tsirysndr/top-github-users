...
The `public contributions` and `private contributions` by users in Botswana on `2022/12/16 4:29 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

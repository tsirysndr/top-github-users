...
The `public contributions` and `private contributions` by users in Botswana on `2022/11/21 10:55 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

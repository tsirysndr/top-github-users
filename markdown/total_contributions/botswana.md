...
The `public contributions` and `private contributions` by users in Botswana on `2023/4/11 5:42 PM UTC`. This list contains users from `Botswana` and cities `Gaborone` `Francistown` `Maun` `Serowe` `Molepolole`.

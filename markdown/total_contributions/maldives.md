...
The `public contributions` and `private contributions` by users in Maldives on `2022/10/7 2:44 PM UTC`. This list contains users from `Maldives` and cities `Malé` `Addu-city`.

...
The `public contributions` and `private contributions` by users in Belarus on `2022/12/15 2:00 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

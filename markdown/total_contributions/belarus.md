...
The `public contributions` and `private contributions` by users in Belarus on `2023/8/1 11:19 PM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

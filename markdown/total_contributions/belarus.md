...
The `public contributions` and `private contributions` by users in Belarus on `2022/11/13 3:19 AM UTC`. This list contains users from `Belarus` and cities `Minsk` `Gomel` `Grodno` `Mogilev` `Brest`.

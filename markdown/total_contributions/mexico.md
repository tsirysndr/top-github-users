...
The `public contributions` and `private contributions` by users in Mexico on `2022/10/8 10:09 AM UTC`. This list contains users from `Mexico` and cities `Mexico-city` `Guadalajara` `Puebla` `Ciudad-juárez` `Tijuana` `Monterrey` `Mexicali`.

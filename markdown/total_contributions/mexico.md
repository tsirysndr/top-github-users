...
The `public contributions` and `private contributions` by users in Mexico on `2023/6/17 4:00 PM UTC`. This list contains users from `Mexico` and cities `Mexico-city` `Guadalajara` `Puebla` `Ciudad-juárez` `Tijuana` `Monterrey` `Mexicali`.

...
The `public contributions` and `private contributions` by users in Malawi on `2023/7/26 7:44 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		...
		<td>Mercury Web </td>
		<td><a href="https://twitter.com/pavel_pavel18">pavel_pavel18</a></td>
		<td>Blantyre, Malawi</td>
		<td>229</td>
		<td>229</td>
	</tr>

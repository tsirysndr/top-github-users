...
The `public contributions` and `private contributions` by users in Malawi on `2022/11/10 7:44 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `898 users`  in Malawi. You need at least `0 followers` to be on this list.
...
<table>
	...
	<tr>
		<td>394</td>
		<td>
			<a href="https://github.com/Clemspc">
				<img src="https://avatars.githubusercontent.com/u/98688367?s=72&v=4" width="24" alt="Avatar of Clemspc"> Clemspc
			</a><br/>
			CLEMENT DERRECK LEFU
		</td>
		<td>Malawi Liverpool Wellcome Trust<br/></td>
		<td>No Twitter Username</td>
		<td>Malawi</td>

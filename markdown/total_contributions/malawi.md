...
The `public contributions` and `private contributions` by users in Malawi on `2022/12/4 5:33 AM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.

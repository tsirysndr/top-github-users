...
The `public contributions` and `private contributions` by users in Malawi on `2023/8/23 1:00 PM UTC`. This list contains users from `Malawi` and cities `Lilongwe` `Blantyre` `Mzuzu` `Zomba` `Karonga`.
...
<table>
	...
	<tr>
		<td>471</td>
		<td>
			<a href="https://github.com/kelvinkalulu">
				<img src="https://avatars.githubusercontent.com/u/131350655?s=72&v=4" width="24" alt="Avatar of kelvinkalulu"> kelvinkalulu
			</a><br/>
			kelvin kalulu
		</td>
		<td>Nk-tek </td>

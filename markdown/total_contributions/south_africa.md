...
The `public contributions` and `private contributions` by users in South Africa on `2023/11/16 3:58 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/NkoneA">
				<img src="https://avatars.githubusercontent.com/u/118694732?s=72&u=95172533347869ba6df1777565f1b49aa99040f3&v=4" width="24" alt="Avatar of NkoneA"> NkoneA
			</a><br/>
			Anne Gaitate
		</td>
		<td>No Company</td>

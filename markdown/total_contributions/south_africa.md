...
The `public contributions` and `private contributions` by users in South Africa on `2022/11/19 7:47 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

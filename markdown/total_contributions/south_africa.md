...
The `public contributions` and `private contributions` by users in South Africa on `2023/6/10 12:43 PM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/bazileros">
				<img src="https://avatars.githubusercontent.com/u/125132613?s=72&u=323b37eef9ca21b58ddeb2b05c386b1fbe7fe335&v=4" width="24" alt="Avatar of bazileros"> bazileros
			</a><br/>
			_BLUDDD
		</td>

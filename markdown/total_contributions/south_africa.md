...
The `public contributions` and `private contributions` by users in South Africa on `2023/9/25 7:40 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/austinwasabi">
				<img src="https://avatars.githubusercontent.com/u/108596811?s=72&v=4" width="24" alt="Avatar of austinwasabi"> austinwasabi
			</a><br/>
			Augustine Ledwaba
		</td>
		<td>Wits University </td>

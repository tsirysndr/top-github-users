...
The `public contributions` and `private contributions` by users in South Africa on `2022/11/20 2:48 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

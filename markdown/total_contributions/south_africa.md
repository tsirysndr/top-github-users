...
The `public contributions` and `private contributions` by users in South Africa on `2023/6/2 6:16 AM UTC`. This list contains users from `South Africa` and cities `Cape-town` `Johannesburg` `Durban` `Pretoria` `Soweto`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `984 users`  in South Africa. You need at least `12 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kayjeee">
				<img src="https://avatars.githubusercontent.com/u/9987251?s=72&u=b950acf326395f728879a31ec22ac6c6a708c459&v=4" width="24" alt="Avatar of kayjeee"> kayjeee
			</a><br/>
			kayjee
		</td>
		<td>@microverseinc  </td>

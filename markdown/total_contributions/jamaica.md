...
The `public contributions` and `private contributions` by users in Jamaica on `2022/11/17 9:55 AM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

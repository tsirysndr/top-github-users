...
The `public contributions` and `private contributions` by users in Jamaica on `2022/10/16 1:39 PM UTC`. This list contains users from `Jamaica` and cities `Kingston` `Montego-bay` `Ocho-rios` `Port-antonio`.

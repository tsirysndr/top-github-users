...
The `public contributions` and `private contributions` by users in Vietnam on `2023/9/8 10:46 AM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

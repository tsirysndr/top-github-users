...
The `public contributions` and `private contributions` by users in Vietnam on `2023/11/16 6:47 PM UTC`. This list contains users from `Vietnam` and cities `Ho-chi-minh-city` `Hanoi` `Da-nang` `Can-tho` `Haiphong`.

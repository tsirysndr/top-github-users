...
The `public contributions` and `private contributions` by users in Burundi on `2022/11/7 11:41 AM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

...
The `public contributions` and `private contributions` by users in Burundi on `2022/10/18 10:15 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

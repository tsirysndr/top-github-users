...
The `public contributions` and `private contributions` by users in Burundi on `2022/10/19 8:01 PM UTC`. This list contains users from `Burundi` and cities `Bujumbura` `Gitega` `Muyinga` `Ruyigi` `Ngozi`.

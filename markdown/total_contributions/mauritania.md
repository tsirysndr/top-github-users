...
The `public contributions` and `private contributions` by users in Mauritania on `2023/8/16 6:37 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

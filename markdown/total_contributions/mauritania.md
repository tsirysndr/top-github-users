...
The `public contributions` and `private contributions` by users in Mauritania on `2023/3/9 7:24 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

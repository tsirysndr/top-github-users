...
The `public contributions` and `private contributions` by users in Mauritania on `2023/11/20 9:30 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

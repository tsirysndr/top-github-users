...
The `public contributions` and `private contributions` by users in Mauritania on `2023/1/19 5:41 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

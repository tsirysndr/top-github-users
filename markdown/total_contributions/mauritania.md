...
The `public contributions` and `private contributions` by users in Mauritania on `2023/9/23 4:00 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `public contributions` and `private contributions` by users in Mauritania on `2023/11/27 1:36 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

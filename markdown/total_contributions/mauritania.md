...
The `public contributions` and `private contributions` by users in Mauritania on `2023/10/18 8:42 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

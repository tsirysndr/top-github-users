...
The `public contributions` and `private contributions` by users in Mauritania on `2023/10/23 7:27 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

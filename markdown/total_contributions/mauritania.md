...
The `public contributions` and `private contributions` by users in Mauritania on `2023/11/8 6:27 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

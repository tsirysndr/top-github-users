...
The `public contributions` and `private contributions` by users in Mauritania on `2023/10/29 7:32 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

...
The `public contributions` and `private contributions` by users in Mauritania on `2022/11/11 10:14 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

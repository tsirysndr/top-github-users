...
The `public contributions` and `private contributions` by users in Mauritania on `2022/10/30 7:29 PM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

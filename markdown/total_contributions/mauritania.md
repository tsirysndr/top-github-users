...
The `public contributions` and `private contributions` by users in Mauritania on `2023/9/1 9:57 AM UTC`. This list contains users from `Mauritania` and cities `Nouakchott` `Nouadhibou` `Atar` `Rosso`.

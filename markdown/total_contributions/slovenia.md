...
The `public contributions` and `private contributions` by users in Slovenia on `2022/10/13 9:42 AM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

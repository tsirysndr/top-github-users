...
The `public contributions` and `private contributions` by users in Slovenia on `2023/10/28 6:37 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

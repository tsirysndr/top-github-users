...
The `public contributions` and `private contributions` by users in Slovenia on `2023/9/18 2:17 PM UTC`. This list contains users from `Slovenia` and cities `Ljubljana` `Maribor` `Koper` `Kranj` `Celje`.

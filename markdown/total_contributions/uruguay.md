...
The `public contributions` and `private contributions` by users in Uruguay on `2023/6/12 1:30 AM UTC`. This list contains users from `Uruguay` and cities `Montevideo`.

...
The `public contributions` and `private contributions` by users in Bolivia on `2023/10/10 12:16 PM UTC`. This list contains users from `Bolivia` and cities `La-paz` `Cochabamba` `Santa-cruz-de-la-sierra` `Sucre` `El-alto`.
...
<table>
	...
	<tr>
		...
		<td>Lima, Perú / Cochabamba, Bolivia</td>
		<td>68</td>
		<td>283</td>
	</tr>
	<tr>

...
The `public contributions` and `private contributions` by users in Kuwait on `2022/12/12 5:13 AM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

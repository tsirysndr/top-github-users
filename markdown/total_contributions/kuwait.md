...
The `public contributions` and `private contributions` by users in Kuwait on `2023/1/22 2:30 PM UTC`. This list contains users from `Kuwait` and cities `Kuwait-city` `Al-jahra` `Mangaf` `Salmiya`.

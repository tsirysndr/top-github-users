...
The `public contributions` and `private contributions` by users in Montenegro on `2022/11/8 3:20 PM UTC`. This list contains users from `Montenegro` and cities `Podgorica` `Nikšić`.

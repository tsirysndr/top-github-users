...
The `public contributions` and `private contributions` by users in Lithuania on `2023/6/20 4:52 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2023/5/31 1:19 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2023/6/8 7:51 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2022/11/15 8:19 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

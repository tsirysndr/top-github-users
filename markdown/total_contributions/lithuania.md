...
The `public contributions` and `private contributions` by users in Lithuania on `2023/3/11 6:48 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

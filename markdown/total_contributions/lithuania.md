...
The `public contributions` and `private contributions` by users in Lithuania on `2022/12/20 4:56 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2023/5/22 2:47 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

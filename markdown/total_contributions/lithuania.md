...
The `public contributions` and `private contributions` by users in Lithuania on `2022/11/19 8:47 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

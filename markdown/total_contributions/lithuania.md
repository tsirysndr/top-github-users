...
The `public contributions` and `private contributions` by users in Lithuania on `2022/12/24 11:13 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2022/10/8 9:03 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

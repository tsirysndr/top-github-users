...
The `public contributions` and `private contributions` by users in Lithuania on `2023/1/5 2:06 AM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

...
The `public contributions` and `private contributions` by users in Lithuania on `2022/10/27 1:24 PM UTC`. This list contains users from `Lithuania` and cities `Vilnius` `Kaunas` `Klaipėda` `Siauliai` `Panevėžys` `Alytus`.

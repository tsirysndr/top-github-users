...
The `public contributions` and `private contributions` by users in Russia on `2023/10/26 11:53 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>425</td>
		<td>
			<a href="https://github.com/rrusich">
				<img src="https://avatars.githubusercontent.com/u/75385356?s=72&v=4" width="24" alt="Avatar of rrusich"> rrusich
			</a><br/>
			No Name
		</td>
		<td>No Company</td>

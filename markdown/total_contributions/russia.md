...
The `public contributions` and `private contributions` by users in Russia on `2023/11/27 11:07 PM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>513</td>
		<td>
			<a href="https://github.com/Li3b3rt">
				<img src="https://avatars.githubusercontent.com/u/88889465?s=72&v=4" width="24" alt="Avatar of Li3b3rt"> Li3b3rt
			</a><br/>
			No Name
		</td>
		<td>No Company</td>

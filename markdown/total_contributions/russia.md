...
The `public contributions` and `private contributions` by users in Russia on `2023/9/9 12:34 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Ahora57">
				<img src="https://avatars.githubusercontent.com/u/84189666?s=72&u=dbef1f368b6fa356a538ee06cd73f97d56709d21&v=4" width="24" alt="Avatar of Ahora57"> Ahora57
			</a><br/>
			No Name
		</td>
		<td>No Company</td>

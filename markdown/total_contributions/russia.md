...
The `public contributions` and `private contributions` by users in Russia on `2023/8/30 8:07 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>617</td>
		<td>
			<a href="https://github.com/NightmareStresser">
				<img src="https://avatars.githubusercontent.com/u/122609261?s=72&v=4" width="24" alt="Avatar of NightmareStresser"> NightmareStresser
			</a><br/>
			Nightmare Stresser
		</td>
		<td>Nightmare Stresser </td>
		<td><a href="https://twitter.com/nightmarebooter">nightmarebooter</a></td>
		<td>Russia</td>
		<td>30</td>
		<td>30</td>
	</tr>

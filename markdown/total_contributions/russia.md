...
The `public contributions` and `private contributions` by users in Russia on `2023/10/12 5:50 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.

There are `138 countries` and `674 cities` can be found [here](https://github.com/tsirysndr/top-github-users).

There are `975 users`  in Russia. You need at least `51 followers` to be on this list.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/realkarych">
				<img src="https://avatars.githubusercontent.com/u/62261985?s=72&u=2c95355229ff3fc59f5859bd3bdd7d3823229b2d&v=4" width="24" alt="Avatar of realkarych"> realkarych
			</a><br/>
			Andrey Karchevsky
		</td>
		<td>Itmo </td>

...
The `public contributions` and `private contributions` by users in Russia on `2023/9/28 6:50 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/GDSimpson3">
				<img src="https://avatars.githubusercontent.com/u/103830594?s=72&u=db883d2b05cb808a02a18edacd71449f36679762&v=4" width="24" alt="Avatar of GDSimpson3"> GDSimpson3
			</a><br/>
			Gavin Simpson 
		</td>
		<td>Sega Studios </td>

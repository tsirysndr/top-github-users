...
The `public contributions` and `private contributions` by users in Russia on `2023/11/20 7:13 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/viocassel">
				<img src="https://avatars.githubusercontent.com/u/3341562?s=72&u=42522847a7b5cfdfb85a4a89e0b5551b0a866435&v=4" width="24" alt="Avatar of viocassel"> viocassel
			</a><br/>
			Vio Cassel
		</td>
		<td>Vcd </td>

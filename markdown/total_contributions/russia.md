...
The `public contributions` and `private contributions` by users in Russia on `2023/6/27 3:41 AM UTC`. This list contains users from `Russia` and cities `Moscow` `Saint-petersburg` `Yekaterinburg` `Novosibirsk` `Kazan` `Omsk` `Volgograd` `Chelyabinsk` `Krasnoyarsk`.
...
<table>
	...
	<tr>
		<td>708</td>
		<td>
			<a href="https://github.com/marcelore">
				<img src="https://avatars.githubusercontent.com/u/136905864?s=72&v=4" width="24" alt="Avatar of marcelore"> marcelore
			</a><br/>
			No Name
		</td>
		<td>No Company</td>

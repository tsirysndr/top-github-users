...
The `public contributions` and `private contributions` by users in Malta on `2023/5/31 2:05 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.

...
The `public contributions` and `private contributions` by users in Malta on `2023/4/17 11:52 PM UTC`. This list contains users from `Malta` and cities `Valletta` `Sliema` `Saint-pauls-bay`.

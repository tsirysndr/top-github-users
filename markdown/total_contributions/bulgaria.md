...
The `public contributions` and `private contributions` by users in Bulgaria on `2022/11/10 12:44 AM UTC`. This list contains users from `Bulgaria` and cities `Sofia` `Varna` `Plovdiv` `Ruse` `Stara-zagora`.

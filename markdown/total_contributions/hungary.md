...
The `public contributions` and `private contributions` by users in Hungary on `2023/2/5 12:00 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

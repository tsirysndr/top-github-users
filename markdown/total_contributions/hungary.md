...
The `public contributions` and `private contributions` by users in Hungary on `2023/6/12 8:47 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

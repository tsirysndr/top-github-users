...
The `public contributions` and `private contributions` by users in Hungary on `2023/9/15 8:45 AM UTC`. This list contains users from `Hungary` and cities `Budapest` `Debrecen` `Szeged` `Miskolc` `Pécs` `Győr`.

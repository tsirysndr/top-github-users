...
The `public contributions` and `private contributions` by users in Canada on `2023/6/8 1:56 PM UTC`. This list contains users from `Canada` and cities `Toronto` `Montreal` `Vancouver` `Calgary` `Edmonton` `Quebec-city` `Winnipeg` `Saskatoon` `Regina`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/kevin369ml">
				<img src="https://avatars.githubusercontent.com/u/10591412?s=72&v=4" width="24" alt="Avatar of kevin369ml"> kevin369ml
			</a><br/>
			Kevin X
		</td>
		<td>No Company</td>

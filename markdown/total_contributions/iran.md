...
The `public contributions` and `private contributions` by users in Iran on `2023/2/11 7:21 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

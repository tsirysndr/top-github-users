...
The `public contributions` and `private contributions` by users in Iran on `2023/2/11 1:49 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

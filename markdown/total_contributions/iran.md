...
The `public contributions` and `private contributions` by users in Iran on `2023/1/12 2:30 PM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

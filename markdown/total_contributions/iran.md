...
The `public contributions` and `private contributions` by users in Iran on `2022/10/12 6:24 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

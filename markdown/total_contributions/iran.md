...
The `public contributions` and `private contributions` by users in Iran on `2022/10/18 6:33 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

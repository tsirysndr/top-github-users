...
The `public contributions` and `private contributions` by users in Iran on `2023/5/15 7:36 AM UTC`. This list contains users from `Iran` and cities `Tehran` `Isfahan` `Tabriz` `Shiraz` `Mashhad` `Qom`.

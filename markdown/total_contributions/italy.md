...
The `public contributions` and `private contributions` by users in Italy on `2023/9/25 12:54 AM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

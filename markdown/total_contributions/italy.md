...
The `public contributions` and `private contributions` by users in Italy on `2023/9/10 10:51 PM UTC`. This list contains users from `Italy` and cities `Rome` `Venice` `Florence` `Turin` `Milan` `Naples` `Bologna` `Genoa`.

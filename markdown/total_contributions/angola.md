...
The `public contributions` and `private contributions` by users in Angola on `2023/10/11 5:18 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/mannuelst">
				<img src="https://avatars.githubusercontent.com/u/79723710?s=72&u=191d86f4697c0f4a43f22796fb287d997a60c3fe&v=4" width="24" alt="Avatar of mannuelst"> mannuelst
			</a><br/>
			MANUEL
		</td>
		<td>No Company</td>

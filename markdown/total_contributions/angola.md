...
The `public contributions` and `private contributions` by users in Angola on `2023/8/6 11:22 PM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/paulovictorarmando">
				<img src="https://avatars.githubusercontent.com/u/122297062?s=72&u=9fbf9ed06842f048315e5e51ba975d285fdd6a97&v=4" width="24" alt="Avatar of paulovictorarmando"> paulovictorarmando
			</a><br/>
			Paulo Armando
		</td>
		<td>No Company</td>

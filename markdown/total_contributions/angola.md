...
The `public contributions` and `private contributions` by users in Angola on `2023/10/13 5:14 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
...
<table>
	...
	<tr>
		...
		<td><a href="https://twitter.com/GracianoSoft">GracianoSoft</a></td>
		<td>Angola</td>
		<td>915</td>
		<td>945</td>
	</tr>

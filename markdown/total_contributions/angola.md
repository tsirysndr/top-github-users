...
The `public contributions` and `private contributions` by users in Angola on `2023/6/18 12:03 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/euotiniel">
				<img src="https://avatars.githubusercontent.com/u/93485038?s=72&v=4" width="24" alt="Avatar of euotiniel"> euotiniel
			</a><br/>
			Otoniel Emanuel
		</td>
		<td>No Company</td>

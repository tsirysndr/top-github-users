...
The `public contributions` and `private contributions` by users in Angola on `2023/11/18 7:26 AM UTC`. This list contains users from `Angola` and cities `Luanda` `Cabinda ` `Huambo` `Lubango ` `Kuito` `Malanje ` `Lobito` `Benguela`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/daniel-koti">
				<img src="https://avatars.githubusercontent.com/u/54755738?s=72&u=146a3c09af7e6d919317b31c9def306f49cf2ffd&v=4" width="24" alt="Avatar of daniel-koti"> daniel-koti
			</a><br/>
			Daniel Koti
		</td>
		<td>No Company</td>

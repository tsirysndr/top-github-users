...
The `public contributions` and `private contributions` by users in Ghana on `2022/12/15 6:43 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

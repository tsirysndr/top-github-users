...
The `public contributions` and `private contributions` by users in Ghana on `2022/11/1 6:33 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

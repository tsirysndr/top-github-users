...
The `public contributions` and `private contributions` by users in Ghana on `2023/1/2 1:01 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

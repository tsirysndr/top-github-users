...
The `public contributions` and `private contributions` by users in Ghana on `2023/1/20 11:51 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

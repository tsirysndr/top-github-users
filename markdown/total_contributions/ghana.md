...
The `public contributions` and `private contributions` by users in Ghana on `2022/12/8 10:26 PM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

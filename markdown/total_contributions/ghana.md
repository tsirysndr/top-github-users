...
The `public contributions` and `private contributions` by users in Ghana on `2023/7/23 2:33 AM UTC`. This list contains users from `Ghana` and cities `Accra` `Kumasi` `Sekondi-takoradi` `Sunyani` `Tamale` `Obuasi`.

...
The `public contributions` and `private contributions` by users in Congo on `2022/10/30 1:00 PM UTC`. This list contains users from `Congo` and cities `Brazzaville` `Pointe-noire`.

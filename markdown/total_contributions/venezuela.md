...
The `public contributions` and `private contributions` by users in Venezuela on `2023/6/23 3:34 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
...
<table>
	...
	<tr>
		...
		<td>San Francisco - Zulia - Venezuela</td>
		<td>201</td>
		<td>433</td>
	</tr>
	<tr>

...
The `public contributions` and `private contributions` by users in Venezuela on `2022/12/8 3:06 PM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

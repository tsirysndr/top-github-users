...
The `public contributions` and `private contributions` by users in Venezuela on `2023/8/10 1:22 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.
...
<table>
	...
	<tr>
		<td>380</td>
		<td>
			<a href="https://github.com/mariasierrabohorquez">
				<img src="https://avatars.githubusercontent.com/u/44810201?s=72&v=4" width="24" alt="Avatar of mariasierrabohorquez"> mariasierrabohorquez
			</a><br/>
			Maria Bohorquez Sierra 
		</td>
		<td>No Company</td>
		<td>No Twitter Username</td>
		<td>Maracay, Venezuela</td>

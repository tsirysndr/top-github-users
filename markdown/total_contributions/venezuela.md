...
The `public contributions` and `private contributions` by users in Venezuela on `2022/10/31 3:27 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

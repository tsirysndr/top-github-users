...
The `public contributions` and `private contributions` by users in Venezuela on `2022/11/24 5:00 AM UTC`. This list contains users from `Venezuela` and cities `Caracas` `Maracay` `Maracaibo` `Guayana-city`.

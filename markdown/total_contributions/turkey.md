...
The `public contributions` and `private contributions` by users in Turkey on `2023/9/3 8:29 PM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

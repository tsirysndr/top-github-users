...
The `public contributions` and `private contributions` by users in Turkey on `2022/11/24 4:01 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

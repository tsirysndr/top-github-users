...
The `public contributions` and `private contributions` by users in Turkey on `2023/8/9 1:55 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

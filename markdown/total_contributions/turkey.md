...
The `public contributions` and `private contributions` by users in Turkey on `2022/11/20 4:29 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

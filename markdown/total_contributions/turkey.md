...
The `public contributions` and `private contributions` by users in Turkey on `2023/1/2 4:54 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

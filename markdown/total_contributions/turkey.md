...
The `public contributions` and `private contributions` by users in Turkey on `2022/11/8 2:30 AM UTC`. This list contains users from `Turkey` and cities `Istanbul` `Ankara` `Izmir` `Konya` `Gaziantep` `Adana`.

...
The `public contributions` and `private contributions` by users in Cyprus on `2023/1/16 1:40 PM UTC`. This list contains users from `Cyprus` and cities `Nicosia` `Limassol` `Larnaca` `Paphos` `Paralimni` `Famagusta`.

...
The `public contributions` and `private contributions` by users in Bahrain on `2022/10/12 7:00 PM UTC`. This list contains users from `Bahrain` and cities `Nassau` `Riffa` `Muharraq`.

...
The `public contributions` and `private contributions` by users in Burkina Faso on `2023/9/2 1:54 PM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.

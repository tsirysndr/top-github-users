...
The `public contributions` and `private contributions` by users in Burkina Faso on `2023/8/3 10:59 AM UTC`. This list contains users from `Burkina Faso` and cities `Ouagadougou` `Bobo-dioulasso` `Koudougou` `Banfora` `Ouahigouya`.

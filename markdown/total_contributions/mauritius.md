...
The `public contributions` and `private contributions` by users in Mauritius on `2022/10/30 12:25 AM UTC`. This list contains users from `Mauritius` and cities `Port-louis` `Curepipe` `Vacoas-phoenix` `Beau-bassin-rose-hill`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/vashilK">
				<img src="https://avatars.githubusercontent.com/u/49190809?s=72&v=4" width="24" alt="Avatar of vashilK"> vashilK
			</a><br/>
			Neeschal Kissoon
		</td>
		<td>No Company</td>

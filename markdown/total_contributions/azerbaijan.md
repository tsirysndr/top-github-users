...
The `public contributions` and `private contributions` by users in Azerbaijan on `2022/10/29 2:58 PM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

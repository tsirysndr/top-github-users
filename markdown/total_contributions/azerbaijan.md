...
The `public contributions` and `private contributions` by users in Azerbaijan on `2022/10/23 8:28 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

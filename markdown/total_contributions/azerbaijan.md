...
The `public contributions` and `private contributions` by users in Azerbaijan on `2022/11/1 1:06 AM UTC`. This list contains users from `Azerbaijan` and cities `Baku` `Ganja` `Sumqayit` `Mingecevir`.

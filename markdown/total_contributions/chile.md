...
The `public contributions` and `private contributions` by users in Chile on `2022/12/13 1:20 PM UTC`. This list contains users from `Chile` and cities `Santiago` `Valparaíso` `Viña-del-mar` `Arica` `Temuco` `Concepcion` `Puerto-montt`.

...
The `public contributions` and `private contributions` by users in Rwanda on `2023/8/14 11:41 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

...
The `public contributions` and `private contributions` by users in Rwanda on `2023/9/13 10:00 AM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

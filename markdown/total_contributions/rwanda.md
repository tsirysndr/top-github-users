...
The `public contributions` and `private contributions` by users in Rwanda on `2023/1/25 10:05 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

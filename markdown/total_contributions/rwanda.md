...
The `public contributions` and `private contributions` by users in Rwanda on `2022/10/30 11:37 PM UTC`. This list contains users from `Rwanda` and cities `Kigali`.

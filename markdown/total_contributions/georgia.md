...
The `public contributions` and `private contributions` by users in Georgia on `2022/12/20 8:17 PM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

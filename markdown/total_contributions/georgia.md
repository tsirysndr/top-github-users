...
The `public contributions` and `private contributions` by users in Georgia on `2022/12/22 10:54 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

...
The `public contributions` and `private contributions` by users in Georgia on `2023/4/30 7:17 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

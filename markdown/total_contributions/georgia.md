...
The `public contributions` and `private contributions` by users in Georgia on `2022/10/16 11:06 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

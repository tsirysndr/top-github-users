...
The `public contributions` and `private contributions` by users in Georgia on `2023/9/1 5:57 AM UTC`. This list contains users from `Georgia` and cities `Tbilisi` `Batumi` `Kutaisi` `Rustavi`.

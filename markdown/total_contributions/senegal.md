...
The `public contributions` and `private contributions` by users in Senegal on `2023/5/16 8:00 AM UTC`. This list contains users from `Senegal` and cities `Dakar`.

...
The `public contributions` and `private contributions` by users in Senegal on `2022/10/27 6:45 PM UTC`. This list contains users from `Senegal` and cities `Dakar`.

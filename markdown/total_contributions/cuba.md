...
The `public contributions` and `private contributions` by users in Cuba on `2023/9/19 4:06 PM UTC`. This list contains users from `Cuba` and cities.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/LiasCode">
				<img src="https://avatars.githubusercontent.com/u/81951059?s=72&v=4" width="24" alt="Avatar of LiasCode"> LiasCode
			</a><br/>
			Raúl Lías
		</td>
		<td>@pico-real  </td>

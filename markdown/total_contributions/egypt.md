...
The `public contributions` and `private contributions` by users in Egypt on `2023/9/30 9:22 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.

...
The `public contributions` and `private contributions` by users in Egypt on `2023/10/16 9:01 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
...
<table>
	...
	<tr>
		...
		<td>Suez Canal University </td>
		<td><a href="https://twitter.com/HasnaaAbdelrhmn">HasnaaAbdelrhmn</a></td>
		<td>Egypt</td>
		<td>93</td>
		<td>93</td>
	</tr>

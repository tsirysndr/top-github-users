...
The `public contributions` and `private contributions` by users in Egypt on `2023/10/14 9:46 PM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/BBDS00">BBDS00</a></td>
		<td>egypt </td>
		<td>191</td>
		<td>191</td>
	</tr>

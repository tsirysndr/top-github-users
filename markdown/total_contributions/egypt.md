...
The `public contributions` and `private contributions` by users in Egypt on `2023/11/25 7:21 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.

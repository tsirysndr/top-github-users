...
The `public contributions` and `private contributions` by users in Egypt on `2023/9/23 11:18 AM UTC`. This list contains users from `Egypt` and cities `Cairo` `Luxor` `Alexandria` `Giza` `Aswan`.
...
<table>
	...
	<tr>
		...
		<td>No Company</td>
		<td><a href="https://twitter.com/AhmedRMMM1996">AhmedRMMM1996</a></td>
		<td>Cairo,Egypt</td>
		<td>726</td>
		<td>735</td>
	</tr>

...
The `public contributions` and `private contributions` by users in Oman on `2023/1/6 12:09 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

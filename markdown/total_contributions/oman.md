...
The `public contributions` and `private contributions` by users in Oman on `2022/10/15 1:07 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

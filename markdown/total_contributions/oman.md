...
The `public contributions` and `private contributions` by users in Oman on `2022/10/12 11:28 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
...
<table>
	...
	<tr>
		...
		<td>Qbg- Qurum Businesses Group.<br/></td>
		<td>No Twitter Username</td>
		<td>Muscat ,Oman</td>
		<td>7</td>
		<td>7</td>

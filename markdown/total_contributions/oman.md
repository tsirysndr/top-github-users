...
The `public contributions` and `private contributions` by users in Oman on `2022/11/14 9:29 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

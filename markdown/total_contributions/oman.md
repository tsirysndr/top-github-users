...
The `public contributions` and `private contributions` by users in Oman on `2023/1/12 7:43 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.

...
The `public contributions` and `private contributions` by users in Oman on `2023/8/20 4:46 PM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/tufool">
				<img src="https://avatars.githubusercontent.com/u/137549497?s=72&v=4" width="24" alt="Avatar of tufool"> tufool
			</a><br/>

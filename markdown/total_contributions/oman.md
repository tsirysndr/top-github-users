...
The `public contributions` and `private contributions` by users in Oman on `2023/8/28 12:59 AM UTC`. This list contains users from `Oman` and cities `Muscat` `Salalah` `Nizwa` `Sohar` `Seeb`.
	...
	<tr>
		...
		<td>
			<a href="https://github.com/Noor-Alma">
				<img src="https://avatars.githubusercontent.com/u/137701270?s=72&v=4" width="24" alt="Avatar of Noor-Alma"> Noor-Alma
			</a><br/>
			Noor Al-majaali
		</td>
		<td>Udacity </td>

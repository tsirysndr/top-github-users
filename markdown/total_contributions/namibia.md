...
The `public contributions` and `private contributions` by users in Namibia on `2022/11/16 5:50 PM UTC`. This list contains users from `Namibia` and cities `Windhoek` `Swakopmund` `Walvis-bay` `Otjiwarongo`.
